...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            CharSequence name = person == null ? JsonProperty.USE_DEFAULT_NAME : message.getPerson().getName();
    ...
    public static class Action {
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent) {
            this(i != 0 ? IconCompat.createWithResource(null, JsonProperty.USE_DEFAULT_NAME, i) : null, charSequence, pendingIntent);
        }
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int i2, boolean z2, boolean z3, boolean z4) {
            this(i != 0 ? IconCompat.createWithResource(null, JsonProperty.USE_DEFAULT_NAME, i) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z, i2, z2, z3, z4);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource(null, JsonProperty.USE_DEFAULT_NAME, i);
            }
            return this.mIcon;
        }
        ...
        public static final class Builder {
            ...
            public Builder(int i, CharSequence charSequence, PendingIntent pendingIntent) {
                this(i != 0 ? IconCompat.createWithResource(null, JsonProperty.USE_DEFAULT_NAME, i) : null, charSequence, pendingIntent, new Bundle(), null, true, 0, true, false, false);
            }
