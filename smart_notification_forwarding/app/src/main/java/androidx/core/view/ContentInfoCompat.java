...
public final class ContentInfoCompat {
    ...
    private static final class CompatImpl implements Compat {
        ...
        public String toString() {
            StringBuilder append = new StringBuilder("ContentInfoCompat{clip=").append(this.mClip.getDescription()).append(", source=").append(ContentInfoCompat.sourceToString(this.mSource)).append(", flags=").append(ContentInfoCompat.flagsToString(this.mFlags));
            Uri uri = this.mLinkUri;
            String str = JsonProperty.USE_DEFAULT_NAME;
            StringBuilder append2 = append.append(uri == null ? JsonProperty.USE_DEFAULT_NAME : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")");
