    ...
    public void forceCompleteAllOperations() {
        ...
        synchronized (this.mPendingOperations) {
            ...
            while (it2.hasNext()) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: " + (isAttachedToWindow ? JsonProperty.USE_DEFAULT_NAME : "Container " + this.mContainer + " is not attached to window. ") + "Cancelling running operation " + operation);
                }
                operation.cancel();
            }
            ...
            while (it3.hasNext()) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v("FragmentManager", "SpecialEffectsController: " + (isAttachedToWindow ? JsonProperty.USE_DEFAULT_NAME : "Container " + this.mContainer + " is not attached to window. ") + "Cancelling pending operation " + operation2);
                }
                operation2.cancel();
            }
        }
