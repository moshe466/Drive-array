...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return str.contains(".") ? str : RecyclerView.class.getPackage().getName() + RuleUtils.DOT + str;
    }
    ...
    */
    ...
    void assertNotInLayoutOrScroll(String str) {
        ...
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(JsonProperty.USE_DEFAULT_NAME + exceptionLabel()));
        }
    }
