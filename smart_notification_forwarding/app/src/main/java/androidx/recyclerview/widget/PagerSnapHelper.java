...
public class PagerSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i, int i2) {
        ...
        if (layoutManager.canScrollVertically()) {
            findStartView = findStartView(layoutManager, getVerticalHelper(layoutManager));
        } else {
            findStartView = layoutManager.canScrollHorizontally() ? findStartView(layoutManager, getHorizontalHelper(layoutManager)) : null;
        }
