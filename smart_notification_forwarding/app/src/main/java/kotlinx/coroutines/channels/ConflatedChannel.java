    ...
    */
    public java.lang.Object offerInternal(E r5) {
        /*
            ...
            r0.lock()
            kotlinx.coroutines.channels.Closed r1 = r4.getClosedForSend()     // Catch: java.lang.Throwable -> L60
            if (r1 == 0) goto L11
            r0.unlock()
            return r1
        L11:
            java.lang.Object r1 = r4.value     // Catch: java.lang.Throwable -> L60
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.channels.AbstractChannelKt.EMPTY     // Catch: java.lang.Throwable -> L60
            if (r1 != r2) goto L53
        L17:
            kotlinx.coroutines.channels.ReceiveOrClosed r1 = r4.takeFirstReceiveOrPeekClosed()     // Catch: java.lang.Throwable -> L60
            if (r1 != 0) goto L1e
            goto L53
        L1e:
            boolean r2 = r1 instanceof kotlinx.coroutines.channels.Closed     // Catch: java.lang.Throwable -> L60
            if (r2 == 0) goto L26
            r0.unlock()
            return r1
        L26:
            ...
            r2 = 0
            kotlinx.coroutines.internal.Symbol r2 = r1.tryResumeReceive(r5, r2)     // Catch: java.lang.Throwable -> L60
            if (r2 == 0) goto L17
            boolean r3 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L60
            if (r3 == 0) goto L46
            kotlinx.coroutines.internal.Symbol r3 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch: java.lang.Throwable -> L60
            if (r2 != r3) goto L3c
            r2 = 1
            goto L3d
        L3c:
        ...
        L46:
            ...
            return r5
        L53:
            kotlinx.coroutines.internal.UndeliveredElementException r5 = r4.updateValueLocked(r5)     // Catch: java.lang.Throwable -> L60
            if (r5 != 0) goto L5f
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.channels.AbstractChannelKt.OFFER_SUCCESS     // Catch: java.lang.Throwable -> L60
            r0.unlock()
            return r5
        L5f:
            throw r5     // Catch: java.lang.Throwable -> L60
