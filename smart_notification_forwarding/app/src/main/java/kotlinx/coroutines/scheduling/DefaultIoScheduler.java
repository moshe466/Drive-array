...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo1674dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo1674dispatch(CoroutineContext context, Runnable block) {
        default.mo1674dispatch(context, block);
    }
