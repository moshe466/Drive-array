...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (newInstance != null) {
            m107constructorimpl = Result.m107constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m113isFailureimpl(m107constructorimpl)) {
                m107constructorimpl = null;
            }
            return (Function1) m107constructorimpl;
        }
    ...
    public final String hierarchyToString(Job job) {
        ...
        try {
            ...
            INSTANCE.build(job, linkedHashMap, sb, JsonProperty.USE_DEFAULT_NAME);
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            m107constructorimpl = Result.m107constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m107constructorimpl = Result.m107constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m107constructorimpl;
