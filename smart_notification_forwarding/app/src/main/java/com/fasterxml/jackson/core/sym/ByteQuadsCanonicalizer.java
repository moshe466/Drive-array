...
public final class ByteQuadsCanonicalizer {
    ...
    private void mergeChild(TableInfo tableInfo) {
        ...
        ByteQuadsCanonicalizer$$ExternalSyntheticBackportWithForwarding0.m(this._tableInfo, tableInfo2, tableInfo);
    }
    ...
    public String findName(int[] iArr, int i) {
        if (i < 4) {
            ...
            if (i != 2) {
                return i != 3 ? JsonProperty.USE_DEFAULT_NAME : findName(iArr[0], iArr[1], iArr[2]);
            }
