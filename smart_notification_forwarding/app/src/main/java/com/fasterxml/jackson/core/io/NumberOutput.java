...
public final class NumberOutput {
    ...
    private static int _outputUptoBillion(int i, char[] cArr, int i2) {
        ...
        int i10 = i9 + 1;
        cArr[i9] = (char) ((i8 >> 8) & WorkQueueKt.MASK);
        int i11 = i10 + 1;
        cArr[i10] = (char) (i8 & WorkQueueKt.MASK);
        int i12 = iArr[i5];
        int i13 = i11 + 1;
        cArr[i11] = (char) (i12 >> 16);
        int i14 = i13 + 1;
        cArr[i13] = (char) ((i12 >> 8) & WorkQueueKt.MASK);
        int i15 = i14 + 1;
        cArr[i14] = (char) (i12 & WorkQueueKt.MASK);
        return i15;
    }
    ...
    private static int _outputFullBillion(int i, char[] cArr, int i2) {
        ...
        cArr[i2] = (char) (i6 >> 16);
        int i8 = i7 + 1;
        cArr[i7] = (char) ((i6 >> 8) & WorkQueueKt.MASK);
        int i9 = i8 + 1;
        cArr[i8] = (char) (i6 & WorkQueueKt.MASK);
        int i10 = iArr[i3 - (i5 * 1000)];
        int i11 = i9 + 1;
        cArr[i9] = (char) (i10 >> 16);
        int i12 = i11 + 1;
        cArr[i11] = (char) ((i10 >> 8) & WorkQueueKt.MASK);
        int i13 = i12 + 1;
        cArr[i12] = (char) (i10 & WorkQueueKt.MASK);
        int i14 = iArr[i4];
        int i15 = i13 + 1;
        cArr[i13] = (char) (i14 >> 16);
        int i16 = i15 + 1;
        cArr[i15] = (char) ((i14 >> 8) & WorkQueueKt.MASK);
        int i17 = i16 + 1;
        cArr[i16] = (char) (i14 & WorkQueueKt.MASK);
        return i17;
    }
    ...
    private static int _outputUptoMillion(char[] cArr, int i, int i2, int i3) {
        ...
        if (i2 > 9) {
            ...
            cArr[i] = (char) ((i4 >> 8) & WorkQueueKt.MASK);
            i++;
        }
        int i5 = i + 1;
        cArr[i] = (char) (i4 & WorkQueueKt.MASK);
        int i6 = iArr[i3];
        int i7 = i5 + 1;
        cArr[i5] = (char) (i6 >> 16);
        int i8 = i7 + 1;
    ...
    private static int _leading3(int i, char[] cArr, int i2) {
        ...
        if (i > 9) {
            ...
            cArr[i2] = (char) ((i3 >> 8) & WorkQueueKt.MASK);
            i2++;
        }
        int i4 = i2 + 1;
        cArr[i2] = (char) (i3 & WorkQueueKt.MASK);
        return i4;
    }
    ...
    private static int _full3(int i, char[] cArr, int i2) {
        ...
        cArr[i2] = (char) (i3 >> 16);
        int i5 = i4 + 1;
        cArr[i4] = (char) ((i3 >> 8) & WorkQueueKt.MASK);
        int i6 = i5 + 1;
        cArr[i5] = (char) (i3 & WorkQueueKt.MASK);
        return i6;
    }
