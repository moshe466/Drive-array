...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
            ...
            do {
                ...
                if (c > 127) {
                    ...
                    if (c < 2048) {
                        ...
                        bArr[i8] = (byte) ((c & RuleUtils.QUESTION_MARK) | 128);
                    } else {
    ...
    public void writeRaw(char c) throws IOException {
        ...
        if (c <= 127) {
            ...
            if (c < 2048) {
                ...
                this._outputTail = i3 + 1;
                bArr[i3] = (byte) ((c & RuleUtils.QUESTION_MARK) | 128);
                return;
            }
            ...
            do {
                ...
                if (c < 128) {
                    ...
                    if (c2 < 2048) {
                        ...
                        this._outputTail = i8 + 1;
                        bArr[i8] = (byte) ((c2 & RuleUtils.QUESTION_MARK) | 128);
                        i = i6;
                    } else {
            ...
            do {
                ...
                if (c > 127) {
                    ...
                    if (c < 2048) {
                        ...
                        this._outputTail = i4 + 1;
                        bArr[i4] = (byte) ((c & RuleUtils.QUESTION_MARK) | 128);
                    } else {
    ...
    private final void _writeStringSegment2(char[] cArr, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                bArr[i3] = (byte) ((c >> 6) | 192);
                i3 = i7 + 1;
                bArr[i7] = (byte) ((c & RuleUtils.QUESTION_MARK) | 128);
            } else {
    ...
    private final void _writeStringSegment2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                i3 = i7 + 1;
                bArr[i7] = (byte) ((charAt & RuleUtils.QUESTION_MARK) | 128);
            } else {
    ...
    private final void _writeStringSegmentASCII2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                bArr[i3] = (byte) ((charAt >> 6) | 192);
                i3 = i8 + 1;
                bArr[i8] = (byte) ((charAt & RuleUtils.QUESTION_MARK) | 128);
            } else {
                i3 = _outputMultiByteChar(charAt, i3);
            }
            i = i5;
    ...
    protected final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            int i8 = i6 + 1;
            int encodeBase64Chunk = base64Variant.encodeBase64Chunk(i7 | (bArr[i6] & UByte.MAX_VALUE), this._outputBuffer, this._outputTail);
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            i5 = i9 + 1;
            i -= 3;
            int encodeBase64Chunk = base64Variant.encodeBase64Chunk((((bArr[i7] & UByte.MAX_VALUE) | i8) << 8) | (bArr[i9] & UByte.MAX_VALUE), this._outputBuffer, this._outputTail);
            this._outputTail = encodeBase64Chunk;
            maxLineLength--;
            if (maxLineLength <= 0) {
                byte[] bArr2 = this._outputBuffer;
