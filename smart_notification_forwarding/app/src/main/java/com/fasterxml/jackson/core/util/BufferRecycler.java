...
public class BufferRecycler {
    ...
    private static final int[] CHAR_BUFFER_LENGTHS = {4000, 4000, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION};
