        ...
        if (isEnabled || _findCoercionFromEmptyArray != CoercionAction.Fail) {
            ...
            if (isEnabled) {
                if (jsonParser.nextToken() == JsonToken.START_ARRAY) {
                    ...
                    return deserializationContext.handleUnexpectedToken(valueType, JsonToken.START_ARRAY, jsonParser, "Cannot deserialize value of type %s from deeply-nested JSON Array: only single wrapper allowed with `%s`", ClassUtil.getTypeDescription(valueType), "DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS");
                }
