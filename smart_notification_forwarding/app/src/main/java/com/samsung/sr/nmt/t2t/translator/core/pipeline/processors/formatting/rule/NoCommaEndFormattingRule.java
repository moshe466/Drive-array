...
public final class NoCommaEndFormattingRule implements FormattingRule {
    ...
    public boolean applicable(String text) {
        ...
        return !StringsKt.contains$default((CharSequence) text, RuleUtils.COMMA, false, 2, (Object) null);
    }
    ...
    public String restore(String text) {
        ...
        String str4 = str;
        if (!StringsKt.contains$default((CharSequence) str4, RuleUtils.COMMA, false, 2, (Object) null)) {
            return text;
        }
