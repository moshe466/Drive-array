...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        this.fontCallback = new ResourcesCompat.FontCallback() { // from class: com.google.android.material.chip.Chip.1
            ...
            public void m9xb24343b7(int i2) {
            }

            @Override // androidx.core.content.res.ResourcesCompat.FontCallback
            /* renamed from: onFontRetrieved */
            public void m10x46c88379(Typeface typeface) {
                Chip chip = Chip.this;
    ...
    */
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.setContentDescription(JsonProperty.USE_DEFAULT_NAME);
    ...
    public CharSequence getText() {
        ChipDrawable chipDrawable = this.chipDrawable;
        return chipDrawable != null ? chipDrawable.getText() : JsonProperty.USE_DEFAULT_NAME;
    }
