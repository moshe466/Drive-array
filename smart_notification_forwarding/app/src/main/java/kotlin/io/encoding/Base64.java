...
public class Base64 {
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i3 == i && i5 + 3 < endIndex) {
                int i6 = i5 + 1;
                int i7 = access$getBase64UrlDecodeMap$p[source[i5] & UByte.MAX_VALUE];
                int i8 = i6 + 1;
                ...
                int i12 = i10 + 1;
                int i13 = (i11 << 6) | (i7 << 18) | (i9 << 12) | access$getBase64UrlDecodeMap$p[source[i10] & UByte.MAX_VALUE];
                if (i13 >= 0) {
                    int i14 = i2 + 1;
            ...
            int i16 = source[i5] & UByte.MAX_VALUE;
            ...
            if (i17 >= 0) {
                ...
                if (!this.isMimeScheme) {
                    ...
                    throw new IllegalArgumentException(append.append(num).append(") at index ").append(i5).toString());
                }
                i5++;
            }
            i = -8;
    ...
    /* compiled from: Base64.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0010\u0005\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0001¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0006\u001a\u00020\u0001¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\u0005R\u000e\u0010\b\u001a\u00020\tX\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\tX\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\tX\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\tX\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\tX\u0080T¢\u0006\u0002\n\u0000R\u0014\u0010\u000e\u001a\u00020\u000fX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u000e\u0010\u0012\u001a\u00020\u0013X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0014\u001a\u00020\tX\u0080T¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lkotlin/io/encoding/Base64$Default;", "Lkotlin/io/encoding/Base64;", "()V", "Mime", "getMime", "()Lkotlin/io/encoding/Base64;", "UrlSafe", "getUrlSafe", "bitsPerByte", JsonProperty.USE_DEFAULT_NAME, "bitsPerSymbol", "bytesPerGroup", "mimeGroupsPerLine", "mimeLineLength", "mimeLineSeparatorSymbols", JsonProperty.USE_DEFAULT_NAME, "getMimeLineSeparatorSymbols$kotlin_stdlib", "()[B", "padSymbol", JsonProperty.USE_DEFAULT_NAME, "symbolsPerGroup", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
