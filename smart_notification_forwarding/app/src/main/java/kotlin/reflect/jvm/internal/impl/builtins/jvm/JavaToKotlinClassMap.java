...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        NUMBERED_FUNCTION_PREFIX = FunctionTypeKind.Function.INSTANCE.getPackageFqName().toString() + RuleUtils.DOT + FunctionTypeKind.Function.INSTANCE.getClassNamePrefix();
        NUMBERED_K_FUNCTION_PREFIX = FunctionTypeKind.KFunction.INSTANCE.getPackageFqName().toString() + RuleUtils.DOT + FunctionTypeKind.KFunction.INSTANCE.getClassNamePrefix();
        NUMBERED_SUSPEND_FUNCTION_PREFIX = FunctionTypeKind.SuspendFunction.INSTANCE.getPackageFqName().toString() + RuleUtils.DOT + FunctionTypeKind.SuspendFunction.INSTANCE.getClassNamePrefix();
        NUMBERED_K_SUSPEND_FUNCTION_PREFIX = FunctionTypeKind.KSuspendFunction.INSTANCE.getPackageFqName().toString() + RuleUtils.DOT + FunctionTypeKind.KSuspendFunction.INSTANCE.getClassNamePrefix();
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((kSuspendFunction.getPackageFqName().toString() + RuleUtils.DOT + kSuspendFunction.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }
    ...
    private final boolean isKotlinFunctionWithBigArity(FqNameUnsafe fqNameUnsafe, String str) {
        ...
        String substringAfter = StringsKt.substringAfter(asString, str, JsonProperty.USE_DEFAULT_NAME);
