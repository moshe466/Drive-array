    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> mo1387getSupertypes = simpleType.getConstructor().mo1387getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1387getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = mo1387getSupertypes;
