...
public final class ClassMapperLite {
    ...
    private static final String f4kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), JsonProperty.USE_DEFAULT_NAME, null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                String str = f4kotlin;
                int i2 = i + 1;
                linkedHashMap.put(sb.append(str).append(JsonPointer.SEPARATOR).append((String) listOf.get(i)).toString(), listOf.get(i2));
                linkedHashMap.put(str + JsonPointer.SEPARATOR + ((String) listOf.get(i)) + "Array", "[" + ((String) listOf.get(i2)));
        ...
        linkedHashMap.put(f4kotlin + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f4kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f4kotlin + JsonPointer.SEPARATOR + str, "L" + str2 + RuleUtils.SEMICOLON);
    }
    ...
    public static final String mapClass(String classId) {
        ...
        return str == null ? "L" + StringsKt.replace$default(classId, RuleUtils.DOT, Typography.dollar, false, 4, (Object) null) + RuleUtils.SEMICOLON : str;
    }
}
