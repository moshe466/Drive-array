...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo1386getDeclarationDescriptor())) {
        ...
        if (z && (mo1386getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType computeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) mo1386getDeclarationDescriptor, list);
            ...
            if (bool.booleanValue()) {
                ...
                if (bool2.booleanValue()) {
                    ...
                    if (makeDefinitelyNotNull$default == null) {
                        throw new IllegalStateException(("null DefinitelyNotNullType for '" + simpleType$default + RuleUtils.QUOTE).toString());
                    }
        ...
        return proto.hasClassName() ? this.c.getComponents().getPlatformDependentTypeTransformer().transformPlatformType(NameResolverUtilKt.getClassId(this.c.getNameResolver(), proto.getClassName()), simpleType$default) : simpleType$default;
    }
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType transformRuntimeFunctionTypeToSuspendFunction(kotlin.reflect.jvm.internal.impl.types.KotlinType r6) {
        ...
        L15:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r2 = r2.mo1386getDeclarationDescriptor()
            if (r2 == 0) goto L26
    ...
    public String toString() {
        return this.debugName + (this.parent == null ? JsonProperty.USE_DEFAULT_NAME : ". Child of " + this.parent.debugName);
    }
}
