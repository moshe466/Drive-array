...
public final class SignatureBuildingComponents {
    ...
    public final Set<String> inClass(String internalName, String... signatures) {
        ...
        for (String str : signatures) {
            linkedHashSet.add(internalName + RuleUtils.DOT + str);
        }
    ...
    public final String signature(String internalName, String jvmDescriptor) {
        ...
        return internalName + RuleUtils.DOT + jvmDescriptor;
    }
    ...
    public final String jvmDescriptor(String name, List<String> parameters, String ret) {
        ...
        return name + '(' + CollectionsKt.joinToString$default(parameters, JsonProperty.USE_DEFAULT_NAME, null, null, 0, null, new Function1<String, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.SignatureBuildingComponents$jvmDescriptor$1
    ...
    public final String escapeClassName(String str) {
        return str.length() > 1 ? "L" + str + RuleUtils.SEMICOLON : str;
    }
