...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo1392recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    private final <D extends DeclarationDescriptor> D substitute(D d) {
        ...
        if (declarationDescriptorNonRoot == null) {
            ...
            DeclarationDescriptorNonRoot substitute = ((Substitutable) d).substitute(this.capturingSubstitutor);
            if (substitute != null) {
    ...
    public ClassifierDescriptor mo1388getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo1388getContributedClassifier(name, location);
