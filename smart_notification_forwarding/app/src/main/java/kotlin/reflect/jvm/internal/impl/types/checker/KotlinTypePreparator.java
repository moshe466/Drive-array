    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo1387getSupertypes = capturedTypeConstructorImpl.mo1387getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1387getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo1387getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1387getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1387getSupertypes2, 10));
            Iterator<T> it2 = mo1387getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo1387getSupertypes3 = intersectionTypeConstructor2.mo1387getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1387getSupertypes3, 10));
        Iterator<T> it3 = mo1387getSupertypes3.iterator();
        while (it3.hasNext()) {
