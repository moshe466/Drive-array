...
public class LockBasedStorageManager implements StorageManager {
    ...
    private static final String PACKAGE_NAME = StringsKt.substringBeforeLast(LockBasedStorageManager.class.getCanonicalName(), ".", JsonProperty.USE_DEFAULT_NAME);
    ...
    */
    ...
    protected <K, V> RecursionDetectedResult<V> recursionDetectedDefault(String str, K k) {
        ...
        throw ((AssertionError) sanitizeStackTrace(new AssertionError("Recursion detected " + str + (k == null ? JsonProperty.USE_DEFAULT_NAME : "on input: " + k) + " under " + this)));
    }
    ...
    public static class MapBasedMemoizedFunction<K, V> implements MemoizedFunctionToNullable<K, V> {
        ...
        protected RecursionDetectedResult<V> recursionDetected(K k, boolean z) {
            RecursionDetectedResult<V> recursionDetectedDefault = this.storageManager.recursionDetectedDefault(JsonProperty.USE_DEFAULT_NAME, k);
            if (recursionDetectedDefault == null) {
                $$$reportNull$$$0(3);
            }
            return recursionDetectedDefault;
