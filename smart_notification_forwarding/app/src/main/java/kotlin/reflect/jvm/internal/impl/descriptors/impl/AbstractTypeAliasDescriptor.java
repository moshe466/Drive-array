...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo1386getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo1387getSupertypes() {
                Collection<KotlinType> mo1387getSupertypes = mo1386getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1387getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1387getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo1387getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1386getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo1386getDeclarationDescriptor().getName().asString() + ']';
            }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    if ((mo1386getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo1386getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
    ...
    public final Collection<TypeAliasConstructorDescriptor> getTypeAliasConstructors() {
        ...
        for (ClassConstructorDescriptor it : constructors) {
            ...
            TypeAliasConstructorDescriptor createIfAvailable = TypeAliasConstructorDescriptorImpl.Companion.createIfAvailable(this.storageManager, this, it);
