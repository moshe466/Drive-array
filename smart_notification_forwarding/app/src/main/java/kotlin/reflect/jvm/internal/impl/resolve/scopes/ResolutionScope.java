...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo1388getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo1392recordLookup(Name name, LookupLocation lookupLocation);
