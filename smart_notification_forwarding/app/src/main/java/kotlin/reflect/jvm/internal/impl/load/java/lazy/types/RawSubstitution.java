...
public final class RawSubstitution extends TypeSubstitution {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.TypeSubstitution
    /* renamed from: get */
    public TypeProjectionImpl mo1391get(KotlinType key) {
    ...
    private final KotlinType eraseType(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (mo1386getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return eraseType(this.typeParameterUpperBoundEraser.getErasedUpperBound((TypeParameterDescriptor) mo1386getDeclarationDescriptor, javaTypeAttributes.markIsRaw(true)), javaTypeAttributes);
        }
        if (mo1386getDeclarationDescriptor instanceof ClassDescriptor) {
            ClassifierDescriptor mo1386getDeclarationDescriptor2 = FlexibleTypesKt.upperIfFlexible(kotlinType).getConstructor().mo1386getDeclarationDescriptor();
            if (!(mo1386getDeclarationDescriptor2 instanceof ClassDescriptor)) {
                throw new IllegalStateException(("For some reason declaration for upper bound is not a class but \"" + mo1386getDeclarationDescriptor2 + "\" while for lower it's \"" + mo1386getDeclarationDescriptor + '\"').toString());
            }
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.lowerIfFlexible(kotlinType), (ClassDescriptor) mo1386getDeclarationDescriptor, lowerTypeAttr);
            ...
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor2 = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.upperIfFlexible(kotlinType), (ClassDescriptor) mo1386getDeclarationDescriptor2, upperTypeAttr);
        ...
        throw new IllegalStateException(("Unexpected declaration kind: " + mo1386getDeclarationDescriptor).toString());
    }
