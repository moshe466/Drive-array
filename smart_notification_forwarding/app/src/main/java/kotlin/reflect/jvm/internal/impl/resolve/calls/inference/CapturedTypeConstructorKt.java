    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection mo1391get(KotlinType key) {
                ...
                TypeProjection mo1391get = super.mo1391get(key);
                if (mo1391get == null) {
                    return null;
                }
                ClassifierDescriptor mo1386getDeclarationDescriptor = key.getConstructor().mo1386getDeclarationDescriptor();
                createCapturedIfNeeded = CapturedTypeConstructorKt.createCapturedIfNeeded(mo1391get, mo1386getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo1386getDeclarationDescriptor : null);
