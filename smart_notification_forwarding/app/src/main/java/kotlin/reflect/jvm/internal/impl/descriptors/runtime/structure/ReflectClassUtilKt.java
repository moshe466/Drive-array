...
public final class ReflectClassUtilKt {
    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (cls.isArray()) {
            ...
            return StringsKt.replace$default(name2, RuleUtils.DOT, JsonPointer.SEPARATOR, false, 4, (Object) null);
        }
        StringBuilder sb = new StringBuilder("L");
        String name3 = cls.getName();
        Intrinsics.checkNotNullExpressionValue(name3, "name");
        return sb.append(StringsKt.replace$default(name3, RuleUtils.DOT, JsonPointer.SEPARATOR, false, 4, (Object) null)).append(RuleUtils.SEMICOLON).toString();
    }
