...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public String renderFlexibleType(String lowerRendered, String upperRendered, KotlinBuiltIns builtIns) {
        ...
        if (RenderingUtilsKt.typeStringsDifferOnlyInNullability(lowerRendered, upperRendered)) {
            ...
            return lowerRendered + RuleUtils.EXCLAMATION_MARK;
        }
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (mo1386getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo1386getDeclarationDescriptor instanceof ClassDescriptor ? true : mo1386getDeclarationDescriptor instanceof TypeAliasDescriptor) {
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 8) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<TypeProjection, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$appendTypeProjections$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (annotationUseSiteTarget != null) {
            sb.append(annotationUseSiteTarget.getRenderName() + RuleUtils.COLON);
        }
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || (!renderAndSortAnnotationArguments.isEmpty())) {
                CollectionsKt.joinTo(renderAndSortAnnotationArguments, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? JsonProperty.USE_DEFAULT_NAME : "(", (r14 & 8) != 0 ? JsonProperty.USE_DEFAULT_NAME : ")", (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1386getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo1380getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo1380getUnsubstitutedPrimaryConstructor = annotationClass.mo1380getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo1380getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
        ...
        while (it3.hasNext()) {
            arrayList7.add(((Name) it3.next()).asString() + " = ...");
        }
    ...
    */
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            CollectionsKt.joinTo(arrayList, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 8) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : null);
        }
    }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> mo1382getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (mo1382getCompileTimeInitializer = variableDescriptor.mo1382getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ").append(escape(renderConstant(mo1382getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo1380getUnsubstitutedPrimaryConstructor = classDescriptor.mo1380getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo1380getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo1380getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo1380getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo1380getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo1387getSupertypes = classDescriptor.getTypeConstructor().mo1387getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo1387getSupertypes, "klass.typeConstructor.supertypes");
        if (mo1387getSupertypes.isEmpty()) {
            return;
        }
        if (mo1387getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo1387getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo1387getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 8) != 0 ? JsonProperty.USE_DEFAULT_NAME : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
