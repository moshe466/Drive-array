...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> mo1387getSupertypes = this.containingClass.getTypeConstructor().mo1387getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo1387getSupertypes, "containingClass.typeConstructor.supertypes");
