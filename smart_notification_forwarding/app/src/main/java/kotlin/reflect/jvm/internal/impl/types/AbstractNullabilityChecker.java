            ...
            while (!supertypesDeque.isEmpty()) {
                ...
                if (supertypesSet.add(current)) {
                    ...
                    if (none == null) {
                        ...
                        while (it.hasNext()) {
                            SimpleTypeMarker mo1390transformType = none.mo1390transformType(typeCheckerState, it.next());
                            if ((typeSystemContext.isClassType(mo1390transformType) && !typeSystemContext.isMarkedNullable(mo1390transformType)) || typeSystemContext.isDefinitelyNotNullType(mo1390transformType)) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(current)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current)).iterator();
                    while (it.hasNext()) {
                        SimpleTypeMarker mo1390transformType = supertypesPolicy.mo1390transformType(state, it.next());
                        if (INSTANCE.isApplicableAsEndNode(state, mo1390transformType, end)) {
                            state.clear();
                            return true;
                        }
                        supertypesDeque.add(mo1390transformType);
