...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor mo1386getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo1386getDeclarationDescriptor();
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo1386getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo1386getDeclarationDescriptor = mo1386getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo1386getDeclarationDescriptor, arrayList5);
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:8:0x0019, code lost:
            ...
            if ((!r0.isRoot() && r0.startsWith(kotlin.reflect.jvm.internal.impl.builtins.StandardNames.BUILT_INS_PACKAGE_NAME)) != false) goto L13;
         */
        /*
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo1381findAnnotation = annotations.mo1381findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public ClassDescriptor mo1386getDeclarationDescriptor() {
