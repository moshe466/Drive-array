...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a, final CallableDescriptor b, final boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality(z, a, b) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$0
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo1386getDeclarationDescriptor = c1.mo1386getDeclarationDescriptor();
        ClassifierDescriptor mo1386getDeclarationDescriptor2 = c2.mo1386getDeclarationDescriptor();
        if ((mo1386getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo1386getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo1386getDeclarationDescriptor, (TypeParameterDescriptor) mo1386getDeclarationDescriptor2, z, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1
