...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1388getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo1388getContributedClassifier = this.javaScope.mo1388getContributedClassifier(name, location);
        if (mo1388getContributedClassifier != null) {
            return mo1388getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1388getContributedClassifier(name, location);
