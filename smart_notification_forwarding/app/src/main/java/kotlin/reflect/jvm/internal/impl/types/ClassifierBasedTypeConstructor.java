...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo1386getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor mo1386getDeclarationDescriptor = mo1386getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo1386getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo1386getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor mo1386getDeclarationDescriptor = mo1386getDeclarationDescriptor();
        ClassifierDescriptor mo1386getDeclarationDescriptor2 = typeConstructor.mo1386getDeclarationDescriptor();
        if (mo1386getDeclarationDescriptor2 != null && hasMeaningfulFqName(mo1386getDeclarationDescriptor) && hasMeaningfulFqName(mo1386getDeclarationDescriptor2)) {
            return isSameClassifier(mo1386getDeclarationDescriptor2);
        }
        return false;
    }
