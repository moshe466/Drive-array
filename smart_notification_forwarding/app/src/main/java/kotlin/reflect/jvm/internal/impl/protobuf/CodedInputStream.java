...
public final class CodedInputStream {
    ...
    public String readString() throws IOException {
        ...
        if (readRawVarint32 > this.bufferSize - this.bufferPos || readRawVarint32 <= 0) {
            return readRawVarint32 == 0 ? JsonProperty.USE_DEFAULT_NAME : new String(readRawBytesSlowPath(readRawVarint32), "UTF-8");
        }
    ...
    private boolean tryRefillBuffer(int i) throws IOException {
        ...
        if (this.input != null) {
            ...
            if (read == 0 || read < -1 || read > this.buffer.length) {
                throw new IllegalStateException(new StringBuilder(LocationRequestCompat.QUALITY_BALANCED_POWER_ACCURACY).append("InputStream#read(byte[]) returned invalid result: ").append(read).append("\nThe InputStream implementation is buggy.").toString());
            }
            if (read > 0) {
