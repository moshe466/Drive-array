...
public final class DebugMetadataKt {
    ...
    public static final StackTraceElement getStackTraceElement(BaseContinuationImpl baseContinuationImpl) {
        ...
        return new StackTraceElement(moduleName == null ? debugMetadataAnnotation.c() : moduleName + JsonPointer.SEPARATOR + debugMetadataAnnotation.c(), debugMetadataAnnotation.m(), debugMetadataAnnotation.f(), i);
    }
