...
class e<T> {
    ...
    private final Class<?> f16028a;

    /* renamed from: b, reason: collision with root package name */
    private final String f16029b;

    /* renamed from: c, reason: collision with root package name */
    private final Class[] f16030c;
    ...
    private Method a(Class<?> cls) {
        ...
        Method b10 = b(cls, str, this.f16030c);
        if (b10 == null || (cls2 = this.f16028a) == null || cls2.isAssignableFrom(b10.getReturnType())) {
            return b10;
        }
        return null;
    }
    ...
    public Object c(T t10, Object... objArr) {
        ...
        if (a10 == null) {
            throw new AssertionError("Method " + this.f16029b + " not supported for object " + t10);
        }
        try {
