...
public class p {
    ...
    private ViewParent f2620a;

    /* renamed from: b, reason: collision with root package name */
    private ViewParent f2621b;
    ...
    private boolean h(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        ...
        if (iArr != null) {
            this.f2622c.getLocationInWindow(iArr);
            i16 = iArr[0];
            i17 = iArr[1];
        } else {
            i16 = 0;
        ...
        e0.d(i15, this.f2622c, i10, i11, i12, i13, i14, iArr3);
        if (iArr != null) {
            this.f2622c.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i16;
            iArr[1] = iArr[1] - i17;
    ...
    private void o(int i10, ViewParent viewParent) {
        if (i10 == 0) {
            this.f2620a = viewParent;
        } else {
            if (i10 != 1) {
                return;
            }
            this.f2621b = viewParent;
        }
    }
    ...
    public boolean a(float f10, float f11, boolean z10) {
        ...
        return e0.a(i10, this.f2622c, f10, f11, z10);
    }
    ...
    public boolean b(float f10, float f11) {
        ...
        return e0.b(i10, this.f2622c, f10, f11);
    }
    ...
    public boolean d(int i10, int i11, int[] iArr, int[] iArr2, int i12) {
        ...
        if (iArr2 != null) {
            this.f2622c.getLocationInWindow(iArr2);
            i14 = iArr2[0];
            i15 = iArr2[1];
        } else {
            i14 = 0;
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        e0.c(i13, this.f2622c, i10, i11, iArr, i12);
        if (iArr2 != null) {
            this.f2622c.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i14;
            iArr2[1] = iArr2[1] - i15;
    ...
    public boolean q(int i10, int i11) {
        ...
        for (ViewParent parent = this.f2622c.getParent(); parent != null; parent = parent.getParent()) {
            if (e0.f(parent, view, this.f2622c, i10, i11)) {
                o(i11, parent);
                e0.e(parent, view, this.f2622c, i10, i11);
                return true;
            }
