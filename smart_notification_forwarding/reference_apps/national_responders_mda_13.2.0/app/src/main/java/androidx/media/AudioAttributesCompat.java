...
public class AudioAttributesCompat implements a {
    ...
    private static final SparseIntArray f3257b;

    /* renamed from: a, reason: collision with root package name */
    AudioAttributesImpl f3258a;

    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        f3257b = sparseIntArray;
    ...
    public boolean equals(Object obj) {
        ...
        AudioAttributesImpl audioAttributesImpl = this.f3258a;
        AudioAttributesImpl audioAttributesImpl2 = ((AudioAttributesCompat) obj).f3258a;
