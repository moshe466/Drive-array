...
public final class n extends SpannableStringBuilder {
    ...
    public static class a implements TextWatcher, SpanWatcher {
        ...
        /* renamed from: g, reason: collision with root package name */
        private final AtomicInteger f2823g = new AtomicInteger(0);
        ...
        final void a() {
            this.f2823g.incrementAndGet();
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f2822f).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f2822f).beforeTextChanged(charSequence, i10, i11, i12);
        }

        final void c() {
            this.f2823g.decrementAndGet();
        }

        @Override // android.text.SpanWatcher
        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f2823g.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f2822f).onSpanAdded(spannable, obj, i10, i11);
            }
        }
        ...
        public void onSpanChanged(Spannable spannable, Object obj, int i10, int i11, int i12, int i13) {
            ...
            if (this.f2823g.get() <= 0 || !b(obj)) {
                ...
                ((SpanWatcher) this.f2822f).onSpanChanged(spannable, obj, i14, i11, i15, i13);
            }
        }
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f2823g.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f2822f).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f2822f).onTextChanged(charSequence, i10, i11, i12);
        }
    }
    ...
    private void b() {
        for (int i10 = 0; i10 < this.f2821g.size(); i10++) {
            this.f2821g.get(i10).a();
        }
    }
    ...
    private void e() {
        for (int i10 = 0; i10 < this.f2821g.size(); i10++) {
            this.f2821g.get(i10).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f2821g.size(); i10++) {
            a aVar = this.f2821g.get(i10);
            if (aVar.f2822f == obj) {
                return aVar;
            }
        }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new n(this.f2820f, this, i10, i11);
    }
}
