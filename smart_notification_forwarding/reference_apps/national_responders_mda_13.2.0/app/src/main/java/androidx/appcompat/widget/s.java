...
class s {
    ...
    private static final int[] f1499c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    private final ProgressBar f1500a;

    /* renamed from: b, reason: collision with root package name */
    private Bitmap f1501b;
    ...
    public void c(AttributeSet attributeSet, int i10) {
        y0 v10 = y0.v(this.f1500a.getContext(), attributeSet, f1499c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f1500a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f1500a.setProgressDrawable(d(h11, false));
        }
        v10.w();
    }
