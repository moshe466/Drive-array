...
public class AlertDialogLayout extends k0 {
    ...
    private static int B(View view) {
        int A = androidx.core.view.a0.A(view);
        if (A > 0) {
            return A;
        }
    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == e.f.P) {
                    view = childAt;
                } else if (id == e.f.f8940k) {
                    view2 = childAt;
                } else {
                    if ((id != e.f.f8942m && id != e.f.f8944o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    private void l(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                k0.a aVar = (k0.a) childAt.getLayoutParams();
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.k0$a r15 = (androidx.appcompat.widget.k0.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = androidx.core.view.a0.z(r17)
