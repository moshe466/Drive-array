...
public final class y3 extends b9 {

    /* renamed from: d, reason: collision with root package name */
    private final SSLSocketFactory f6632d;

    public y3(e9 e9Var) {
        super(e9Var);
        this.f6632d = Build.VERSION.SDK_INT < 19 ? new q9() : null;
    }
    ...
    public final HttpURLConnection x(URL url) {
        ...
        SSLSocketFactory sSLSocketFactory = this.f6632d;
