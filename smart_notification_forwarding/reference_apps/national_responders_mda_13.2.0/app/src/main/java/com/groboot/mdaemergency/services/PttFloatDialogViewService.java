...
public class PttFloatDialogViewService extends Service implements e6.b {

    /* renamed from: h, reason: collision with root package name */
    static int f8003h = -1;

    /* renamed from: f, reason: collision with root package name */
    PTTDialogView f8004f;
    ...
    class a implements p.b0 {
        ...
        public void b(p pVar) {
            if (pVar != null) {
                PttFloatDialogViewService pttFloatDialogViewService = PttFloatDialogViewService.this;
                pttFloatDialogViewService.f8004f.o(pttFloatDialogViewService.getApplicationContext(), pVar.e0());
            }
        }
    }
    ...
    class b implements p.b0 {
        ...
        public void b(p pVar) {
            ...
            pVar.E(s.a.floatView, PttFloatDialogViewService.this.g());
        }
    }
    ...
    public class c implements s {
        ...
        public boolean b(com.groboot.mdaemergency.ptt.a aVar) {
            ...
            PttFloatDialogViewService pttFloatDialogViewService = PttFloatDialogViewService.this;
            PTTDialogView pTTDialogView = pttFloatDialogViewService.f8004f;
            if (pTTDialogView != null) {
                pTTDialogView.o(pttFloatDialogViewService.getApplicationContext(), aVar);
            }
            PttFloatDialogViewService.f8003h = 0;
            return true;
        }
        ...
        public void d(p.a0 a0Var, p.a0 a0Var2) {
            ...
            sb2.append("status:");
            sb2.append(a0Var);
            PTTDialogView pTTDialogView = PttFloatDialogViewService.this.f8004f;
            if (pTTDialogView != null) {
                pTTDialogView.y();
            }
            PttFloatDialogViewService.f8003h = 0;
    ...
    */
    private e6.c.a j(android.util.DisplayMetrics r8) {
        ...
        Lc7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.groboot.mdaemergency.services.PttFloatDialogViewService.j(android.util.DisplayMetrics):e6.c$a");
    }
    ...
    public static boolean k(Context context) {
        ...
        Intent intent = new Intent(context, (Class<?>) PttFloatDialogViewService.class);
        if (i10 >= 26) {
    ...
    public static void l(Context context) {
        if (context != null) {
            context.stopService(new Intent(context, (Class<?>) PttFloatDialogViewService.class));
        }
    }
    ...
    private static void m(final Context context) {
        ...
        new Thread(new Runnable() { // from class: z5.i
            ...
            public final void run() {
                PttFloatDialogViewService.h(context);
            }
        }).start();
    }
    ...
    public void c(int i10) {
        PTTDialogView pTTDialogView = this.f8004f;
        if (pTTDialogView != null) {
            pTTDialogView.getChanelData();
        }
    }
    ...
    public void onCreate() {
        ...
        p.d0(getApplicationContext(), new b());
    }
    ...
    public int onStartCommand(Intent intent, int i10, int i11) {
        ...
        this.f8004f = new PTTDialogView(this, PTTDialogView.k.float_view);
        p.d0(getApplicationContext(), new a());
        e6.c cVar = new e6.c(this, this);
        this.f8005g = cVar;
        cVar.l(R.drawable.ic_trash_fixed);
        this.f8005g.j(R.drawable.ic_trash_action);
        i();
        c.a j10 = j(displayMetrics);
        Rect rect = new Rect();
        Resources resources = getResources();
        rect.bottom = (int) TypedValue.applyDimension(1, 50.0f, resources.getDisplayMetrics());
        rect.right = (int) TypedValue.applyDimension(1, 200.0f, resources.getDisplayMetrics());
        this.f8005g.e(this.f8004f, j10, rect);
        return 3;
    }
}
