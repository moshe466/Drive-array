...
public final class x6 extends q5 {

    /* renamed from: c, reason: collision with root package name */
    private final SSLSocketFactory f6619c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public x6(t4 t4Var) {
        super(t4Var);
        this.f6619c = Build.VERSION.SDK_INT < 19 ? new q9() : null;
    }
    ...
    public final HttpURLConnection u(URL url) {
        ...
        SSLSocketFactory sSLSocketFactory = this.f6619c;
