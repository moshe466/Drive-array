...
public class b {
    ...
    private static final ThreadLocal<Matrix> f6914a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f6915b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f6914a;
        ...
        ThreadLocal<RectF> threadLocal2 = f6915b;
