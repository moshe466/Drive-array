...
public class a {
    ...
    private static volatile a f9355c;

    /* renamed from: a, reason: collision with root package name */
    public ConcurrentHashMap f9356a = new ConcurrentHashMap();
    ...
    private final boolean f(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, boolean z10, Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((i2.c.a(context).c(packageName, 0).flags & 2097152) != 0) {
                    return false;
                }
        ...
        ServiceConnection serviceConnection2 = (ServiceConnection) this.f9356a.putIfAbsent(serviceConnection, serviceConnection);
        ...
        try {
            ...
            this.f9356a.remove(serviceConnection, serviceConnection);
        }
    }
    ...
    public void c(Context context, ServiceConnection serviceConnection) {
        if (!g(serviceConnection) || !this.f9356a.containsKey(serviceConnection)) {
            e(context, serviceConnection);
            return;
        }
        try {
            e(context, (ServiceConnection) this.f9356a.get(serviceConnection));
        } finally {
            this.f9356a.remove(serviceConnection);
        }
    }
