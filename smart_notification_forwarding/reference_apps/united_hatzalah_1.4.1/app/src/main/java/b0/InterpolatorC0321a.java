...
public final class InterpolatorC0321a implements Interpolator {
    ...
    public InterpolatorC0321a(float[] fArr) {
        this.f3799a = fArr;
        this.f3800b = 1.0f / (fArr.length - 1);
    }
