...
public class FlutterEngineGroup {
    ...
    public static class Options {
        ...
        public Options setAutomaticallyRegisterPlugins(boolean z3) {
            this.automaticallyRegisterPlugins = z3;
            return this;
        }
        ...
        public Options setWaitForRestorationData(boolean z3) {
    ...
    public FlutterEngine createEngine(Context context, PlatformViewsController platformViewsController, boolean z3, boolean z4) {
        return new FlutterEngine(context, null, null, platformViewsController, null, z3, z4, this);
    }
