...
public class WebViewActivity extends Activity {
    ...
    public static Intent createIntent(Context context, String str, boolean z3, boolean z4, Bundle bundle) {
        return new Intent(context, (Class<?>) WebViewActivity.class).putExtra("url", str).putExtra(ENABLE_JS_EXTRA, z3).putExtra(ENABLE_DOM_EXTRA, z4).putExtra("com.android.browser.headers", bundle);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        AbstractC0773d.c(this, this.broadcastReceiver, this.closeIntentFilter);
    }
