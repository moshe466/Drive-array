...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    private I.a windowInfoListener;
    ...
    private View findViewByAccessibilityIdRootedAtCurrentView(int i, View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            while (true) {
                ...
                View findViewByAccessibilityIdRootedAtCurrentView = findViewByAccessibilityIdRootedAtCurrentView(i, viewGroup.getChildAt(i3));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void resetWillNotDraw(boolean z3, boolean z4) {
        boolean z5 = false;
    ...
    public WindowInfoRepositoryCallbackAdapterWrapper createWindowInfoRepo() {
        try {
            ...
            Context context = getContext();
            gVar.getClass();
            return new WindowInfoRepositoryCallbackAdapterWrapper(new C0783a(g.a(context)));
    ...
    */
    ...
    public void onAttachedToWindow() {
        ...
        if (windowInfoRepositoryCallbackAdapterWrapper != null && activity != null) {
            this.windowInfoListener = new a(this, 0);
            Context context = getContext();
            if (Build.VERSION.SDK_INT >= 28) {
                dVar = AbstractC0771b.a(context);
            } else {
                dVar = new d(new Handler(context.getMainLooper()), 0);
            }
            windowInfoRepositoryCallbackAdapterWrapper.addWindowLayoutInfoListener(activity, dVar, this.windowInfoListener);
        }
    }
    ...
    public void onSizeChanged(int i, int i3, int i4, int i5) {
        ...
        Log.v(TAG, "Size changed. Sending Flutter new viewport metrics. FlutterView was " + i4 + " x " + i5 + ", it is now " + i + " x " + i3);
    ...
    */
    ...
    public void setWindowInfoListenerDisplayFeatures(j jVar) {
        ...
        z0.b bVar2 = z0.b.f6811e;
        ?? r7 = jVar.f6834a;
        ArrayList arrayList = new ArrayList();
        for (z0.c cVar : r7) {
            Log.v(TAG, "WindowInfoTracker Display Feature reported with bounds = " + cVar.f6817a.a().toString() + " and type = " + cVar.getClass().getSimpleName());
            C0746b c0746b = cVar.f6817a;
            if (c0746b.f6684c - c0746b.f6682a != 0 && c0746b.f6685d - c0746b.f6683b != 0) {
                bVar = bVar2;
            } else {
                bVar = z0.b.f6810d;
            }
            ...
            arrayList.add(new FlutterRenderer.DisplayFeature(c0746b.a(), displayFeatureType, displayFeatureState));
        }
    ...
    public FlutterView(Context context, RenderMode renderMode) {
        ...
        this.onAccessibilityChangeListener = new AccessibilityBridge.OnAccessibilityChangeListener() { // from class: io.flutter.embedding.android.FlutterView.1
            ...
            public void onAccessibilityChanged(boolean z3, boolean z4) {
                FlutterView.this.resetWillNotDraw(z3, z4);
            }
        };
