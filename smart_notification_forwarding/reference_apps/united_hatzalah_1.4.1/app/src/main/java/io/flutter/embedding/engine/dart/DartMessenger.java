...
public class DartMessenger implements BinaryMessenger, PlatformMessageHandler {
    ...
    public static class BufferedMessageInfo {
        ...
        public BufferedMessageInfo(ByteBuffer byteBuffer, int i, long j2) {
    ...
    private void dispatchMessageToQueue(final String str, final HandlerInfo handlerInfo, final ByteBuffer byteBuffer, final int i, final long j2) {
        ...
        Runnable runnable = new Runnable() { // from class: io.flutter.embedding.engine.dart.a
            ...
            public final void run() {
                DartMessenger.this.lambda$dispatchMessageToQueue$0(str, i, handlerInfo, byteBuffer, j2);
            }
        };
    ...
    public /* synthetic */ void lambda$dispatchMessageToQueue$0(String str, int i, HandlerInfo handlerInfo, ByteBuffer byteBuffer, long j2) {
    ...
    public void handleMessageFromDart(String str, ByteBuffer byteBuffer, int i, long j2) {
        ...
        synchronized (this.handlersLock) {
            try {
                ...
                if (z3) {
                    ...
                    this.bufferedMessages.get(str).add(new BufferedMessageInfo(byteBuffer, i, j2));
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        if (!z3) {
            dispatchMessageToQueue(str, handlerInfo, byteBuffer, i, j2);
        }
    }
