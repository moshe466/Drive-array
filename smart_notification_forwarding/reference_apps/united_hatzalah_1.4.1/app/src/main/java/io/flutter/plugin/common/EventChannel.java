        ...
        private void onCancel(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            if (this.activeSink.getAndSet(null) != null) {
                try {
                    ...
                    Log.e(EventChannel.TAG + EventChannel.this.name, "Failed to close event stream", e4);
                    binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e4.getMessage(), null));
                    return;
                }
            }
            binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "No active stream to cancel", null));
        }
        ...
        private void onListen(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            ...
            if (this.activeSink.getAndSet(eventSinkImplementation) != null) {
                try {
                    ...
                    Log.e(EventChannel.TAG + EventChannel.this.name, "Failed to close existing event stream", e4);
                }
            }
            try {
                ...
                Log.e(EventChannel.TAG + EventChannel.this.name, "Failed to open event stream", e5);
                binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e5.getMessage(), null));
            }
        }
