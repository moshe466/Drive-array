...
public class RestorationChannel {
    ...
    public RestorationChannel(DartExecutor dartExecutor, boolean z3) {
        this(new MethodChannel(dartExecutor, "flutter/restoration", StandardMethodCodec.INSTANCE), z3);
    }
    ...
    public RestorationChannel(MethodChannel methodChannel, boolean z3) {
