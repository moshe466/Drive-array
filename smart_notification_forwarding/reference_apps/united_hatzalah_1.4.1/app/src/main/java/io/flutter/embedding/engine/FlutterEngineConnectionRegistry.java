...
public class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    public static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        public FlutterEngineActivityPluginBinding(Activity activity, AbstractC0305o abstractC0305o) {
            this.activity = activity;
            this.hiddenLifecycleReference = new HiddenLifecycleReference(abstractC0305o);
        }
        ...
        public boolean onActivityResult(int i, int i3, Intent intent) {
            ...
            while (true) {
                boolean z3 = false;
                while (it.hasNext()) {
                    if (((PluginRegistry.ActivityResultListener) it.next()).onActivityResult(i, i3, intent) || z3) {
                        z3 = true;
                    }
                }
                return z3;
        ...
        public boolean onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
            ...
            while (true) {
                boolean z3 = false;
                while (it.hasNext()) {
                    if (it.next().onRequestPermissionsResult(i, strArr, iArr) || z3) {
                        z3 = true;
                    }
                }
                return z3;
    ...
    public static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        public FlutterEngineServicePluginBinding(Service service, AbstractC0305o abstractC0305o) {
            HiddenLifecycleReference hiddenLifecycleReference;
            this.service = service;
            if (abstractC0305o != null) {
                hiddenLifecycleReference = new HiddenLifecycleReference(abstractC0305o);
            } else {
    ...
    private void attachToActivityInternal(Activity activity, AbstractC0305o abstractC0305o) {
        boolean z3;
        this.activityPluginBinding = new FlutterEngineActivityPluginBinding(activity, abstractC0305o);
        if (activity.getIntent() != null) {
            z3 = activity.getIntent().getBooleanExtra(FlutterShellArgs.ARG_KEY_ENABLE_SOFTWARE_RENDERING, false);
        } else {
            z3 = false;
        }
        this.flutterEngine.getPlatformViewsController().setSoftwareRendering(z3);
        this.flutterEngine.getPlatformViewsControllerDelegator().attach(activity, this.flutterEngine.getRenderer(), this.flutterEngine.getDartExecutor());
    ...
    public void attachToActivity(ExclusiveAppComponent<Activity> exclusiveAppComponent, AbstractC0305o abstractC0305o) {
        ...
        try {
            ...
            attachToActivityInternal(exclusiveAppComponent.getAppComponent(), abstractC0305o);
            if (scoped != null) {
                scoped.close();
            }
        } catch (Throwable th) {
    ...
    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver, AbstractC0305o abstractC0305o) {
    ...
    public void attachToContentProvider(ContentProvider contentProvider, AbstractC0305o abstractC0305o) {
    ...
    public void attachToService(Service service, AbstractC0305o abstractC0305o, boolean z3) {
        TraceSection scoped = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
            this.service = service;
            this.servicePluginBinding = new FlutterEngineServicePluginBinding(service, abstractC0305o);
    ...
    public boolean onActivityResult(int i, int i3, Intent intent) {
        if (isAttachedToActivity()) {
            ...
            try {
                boolean onActivityResult = this.activityPluginBinding.onActivityResult(i, i3, intent);
                if (scoped != null) {
                    scoped.close();
                }
