...
public final class ApplicationInfoLoader {
    ...
    private static boolean getBoolean(Bundle bundle, String str, boolean z3) {
        if (bundle == null) {
            return z3;
        }
        return bundle.getBoolean(str, z3);
    }
    ...
    private static void parseDomain(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z3) {
    ...
    private static void parseDomainConfig(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z3) {
