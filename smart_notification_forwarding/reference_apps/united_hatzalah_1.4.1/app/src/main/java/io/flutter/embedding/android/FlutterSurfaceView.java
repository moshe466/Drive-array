...
public class FlutterSurfaceView extends SurfaceView implements RenderSurface {
    ...
    public void changeSurfaceSize(int i, int i3) {
        if (this.flutterRenderer != null) {
            Log.v(TAG, "Notifying FlutterRenderer that Android surface size has changed to " + i + " x " + i3);
            this.flutterRenderer.surfaceChanged(i, i3);
            return;
        }
    ...
    private FlutterSurfaceView(Context context, AttributeSet attributeSet, boolean z3) {
