...
public class GeneratedAndroidFirebaseCore {
    ...
    public interface FirebaseAppHostApi {
        ...
        static void setUp(BinaryMessenger binaryMessenger, String str, final FirebaseAppHostApi firebaseAppHostApi) {
            ...
            BasicMessageChannel basicMessageChannel = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseAppHostApi.setAutomaticDataCollectionEnabled", concat), getCodec());
            if (firebaseAppHostApi != null) {
                final int i = 0;
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseAppHostApi) { // from class: io.flutter.plugins.firebase.core.d

                    /* renamed from: b, reason: collision with root package name */
                    public final /* synthetic */ GeneratedAndroidFirebaseCore.FirebaseAppHostApi f5058b;

                    {
                        this.f5058b = firebaseAppHostApi;
                    }
                    ...
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        switch (i) {
                            case 0:
                                GeneratedAndroidFirebaseCore.FirebaseAppHostApi.lambda$setUp$0(this.f5058b, obj, reply);
                                return;
                            case 1:
                                GeneratedAndroidFirebaseCore.FirebaseAppHostApi.lambda$setUp$1(this.f5058b, obj, reply);
                                return;
                            default:
                                GeneratedAndroidFirebaseCore.FirebaseAppHostApi.lambda$setUp$2(this.f5058b, obj, reply);
                                return;
                        }
                    }
                });
            ...
            BasicMessageChannel basicMessageChannel2 = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseAppHostApi.setAutomaticResourceManagementEnabled", concat), getCodec());
            if (firebaseAppHostApi != null) {
                final int i3 = 1;
                basicMessageChannel2.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseAppHostApi) { // from class: io.flutter.plugins.firebase.core.d
            ...
            BasicMessageChannel basicMessageChannel3 = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseAppHostApi.delete", concat), getCodec());
            if (firebaseAppHostApi != null) {
                final int i4 = 2;
                basicMessageChannel3.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseAppHostApi) { // from class: io.flutter.plugins.firebase.core.d
    ...
    public interface FirebaseCoreHostApi {
        ...
        static void setUp(BinaryMessenger binaryMessenger, String str, final FirebaseCoreHostApi firebaseCoreHostApi) {
            String concat = str.isEmpty() ? "" : ".".concat(str);
            BasicMessageChannel basicMessageChannel = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseCoreHostApi.initializeApp", concat), getCodec());
            if (firebaseCoreHostApi != null) {
                final int i = 0;
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseCoreHostApi) { // from class: io.flutter.plugins.firebase.core.e

                    /* renamed from: b, reason: collision with root package name */
                    public final /* synthetic */ GeneratedAndroidFirebaseCore.FirebaseCoreHostApi f5060b;

                    {
                        this.f5060b = firebaseCoreHostApi;
                    }
                    ...
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        switch (i) {
                            case 0:
                                GeneratedAndroidFirebaseCore.FirebaseCoreHostApi.lambda$setUp$0(this.f5060b, obj, reply);
                                return;
                            case 1:
                                GeneratedAndroidFirebaseCore.FirebaseCoreHostApi.lambda$setUp$1(this.f5060b, obj, reply);
                                return;
                            default:
                                GeneratedAndroidFirebaseCore.FirebaseCoreHostApi.lambda$setUp$2(this.f5060b, obj, reply);
                                return;
                        }
                    }
                });
            ...
            BasicMessageChannel basicMessageChannel2 = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseCoreHostApi.initializeCore", concat), getCodec());
            if (firebaseCoreHostApi != null) {
                final int i3 = 1;
                basicMessageChannel2.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseCoreHostApi) { // from class: io.flutter.plugins.firebase.core.e
            ...
            BasicMessageChannel basicMessageChannel3 = new BasicMessageChannel(binaryMessenger, e0.a.d("dev.flutter.pigeon.firebase_core_platform_interface.FirebaseCoreHostApi.optionsFromResource", concat), getCodec());
            if (firebaseCoreHostApi != null) {
                final int i4 = 2;
                basicMessageChannel3.setMessageHandler(new BasicMessageChannel.MessageHandler(firebaseCoreHostApi) { // from class: io.flutter.plugins.firebase.core.e
