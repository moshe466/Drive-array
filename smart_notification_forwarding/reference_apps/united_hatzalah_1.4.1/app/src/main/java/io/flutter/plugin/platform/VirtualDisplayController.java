...
public class VirtualDisplayController {
    ...
    public static VirtualDisplayController create(Context context, AccessibilityEventsDelegate accessibilityEventsDelegate, PlatformView platformView, PlatformViewRenderTarget platformViewRenderTarget, int i, int i3, int i4, Object obj, View.OnFocusChangeListener onFocusChangeListener) {
        if (i == 0 || i3 == 0) {
            return null;
        }
        ...
        VirtualDisplay createVirtualDisplay = displayManager.createVirtualDisplay(e0.a.c(i4, "flutter-vd#"), i, i3, displayMetrics.densityDpi, platformViewRenderTarget.getSurface(), 0, callback, null);
    ...
    private void resize31(View view, int i, int i3, Runnable runnable) {
        this.renderTarget.resize(i, i3);
        this.virtualDisplay.resize(i, i3, this.densityDpi);
    ...
    public void resize(int i, int i3, final Runnable runnable) {
        ...
        this.renderTarget.resize(i, i3);
        this.virtualDisplay = displayManager.createVirtualDisplay("flutter-vd#" + this.viewId, i, i3, this.densityDpi, this.renderTarget.getSurface(), 0, callback, null);
