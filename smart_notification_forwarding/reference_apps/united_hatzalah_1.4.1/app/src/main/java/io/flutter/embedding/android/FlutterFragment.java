...
public class FlutterFragment extends G implements FlutterActivityAndFragmentDelegate.Host, ComponentCallbacks2, FlutterActivityAndFragmentDelegate.DelegateFactory {
    ...
    private final ViewTreeObserver.OnWindowFocusChangeListener onWindowFocusChangeListener = new ViewTreeObserver.OnWindowFocusChangeListener() { // from class: io.flutter.embedding.android.FlutterFragment.1
        ...
        public void onWindowFocusChanged(boolean z3) {
            if (FlutterFragment.this.stillAttachedForEvent("onWindowFocusChanged")) {
                FlutterFragment.this.delegate.onWindowFocusChanged(z3);
            }
        }
    };
    private FlutterActivityAndFragmentDelegate.DelegateFactory delegateFactory = this;
    final p onBackPressedCallback = new p(true) { // from class: io.flutter.embedding.android.FlutterFragment.2
        @Override // c.p
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public <T extends FlutterFragment> T build() {
            try {
                T t3 = (T) this.fragmentClass.getDeclaredConstructor(null).newInstance(null);
                if (t3 != null) {
                    t3.setArguments(createArgs());
                    return t3;
                }
        ...
        public CachedEngineFragmentBuilder destroyEngineWithFragment(boolean z3) {
            this.destroyEngineWithFragment = z3;
            return this;
        }
        ...
        public CachedEngineFragmentBuilder shouldAttachEngineToActivity(boolean z3) {
            this.shouldAttachEngineToActivity = z3;
            return this;
        }

        public CachedEngineFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z3) {
            this.shouldAutomaticallyHandleOnBackPressed = z3;
            return this;
        }

        public CachedEngineFragmentBuilder shouldDelayFirstAndroidViewDraw(boolean z3) {
            this.shouldDelayFirstAndroidViewDraw = z3;
            return this;
        }
    ...
    public static class NewEngineInGroupFragmentBuilder {
        ...
        public NewEngineInGroupFragmentBuilder handleDeeplinking(boolean z3) {
            this.handleDeeplinking = z3;
            return this;
        }
        ...
        public NewEngineInGroupFragmentBuilder shouldAttachEngineToActivity(boolean z3) {
            this.shouldAttachEngineToActivity = z3;
            return this;
        }

        public NewEngineInGroupFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z3) {
            this.shouldAutomaticallyHandleOnBackPressed = z3;
            return this;
        }

        public NewEngineInGroupFragmentBuilder shouldDelayFirstAndroidViewDraw(boolean z3) {
            this.shouldDelayFirstAndroidViewDraw = z3;
            return this;
        }
    ...
    public void setFrameworkHandlesBack(boolean z3) {
        ...
        this.onBackPressedCallback.setEnabled(z3);
    }
    ...
    public boolean shouldDestroyEngineWithHost() {
        boolean z3 = getArguments().getBoolean(ARG_DESTROY_ENGINE_WITH_FRAGMENT, false);
    ...
    public static class NewEngineFragmentBuilder {
        ...
        public NewEngineFragmentBuilder shouldAttachEngineToActivity(boolean z3) {
            this.shouldAttachEngineToActivity = z3;
            return this;
        }

        public NewEngineFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z3) {
            this.shouldAutomaticallyHandleOnBackPressed = z3;
            return this;
        }

        public NewEngineFragmentBuilder shouldDelayFirstAndroidViewDraw(boolean z3) {
            this.shouldDelayFirstAndroidViewDraw = z3;
            return this;
        }
