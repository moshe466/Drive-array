...
public class InputConnectionAdaptor extends BaseInputConnection implements ListenableEditingState.EditingStateWatcher {
    ...
    private boolean handleHorizontalMovement(boolean z3, boolean z4) {
        int min;
        int selectionStart = Selection.getSelectionStart(this.mEditable);
        int selectionEnd = Selection.getSelectionEnd(this.mEditable);
    ...
    private boolean handleVerticalMovement(boolean z3, boolean z4) {
        int selectionStart = Selection.getSelectionStart(this.mEditable);
        int selectionEnd = Selection.getSelectionEnd(this.mEditable);
        boolean z5 = false;
        if (selectionStart < 0 || selectionEnd < 0) {
    ...
    public boolean deleteSurroundingTextInCodePoints(int i, int i3) {
        return super.deleteSurroundingTextInCodePoints(i, i3);
    }

    @Override // io.flutter.plugin.editing.ListenableEditingState.EditingStateWatcher
    public void didChangeEditingState(boolean z3, boolean z4, boolean z5) {
    ...
    public boolean requestCursorUpdates(int i) {
        ...
        if (z3 != this.mMonitorCursorUpdate) {
            if (z3) {
                str = "on";
            } else {
                str = "off";
            }
            Log.d(TAG, "The input method toggled cursor monitoring ".concat(str));
        }
        this.mMonitorCursorUpdate = z3;
        return true;
    }
    ...
    @Override // android.view.inputmethod.BaseInputConnection, android.view.inputmethod.InputConnection
    public boolean setComposingRegion(int i, int i3) {
        return super.setComposingRegion(i, i3);
    }
    ...
    @Override // android.view.inputmethod.BaseInputConnection, android.view.inputmethod.InputConnection
    public boolean setSelection(int i, int i3) {
        beginBatchEdit();
        boolean selection = super.setSelection(i, i3);
        endBatchEdit();
        return selection;
    }
    ...
    public ExtractedText getExtractedText(ExtractedTextRequest extractedTextRequest, int i) {
        boolean z3 = (i & 1) != 0;
        if (z3 == (this.mExtractRequest == null)) {
            Log.d(TAG, "The input method toggled text monitoring ".concat(z3 ? "on" : "off"));
        }
        this.mExtractRequest = z3 ? extractedTextRequest : null;
