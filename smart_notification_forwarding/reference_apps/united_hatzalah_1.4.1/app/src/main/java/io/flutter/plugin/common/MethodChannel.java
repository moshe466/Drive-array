...
public class MethodChannel {
    ...
    public final class IncomingMethodCallHandler implements BinaryMessenger.BinaryMessageHandler {
        ...
        public void onMessage(ByteBuffer byteBuffer, final BinaryMessenger.BinaryReply binaryReply) {
            try {
                ...
                Log.e(MethodChannel.TAG + MethodChannel.this.name, "Failed to handle method call", e4);
                binaryReply.reply(MethodChannel.this.codec.encodeErrorEnvelopeWithStacktrace(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e4.getMessage(), null, Log.getStackTraceString(e4)));
            }
        }
    }
            ...
            try {
                if (byteBuffer == null) {
                    ...
                    try {
                        ...
                        this.callback.error(e4.code, e4.getMessage(), e4.details);
                    }
                }
    ...
    public void setWarnsOnChannelOverflow(boolean z3) {
        BasicMessageChannel.setWarnsOnChannelOverflow(this.messenger, this.name, z3);
    }
