...
public class PipesResult {
    ...
    private PipesResult(STATUS status, EmitData emitData, String str, boolean z3) {
        this.status = status;
        this.emitData = emitData;
        this.message = str;
        this.intermediate = z3;
    }
    ...
    public PipesResult(STATUS status, EmitData emitData, boolean z3) {
        this(status, emitData, null, z3);
    }
