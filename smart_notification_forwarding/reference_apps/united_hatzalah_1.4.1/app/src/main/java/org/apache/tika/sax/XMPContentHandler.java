...
public class XMPContentHandler extends SafeContentHandler {
    ...
    private void description(Metadata metadata, String str, String str2) {
        int i = 0;
    ...
    public void property(String str, String str2) {
        String o2 = AbstractC0008a.o(this.prefix, TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER, str);
        startElement(this.uri, str, o2, EMPTY_ATTRIBUTES);
        characters(str2.toCharArray(), 0, str2.length());
        endElement(this.uri, str, o2);
    }

    public void startDescription(String str, String str2, String str3) {
        this.prefix = str2;
        this.uri = str3;
