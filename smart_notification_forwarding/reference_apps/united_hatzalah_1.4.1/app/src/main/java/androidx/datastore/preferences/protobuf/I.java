...
public abstract class I {
    ...
    public static final char[] f3099a;
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            ...
            sb.append(m3.b.l(new C0240g(((String) obj).getBytes(AbstractC0255w.f3236a))));
            sb.append('\"');
            return;
        }
        if (obj instanceof C0240g) {
            sb.append(": \"");
            sb.append(m3.b.l((C0240g) obj));
            sb.append('\"');
            return;
        }
        if (obj instanceof AbstractC0253u) {
            sb.append(" {");
            c((AbstractC0253u) obj, sb, i + 2);
            sb.append("\n");
            a(i, sb);
            sb.append("}");
            return;
    ...
    */
    public static void c(androidx.datastore.preferences.protobuf.AbstractC0253u r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 566
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.I.c(androidx.datastore.preferences.protobuf.u, java.lang.StringBuilder, int):void");
    }
}
