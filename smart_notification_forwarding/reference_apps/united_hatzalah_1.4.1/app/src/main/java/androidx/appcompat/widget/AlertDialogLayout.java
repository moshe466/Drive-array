...
public class AlertDialogLayout extends B0 {
    ...
    */
    ...
    public final void onMeasure(int i, int i3) {
        ...
        int i13 = i3;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + i11, i, i4), View.resolveSizeAndState(paddingBottom, i13, 0));
        if (mode2 != 1073741824) {
            ...
            while (i14 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) a02).width == -1) {
                        int i15 = ((LinearLayout.LayoutParams) a02).height;
                        ((LinearLayout.LayoutParams) a02).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i13, 0);
                        ((LinearLayout.LayoutParams) a02).height = i15;
                    }
                }
                i14++;
