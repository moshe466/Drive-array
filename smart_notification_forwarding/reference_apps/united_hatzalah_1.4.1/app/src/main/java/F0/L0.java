...
public abstract class L0 extends T0 {
    ...
    public final C0021d0 f244f;

    /* renamed from: g, reason: collision with root package name */
    public final C0054l1 f245g;
    ...
    static {
        ...
        long j18 = 1970086008;
        long j19 = (((1538717152 | i) + 9586376) - (i | 1538717672)) - 1979672320;
        ...
        byte[] bArr = {-69, (int) (((j33 | (j33 >>> 4)) & 16711935) + (j27 | (((j30 | (j30 >>> 4)) & 16711935) << 8))), 98, 50, -127};
        z(bArr, new byte[]{-77, -29, -74, -27, -26, -61, 43, 67});
        new String(bArr, StandardCharsets.UTF_8).intern();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public L0(C0093v1 c0093v1, C0021d0 c0021d0, C0054l1 c0054l1) {
        super(c0093v1);
        byte[] bArr = {106, 63, -89, -16, 121, -77};
        z(bArr, new byte[]{122, 98, 126, 57, 28, -63, -79, 57});
        Charset charset = StandardCharsets.UTF_8;
        new String(bArr, charset).intern();
        byte[] bArr2 = {75, 91, -24, 110, -1, 60};
        z(bArr2, new byte[]{66, 9, 51, -72, -112, 78, -77, 100});
        kotlin.jvm.internal.j.e(c0021d0, new String(bArr2, charset).intern());
        byte[] bArr3 = {-114, 125, -12, 100, -66, -14, 55, 75};
        long j2 = -1175671426;
        long j3 = -3;
        ...
        long j33 = (j32 | (j32 >>> 2)) & 252645135;
        z(bArr3, new byte[]{-104, 46, ((((int) ((((j17 >>> 4) | j17) & 16711935) | (((((j14 >>> 4) | j14) & 16711935) << 8) | j11))) & (-1534851316)) + (((int) (((j33 | (j33 >>> 4)) & 16711935) + ((((j30 | (j30 >>> 4)) & 16711935) << 8) + j27))) | 140652642)) ^ (-1394198711), -95, -90, -91, -42, -101});
