            ...
            if (c4 != 17620) {
                if (c4 != 29223) {
                    if (c4 != 45522) {
                        ...
                        byte[] bArr = {-28, -26, 64, 96, -4, -71};
                        c(bArr, new byte[]{-4, -79, -97, -89, -79, -54, 35, -28});
                        jSONObject2.put(new String(bArr, StandardCharsets.UTF_8).intern(), longValue);
                    }
                }
                c4 = 58141;
            } else {
                jSONObject2 = new JSONObject();
                byte[] bArr2 = {-115, -126, 36, 81, -123, 77};
                c(bArr2, new byte[]{-102, -32, -9, -121, -16, 62, 67, 18});
                jSONObject2.put(new String(bArr2, StandardCharsets.UTF_8).intern(), this.f429a.f411a);
                l3 = this.f430b;
