...
public abstract class AbstractC0095w extends T0 {

    /* renamed from: f, reason: collision with root package name */
    public final C0054l1 f700f;

    /* JADX WARN: Failed to find 'out' block for switch in B:3:0x0201. Please report as an issue. */
    static {
        int i;
        byte[] bArr;
        int i3;
        int i4 = 1;
        byte[] bArr2 = {-107, 70, 48, -58, 42, -95, -125, 68, -21, -99};
        ...
        bArr3[4] = 68;
        long j2 = -1568075228;
        long j3 = (~AbstractC0095w.class.getName().length()) | (-1115657226);
        ...
        int length = AbstractC0095w.class.getName().length();
        int length2 = ((AbstractC0095w.class.getName().length() | 1107890496) - (length | 1107890496)) + AbstractC0008a.f(AbstractC0095w.class, length) + (AbstractC0095w.class.getName().length() & 1107890496);
        bArr3[(-494184607) ^ ((((((AbstractC0095w.class.getName().length() & (~length2)) & 1073890624) + 1073890624) + length2) - ((AbstractC0095w.class.getName().length() | length2) & 1073890624)) + ((int) (((j17 | (j17 >>> 4)) & 16711935) | (((((j14 >>> 4) | j14) & 16711935) << 8) | j11))))] = -64;
        bArr3[6] = -31;
        bArr3[7] = 40;
        bArr3[8] = -114;
        bArr3[9] = -7;
        ...
        while (true) {
            ...
            int i9 = i7 >>> 8;
            int i10 = (i9 - i4) - ((~i8) | i9);
            int i11 = (-1700147435) - ((i10 & 2) | (2028104049 - i10));
            int i12 = -1396193641;
            switch ((-1363443157) ^ ((~i11) + ((i11 | 1) * 2))) {
                case -1940167324:
                    i = i4;
                    bArr = bArr4;
                    byte b4 = bArr[i5];
                    int i13 = ((byte) 0) - b4;
                    bArr[i5] = (byte) (((byte) (b4 & (~i13))) - ((byte) ((~b4) & i13)));
                    i7 = 614229416;
                    i4 = i;
                    bArr4 = bArr;
                case -360299937:
                    i = i4;
                    bArr = bArr4;
                    if ((bArr[i6] > Double.NaN ? 1 : (bArr[i6] == Double.NaN ? 0 : -1)) <= -1) {
                        i3 = 0;
                    } else {
                        i3 = i;
                    }
                ...
                case 1733787683:
                    byte b5 = bArr5[i5];
                    byte b6 = bArr4[i5];
                    bArr5[i5] = (byte) (((byte) (b6 + b5)) - ((byte) (((byte) 2) * ((byte) (b6 & b5)))));
                    i6 = (i5 ^ 1) + ((i5 & 1) * 2);
                    i = i4;
                    bArr = bArr4;
    ...
    public AbstractC0095w(C0093v1 c0093v1, C0054l1 c0054l1) {
        super(c0093v1);
        byte[] bArr = new byte[6];
        int i = ((~AbstractC0095w.class.getName().length()) | 2091534278) & 1720709;
        int length = ((AbstractC0095w.class.getName().length() | (-5511170)) - (-5511170)) | (-2126243776);
        bArr[(((i & length) * 2) + (length ^ i)) ^ (-2124523067)] = -27;
        bArr[1] = -10;
        bArr[2] = -20;
        bArr[3] = -4;
        bArr[4] = -8;
        bArr[5] = 98;
        r(bArr, new byte[]{-96, 105, -95, -126, -99, ((((~AbstractC0095w.class.getName().length()) | (-1689150353)) & (-2013214520)) + ((AbstractC0095w.class.getName().length() & 4210818) | 557850627)) ^ (-1455363877), -40, -4});
        Charset charset = StandardCharsets.UTF_8;
        new String(bArr, charset).intern();
        long j2 = -2073660381;
        long length2 = (((~AbstractC0095w.class.getName().length()) | (-1788184858)) & 463014020) + ((AbstractC0095w.class.getName().length() & 1251051520) | 1610646273);
        ...
        byte[] bArr2 = {36, -125, 96, 52, 79, -97, -67, (int) ((((((j13 >>> 4) | j13) & 16711935) << 8) + j10) | (((j16 >>> 4) | j16) & 16711935))};
        byte[] bArr3 = new byte[8];
        bArr3[0] = 109;
        bArr3[1] = -74;
        bArr3[2] = 23;
        bArr3[3] = 62;
        int i3 = ~AbstractC0095w.class.getName().length();
        bArr3[4] = (((~(((AbstractC0095w.class.getName().length() | 416078872) | i3) - (i3 | (AbstractC0095w.class.getName().length() & (-416078873))))) & (-1874558136)) + ((AbstractC0095w.class.getName().length() & 340037656) | 67114000)) ^ (-1807444214);
        bArr3[5] = -58;
        int i4 = ((~AbstractC0095w.class.getName().length()) | (-536887297)) - 1572709884;
        int length3 = (AbstractC0095w.class.getName().length() & 536896524) | 227582988;
        int i5 = -i4;
        int i6 = i5 | length3;
        bArr3[(-1345126903) ^ ((i6 - (i5 * 2)) + ((length3 ^ i5) ^ i6))] = -24;
        bArr3[7] = -81;
        r(bArr2, bArr3);
