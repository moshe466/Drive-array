...
public final class C0065o0 {

    /* renamed from: a, reason: collision with root package name */
    public final G2 f598a;

    static {
        int f4 = (AbstractC0008a.f(C0065o0.class, -1) | 350981191) & 553812226;
        long j2 = 329760;
        long length = C0065o0.class.getName().length() & 553912576;
        ...
        byte[] bArr = new byte[(f4 + ((int) ((((j15 >>> 4) | j15) & 16711935) | (((((j12 >>> 4) | j12) & 16711935) << 8) + j9)))) ^ 554141998];
        bArr[0] = -102;
        bArr[1] = 45;
        bArr[2] = 47;
        bArr[3] = 84;
        ...
        bArr2[3] = -126;
        long j16 = 35656323;
        long j17 = (~C0065o0.class.getName().length()) | (-516170841);
        ...
        int i = (int) (((j31 | (j31 >>> 4)) & 16711935) + (((j28 | (j28 >>> 4)) & 16711935) << 8) + j25);
        int length2 = C0065o0.class.getName().length();
        bArr2[(i + (135595028 | (((C0065o0.class.getName().length() | 34668544) - (length2 | 34668544)) + (AbstractC0008a.f(C0065o0.class, length2) + (C0065o0.class.getName().length() & 34668544))))) ^ 171251347] = -34;
        bArr2[5] = -57;
        bArr2[6] = -99;
        bArr2[7] = -122;
        bArr2[8] = -15;
        bArr2[9] = -41;
        bArr2[10] = -31;
        int i3 = ~C0065o0.class.getName().length();
        int i4 = 722863890 & (((~i3) & (-1952823200)) + i3);
        int length3 = (C0065o0.class.getName().length() & 813967130) | 343941132;
        bArr2[11] = 1066805118 ^ ((length3 & i4) + (length3 | i4));
        c(bArr, bArr2);
    ...
    /*  JADX ERROR: NullPointerException in pass: InitCodeVariables
        ...
        */
    public C0065o0(android.content.Context r53) {
        /*
            Method dump skipped, instructions count: 1314
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: F0.C0065o0.<init>(android.content.Context):void");
    }
    ...
    public final void a(String str) {
        long j2 = -1;
        long length = C0065o0.class.getName().length();
        ...
        int i3 = (~(((C0065o0.class.getName().length() | (-416970041)) | i) - (i | (C0065o0.class.getName().length() & 416970040)))) & (-1071771648);
        int length2 = (C0065o0.class.getName().length() & (-939259903)) | 134236161;
        byte[] bArr = {AbstractC0099x.a(i3 | length2, 2, (~i3) ^ length2) ^ (-937535416), -47, 93, -20, -17, 41, 49, -17, -118, -1, -6};
        b(bArr, new byte[]{57, -80, 62, -121, -114, 78, 84, -95, -21, -110, -97});
        ...
        bArr2[1] = -121;
        long j17 = 85205799;
        long length3 = (((~C0065o0.class.getName().length()) | (-1854384374)) & 84943393) + ((C0065o0.class.getName().length() & 67117345) | 262404);
        ...
        long j31 = (j30 | (j30 >>> 2)) & 252645135;
        bArr2[(int) (((j31 | (j31 >>> 4)) & 16711935) + ((((j28 >>> 4) | j28) & 16711935) << 8) + j25)] = 14;
        ...
        bArr2[8] = 61;
        bArr2[9] = -16;
        int i4 = ((~C0065o0.class.getName().length()) | 2090355541) & 1611728926;
        long j32 = 82186;
        long length4 = C0065o0.class.getName().length();
        ...
        bArr2[(i4 + (((int) ((((((j43 >>> 4) | j43) & 16711935) << 8) + j40) | ((j46 | (j46 >>> 4)) & 16711935))) | (-2138943231))) ^ (-527214315)] = -3;
        bArr2[11] = -108;
        b(bArr2, new byte[]{-65, -24, 97, (-919008495) ^ (((AbstractC0008a.f(C0065o0.class, -1) | (-8527878)) + 880944294) + ((C0065o0.class.getName().length() & 8806405) | 38064192)), -89, -84, 8, 73, 86, -111, -102, -15});
        this.f598a.d(new String(bArr2, charset).intern(), str);
    }
}
