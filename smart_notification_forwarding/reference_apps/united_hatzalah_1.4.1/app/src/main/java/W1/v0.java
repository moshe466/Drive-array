...
public final class v0 extends AbstractC0351x {
    private static final v0 DEFAULT_INSTANCE;
    private static volatile com.google.crypto.tink.shaded.protobuf.W PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private int version_;

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.crypto.tink.shaded.protobuf.x, W1.v0] */
    static {
        ?? abstractC0351x = new AbstractC0351x();
        DEFAULT_INSTANCE = abstractC0351x;
        AbstractC0351x.t(v0.class, abstractC0351x);
    }
    ...
    public static v0 x(AbstractC0337i abstractC0337i, C0344p c0344p) {
        return (v0) AbstractC0351x.r(DEFAULT_INSTANCE, abstractC0337i, c0344p);
    }
