...
public final class C0225x extends AbstractC0351x {
    private static final C0225x DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = c0225x;
        AbstractC0351x.t(C0225x.class, c0225x);
    }

    public static C0224w A() {
        return (C0224w) DEFAULT_INSTANCE.h();
    }

    public static C0225x B(AbstractC0337i abstractC0337i, C0344p c0344p) {
        return (C0225x) AbstractC0351x.r(DEFAULT_INSTANCE, abstractC0337i, c0344p);
    }

    public static void w(C0225x c0225x) {
        c0225x.version_ = 0;
    }

    public static void x(C0225x c0225x, C0336h c0336h) {
        c0225x.getClass();
        c0225x.keyValue_ = c0336h;
    }
