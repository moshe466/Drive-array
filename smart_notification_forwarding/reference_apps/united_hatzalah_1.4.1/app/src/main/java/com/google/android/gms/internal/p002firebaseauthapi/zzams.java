...
public interface zzams {
    double zza();

    <T> void zza(T t3, zzamv<T> zzamvVar, zzakk zzakkVar);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzamv<T> zzamvVar, zzakk zzakkVar);

    <K, V> void zza(Map<K, V> map, zzalx<K, V> zzalxVar, zzakk zzakkVar);

    float zzb();

    <T> void zzb(T t3, zzamv<T> zzamvVar, zzakk zzakkVar);

    void zzb(List<zzajp> list);

    <T> void zzb(List<T> list, zzamv<T> zzamvVar, zzakk zzakkVar);
