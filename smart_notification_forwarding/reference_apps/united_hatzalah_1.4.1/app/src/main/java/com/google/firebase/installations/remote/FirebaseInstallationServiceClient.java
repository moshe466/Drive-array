...
public class FirebaseInstallationServiceClient {
    ...
    private static String availableFirebaseOptions(String str, String str2, String str3) {
        ...
        return AbstractC0008a.p("Firebase options used while communicating with Firebase server APIs: ", str2, ", ", str3, d2);
    }
    ...
    public InstallationResponse createFirebaseInstallation(String str, String str2, String str3, String str4, String str5) {
        ...
        if (this.requestLimiter.isRequestAllowed()) {
            URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(a.e("projects/", str3, "/installations"));
            for (int i = 0; i <= 1; i++) {
    ...
    public void deleteFirebaseInstallation(String str, String str2, String str3, String str4) {
        int responseCode;
        URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(a.f("projects/", str3, "/installations/", str2));
        int i = 0;
        while (i <= 1) {
    ...
    public TokenResult generateAuthToken(String str, String str2, String str3, String str4) {
        ...
        if (this.requestLimiter.isRequestAllowed()) {
            URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(AbstractC0008a.p("projects/", str3, "/installations/", str2, "/authTokens:generate"));
            for (int i = 0; i <= 1; i++) {
