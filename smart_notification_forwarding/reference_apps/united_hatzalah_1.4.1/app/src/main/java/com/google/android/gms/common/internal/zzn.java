...
public final class zzn {
    ...
    public final boolean equals(Object obj) {
        ...
        zzn zznVar = (zzn) obj;
        if (Objects.equal(this.zza, zznVar.zza) && Objects.equal(this.zzb, zznVar.zzb) && Objects.equal(this.zzc, zznVar.zzc) && this.zze == zznVar.zze && Objects.equal(this.zzf, zznVar.zzf)) {
            return true;
        }
        return false;
    }
    ...
    public zzn(String str, int i, boolean z3) {
        this(str, "com.google.android.gms", 4225, false, null);
    }

    public zzn(String str, String str2, int i, boolean z3, UserHandle userHandle) {
