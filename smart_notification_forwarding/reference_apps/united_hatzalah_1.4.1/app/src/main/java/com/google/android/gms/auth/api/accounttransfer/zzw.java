...
public final class zzw extends zzbz {
        ...
        if (safeParcelableFieldId != 1) {
            if (safeParcelableFieldId != 2) {
                if (safeParcelableFieldId != 3) {
                    ...
                    throw new IllegalStateException(a.c(field.getSafeParcelableFieldId(), "Unknown SafeParcelable id="));
                }
    ...
    public final void setDecodedBytesInternal(FastJsonResponse.Field field, String str, byte[] bArr) {
        ...
        throw new IllegalArgumentException(AbstractC0008a.j(safeParcelableFieldId, "Field with id=", " is not known to be an byte array."));
    }
    ...
    public final void setIntegerInternal(FastJsonResponse.Field field, String str, int i) {
        ...
        throw new IllegalArgumentException(AbstractC0008a.j(safeParcelableFieldId, "Field with id=", " is not known to be an int."));
    }
    ...
    public zzw(Set set, int i, String str, int i3, byte[] bArr, PendingIntent pendingIntent, DeviceMetaData deviceMetaData) {
        this.zza = set;
        this.zzb = i;
        this.zzd = str;
        this.zze = i3;
