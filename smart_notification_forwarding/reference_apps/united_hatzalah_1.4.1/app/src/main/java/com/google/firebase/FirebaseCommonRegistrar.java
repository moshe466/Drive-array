...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new C0119g(15)));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new C0119g(16)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new C0119g(17)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new C0119g(18)));
