            ...
            try {
                if (z3) {
                    if (zzd == null) {
                        ...
                        zzd = obj;
                        return doRegisterEventListener(RegistrationMethods.builder().register(zzcb.zza).unregister(zzcc.zza).withHolder(ListenerHolders.createListenerHolder(obj, Looper.getMainLooper(), "Object")).setMethodKey(2420).build());
                    }
                } else {
                    Object obj2 = zzd;
                    if (obj2 != null) {
                        zzd = null;
                        return doUnregisterEventListener(ListenerHolders.createListenerKey(obj2, "Object"), 2420).continueWith(zzcf.zza, zzbk.zza);
                    }
                }
