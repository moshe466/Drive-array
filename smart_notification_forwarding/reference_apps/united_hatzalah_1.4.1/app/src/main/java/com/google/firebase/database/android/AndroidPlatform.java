...
public class AndroidPlatform implements Platform {
    ...
    public PersistenceManager createPersistenceManager(com.google.firebase.database.core.Context context, String str) {
        ...
        String o2 = AbstractC0008a.o(str, "_", sessionPersistenceKey);
        if (!this.createdPersistenceCaches.contains(o2)) {
            this.createdPersistenceCaches.add(o2);
            return new DefaultPersistenceManager(context, new SqlPersistenceStorageEngine(this.applicationContext, context, o2), new LRUCachePolicy(context.getPersistenceCacheSizeBytes()));
        }
        throw new DatabaseException(e0.a.e("SessionPersistenceKey '", sessionPersistenceKey, "' has already been used."));
    }
    ...
    public String getUserAgent(com.google.firebase.database.core.Context context) {
        return AbstractC0008a.r(new StringBuilder(), Build.VERSION.SDK_INT, "/Android");
    }
