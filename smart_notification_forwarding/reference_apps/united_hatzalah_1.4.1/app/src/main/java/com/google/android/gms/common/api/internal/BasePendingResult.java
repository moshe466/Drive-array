...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public static class CallbackHandler<R extends Result> extends com.google.android.gms.internal.base.zar {
        ...
        public final void handleMessage(Message message) {
            ...
            if (i != 1) {
                if (i != 2) {
                    Log.wtf("BasePendingResult", AbstractC0008a.t(new StringBuilder(String.valueOf(i).length() + 34), "Don't know how to handle message: ", i), new Exception());
                    return;
                } else {
