...
public final class zzs extends zzbz {
    ...
    private static final C0689e zzb;
    final int zza;
    private List zzc;
    private List zzd;
    private List zze;
    ...
    static {
        ?? c0694j = new C0694j(0);
        zzb = c0694j;
        c0694j.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
        c0694j.put("in_progress", FastJsonResponse.Field.forStrings("in_progress", 3));
        c0694j.put("success", FastJsonResponse.Field.forStrings("success", 4));
        c0694j.put("failed", FastJsonResponse.Field.forStrings("failed", 5));
        c0694j.put("escrowed", FastJsonResponse.Field.forStrings("escrowed", 6));
    }
