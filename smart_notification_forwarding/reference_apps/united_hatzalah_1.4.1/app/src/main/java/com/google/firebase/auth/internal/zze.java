...
public final class zze implements Continuation<zzahj, Task<IntegrityTokenResponse>> {
    ...
    public final /* synthetic */ Task<IntegrityTokenResponse> then(Task<zzahj> task) {
        String str;
