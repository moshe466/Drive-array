...
public class GmsRpc {
    ...
    /* renamed from: app */
    private final FirebaseApp f4304app;
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new Object(), new l(this, 0));
    }

    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance("SHA-1").digest(this.f4304app.getName().getBytes()));
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) {
        ...
        bundle.putString(PARAM_GMP_APP_ID, this.f4304app.getOptions().getApplicationId());
    ...
    public Task<?> deleteToken() {
        ...
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f4304app), SCOPE_ALL, bundle));
    }
    ...
    public Task<String> getToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f4304app), SCOPE_ALL, new Bundle()));
    }

    public Task<Void> setRetainProxiedNotifications(boolean z3) {
        return this.rpc.setRetainProxiedNotifications(z3);
    }
