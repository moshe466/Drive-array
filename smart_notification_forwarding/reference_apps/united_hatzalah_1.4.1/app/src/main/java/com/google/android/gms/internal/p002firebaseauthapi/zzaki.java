...
final class zzaki extends zzajj<Double> implements zzalc<Double>, RandomAccess {
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < this.zzc; i3++) {
            i = (i * 31) + zzalb.zza(Double.doubleToLongBits(this.zzb[i3]));
        }
        return i;
    }
    ...
    public final /* synthetic */ zzalc<Double> zza(int i) {
        if (i >= this.zzc) {
            return new zzaki(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzaki(double[] dArr, int i, boolean z3) {
        super(z3);
        this.zzb = dArr;
        this.zzc = i;
    }
