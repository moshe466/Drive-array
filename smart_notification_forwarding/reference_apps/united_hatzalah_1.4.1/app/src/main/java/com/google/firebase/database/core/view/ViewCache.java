...
public class ViewCache {
    ...
    public ViewCache updateEventSnap(IndexedNode indexedNode, boolean z3, boolean z4) {
        return new ViewCache(new CacheNode(indexedNode, z3, z4), this.serverSnap);
    }

    public ViewCache updateServerSnap(IndexedNode indexedNode, boolean z3, boolean z4) {
        return new ViewCache(this.eventSnap, new CacheNode(indexedNode, z3, z4));
    }
}
