...
public class DatabaseReference extends Query {
    ...
    public void runTransaction(final Transaction.Handler handler, final boolean z3) {
        if (handler != null) {
            Validation.validateWritablePath(getPath());
            this.repo.scheduleNow(new Runnable() { // from class: com.google.firebase.database.DatabaseReference.4
                ...
                public void run() {
                    DatabaseReference databaseReference = DatabaseReference.this;
                    databaseReference.repo.startTransaction(databaseReference.getPath(), handler, z3);
                }
            });
            return;
        }
