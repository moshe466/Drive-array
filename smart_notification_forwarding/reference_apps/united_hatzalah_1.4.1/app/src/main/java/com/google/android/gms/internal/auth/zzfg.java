...
final class zzfg extends zzfk {
    ...
    public final void zza(Object obj, long j2) {
        ...
        List list = (List) zzhi.zzf(obj, j2);
        ...
        zzhi.zzp(obj, j2, unmodifiableList);
    }
    ...
    public final void zzb(Object obj, Object obj2, long j2) {
        zzfd zzfdVar;
        List list = (List) zzhi.zzf(obj2, j2);
        int size = list.size();
        List list2 = (List) zzhi.zzf(obj, j2);
        if (list2.isEmpty()) {
