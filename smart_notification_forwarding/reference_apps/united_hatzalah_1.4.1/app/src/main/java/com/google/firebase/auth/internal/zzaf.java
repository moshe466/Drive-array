...
public class zzaf extends FirebaseUser {
    ...
    public String getTenantId() {
        ...
        if (zzahnVar == null || zzahnVar.zzc() == null || (map = (Map) zzbi.zza(this.zza.zzc()).getClaims().get("firebase")) == null) {
            return null;
        }
    ...
    public boolean isAnonymous() {
        ...
        if (bool == null || bool.booleanValue()) {
            zzahn zzahnVar = this.zza;
            String str = "";
            if (zzahnVar != null && (zza = zzbi.zza(zzahnVar.zzc())) != null) {
    ...
    public zzaf(zzahn zzahnVar, zzab zzabVar, String str, String str2, List<zzab> list, List<String> list2, String str3, Boolean bool, zzah zzahVar, boolean z3, com.google.firebase.auth.zzc zzcVar, zzbj zzbjVar, List<com.google.firebase.auth.zzal> list3) {
        this.zza = zzahnVar;
        this.zzb = zzabVar;
        this.zzc = str;
        this.zzd = str2;
    ...
    public final void zza(zzahn zzahnVar) {
        this.zza = (zzahn) Preconditions.checkNotNull(zzahnVar);
    }
