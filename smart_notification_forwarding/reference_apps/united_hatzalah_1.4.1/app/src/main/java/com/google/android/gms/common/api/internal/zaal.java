...
final class zaal extends zaaq {
    ...
    public final void zaa() {
        ...
        if (arrayList.isEmpty()) {
            ...
            while (i < size) {
                i3 = zaqVar.zaa(zaarVar.zat(), (Api.Client) arrayList2.get(i));
                i++;
                if (i3 == 0) {
                    break;
                }
            ...
            while (i < size2) {
                i3 = zaqVar.zaa(zaarVar.zat(), (Api.Client) arrayList.get(i));
                i++;
                if (i3 != 0) {
                    break;
                }
        ...
        if (i3 != 0) {
            zaarVar.zar().zar(new zaaj(this, zaarVar, new ConnectionResult(i3, null)));
            return;
        }
