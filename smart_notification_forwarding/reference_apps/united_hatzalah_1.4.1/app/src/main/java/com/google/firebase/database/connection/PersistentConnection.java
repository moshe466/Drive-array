...
public interface PersistentConnection {
    ...
    public interface Delegate {
        ...
        void onConnectionStatus(boolean z3);

        void onDataUpdate(List<String> list, Object obj, boolean z3, Long l3);

        void onDisconnect();

        void onRangeMergeUpdate(List<String> list, List<RangeMerge> list2, Long l3);
    ...
    void listen(List<String> list, Map<String, Object> map, ListenHashProvider listenHashProvider, Long l3, RequestResultCallback requestResultCallback);
