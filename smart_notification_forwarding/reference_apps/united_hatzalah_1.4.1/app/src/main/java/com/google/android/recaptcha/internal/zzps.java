...
final class zzps {
    ...
    public static void zzD(Object obj, long j2, byte b4) {
        zzpr zzprVar = zzf;
        long j3 = (-4) & j2;
        int i = zzprVar.zza.getInt(obj, j3);
        int i3 = ((~((int) j2)) & 3) << 3;
        zzprVar.zza.putInt(obj, j3, ((255 & b4) << i3) | (i & (~(255 << i3))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void zzE(Object obj, long j2, byte b4) {
        zzpr zzprVar = zzf;
        long j3 = (-4) & j2;
        int i = (((int) j2) & 3) << 3;
        zzprVar.zza.putInt(obj, j3, ((255 & b4) << i) | (zzprVar.zza.getInt(obj, j3) & (~(255 << i))));
    }
    ...
    public static void zzm(Object obj, long j2, boolean z3) {
        zzf.zzc(obj, j2, z3);
    }

    public static void zzn(byte[] bArr, long j2, byte b4) {
        zzf.zzd(bArr, zza + j2, b4);
    }
    ...
    public static void zzp(Object obj, long j2, float f4) {
        zzf.zzf(obj, j2, f4);
    }

    public static void zzq(Object obj, long j2, int i) {
        zzf.zza.putInt(obj, j2, i);
    }
    ...
    public static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j2) {
        if (((byte) ((zzf.zza.getInt(obj, (-4) & j2) >>> ((int) (((~j2) & 3) << 3))) & 255)) != 0) {
            return true;
        }
        return false;
    }
