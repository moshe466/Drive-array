...
public class FirebaseRemoteConfigValueImpl implements FirebaseRemoteConfigValue {
    ...
    public boolean asBoolean() {
        ...
        throw new IllegalArgumentException(e0.a.e("[Value: ", asTrimmedString, "] cannot be converted to a boolean."));
    }
    ...
    public double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(e0.a.e("[Value: ", asTrimmedString, "] cannot be converted to a double."), e4);
        }
    }
    ...
    public long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(e0.a.e("[Value: ", asTrimmedString, "] cannot be converted to a long."), e4);
        }
    }
