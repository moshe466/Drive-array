...
public class Context {
    ...
    public class AnonymousClass1 implements TokenProvider.GetTokenCompletionListener {
        ...
        public void onError(String str) {
            this.val$executorService.execute(new b(1, this.val$callback, str));
        }

        @Override // com.google.firebase.database.core.TokenProvider.GetTokenCompletionListener
        public void onSuccess(String str) {
            this.val$executorService.execute(new b(0, this.val$callback, str));
        }
    }

    private String buildUserAgent(String str) {
        return "Firebase/5/" + FirebaseDatabase.getSdkVersion() + RemoteSettings.FORWARD_SLASH_STRING + str;
    }
    ...
    public static /* synthetic */ void lambda$wrapTokenProvider$0(TokenProvider tokenProvider, ScheduledExecutorService scheduledExecutorService, boolean z3, ConnectionTokenProvider.GetTokenCallback getTokenCallback) {
        tokenProvider.getToken(z3, new AnonymousClass1(scheduledExecutorService, getTokenCallback));
    }
    ...
    private static ConnectionTokenProvider wrapTokenProvider(final TokenProvider tokenProvider, final ScheduledExecutorService scheduledExecutorService) {
        return new ConnectionTokenProvider() { // from class: com.google.firebase.database.core.a
            ...
            public final void getToken(boolean z3, ConnectionTokenProvider.GetTokenCallback getTokenCallback) {
                Context.lambda$wrapTokenProvider$0(TokenProvider.this, scheduledExecutorService, z3, getTokenCallback);
            }
        };
    }
