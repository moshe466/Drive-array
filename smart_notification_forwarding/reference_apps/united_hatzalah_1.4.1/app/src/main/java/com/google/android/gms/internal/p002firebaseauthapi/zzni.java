...
public final class zzni {
    ...
    private static zznl zza(zznl zznlVar, zznl zznlVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zznlVar.zza()) {
            return zznlVar2;
        }
        if (zznlVar2.zza()) {
        ...
        BigInteger bigInteger3 = zznlVar.zzd;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zznlVar2.zzd;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = zznlVar.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zznlVar2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zznlVar.zzc.multiply(zznlVar2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zznlVar2.zzc.multiply(zznlVar.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            if (!mod5.equals(mod6)) {
                return zznl.zza;
            }
            return zza(zznlVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = zznlVar.zzd.add(zznlVar2.zzd);
        return new zznl(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

    private static zznl zza(zznl zznlVar, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zznlVar.zzc.equals(BigInteger.ZERO)) {
            return zznl.zza;
        }
        BigInteger bigInteger3 = zznlVar.zzb;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zznlVar.zzc;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = zznlVar.zzd;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = zznlVar.zzb.add(mod2);
        ...
        BigInteger add3 = zznlVar.zzc.add(zznlVar.zzd);
        return new zznl(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    private static zznl zza(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zznl.zza;
        }
        BigInteger mod = new BigInteger(1, zzqg.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zznl(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ECPoint eCPoint;
        ...
        if (bigInteger.signum() == 1) {
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                zznl zza3 = zza(ECPoint.POINT_INFINITY, zza2);
                zznl zza4 = zza(generator, zza2);
                for (int bitLength = bigInteger.bitLength(); bitLength >= 0; bitLength--) {
                    if (bigInteger.testBit(bitLength)) {
                        zza3 = zza(zza3, zza4, a2, zza2);
                        zza4 = zza(zza4, a2, zza2);
                    } else {
                        zza4 = zza(zza3, zza4, a2, zza2);
                        zza3 = zza(zza3, a2, zza2);
                    }
                }
                if (zza3.zza()) {
    ...
    public static void zza(ECPoint eCPoint, EllipticCurve ellipticCurve) {
