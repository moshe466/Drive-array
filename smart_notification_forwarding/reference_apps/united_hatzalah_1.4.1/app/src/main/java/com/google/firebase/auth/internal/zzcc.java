...
public final class zzcc implements TotpSecret {
    ...
    public zzcc(String str, String str2, int i, int i3, long j2, String str3, FirebaseAuth firebaseAuth) {
    ...
    public final String generateQrCodeUrl(String str, String str2) {
        ...
        int i = this.zzc;
        StringBuilder y = AbstractC0008a.y("otpauth://totp/", str2, TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER, str, "?secret=");
        y.append(str3);
        y.append("&issuer=");
        y.append(str2);
        y.append("&algorithm=");
