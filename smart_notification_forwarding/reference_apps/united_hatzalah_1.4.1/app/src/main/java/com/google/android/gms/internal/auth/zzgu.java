...
public class zzgu extends AbstractMap {
    ...
    public /* synthetic */ zzgu(int i, zzgt zzgtVar) {
        this.zza = i;
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i3 <= i) {
            int i4 = (i3 + i) / 2;
            int compareTo2 = comparable.compareTo(((zzgo) this.zzb.get(i4)).zza());
            if (compareTo2 < 0) {
                i = i4 - 1;
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < zzb; i3++) {
            i += ((zzgo) this.zzb.get(i3)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i3 = this.zza;
        if (size == i3) {
            zzgo zzgoVar = (zzgo) this.zzb.remove(i3 - 1);
