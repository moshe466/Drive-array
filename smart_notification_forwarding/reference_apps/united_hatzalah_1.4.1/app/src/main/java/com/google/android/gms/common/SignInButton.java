...
import com.google.android.gms.common.internal.zaae;
import com.google.android.gms.common.internal.zaaf;
...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) {
        ...
        try {
            this.zac = zaae.zaa(context, this.zaa, this.zab);
        } catch (RemoteCreator.RemoteCreatorException unused) {
            int i = this.zaa;
            int i3 = this.zab;
            zaaf zaafVar = new zaaf(context, null);
            zaafVar.zaa(context.getResources(), i, i3);
            this.zac = zaafVar;
        }
        addView(this.zac);
    ...
    @Deprecated
    public void setStyle(int i, int i3, Scope[] scopeArr) {
        setStyle(i, i3);
    }
