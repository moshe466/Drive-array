...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    public ProxyResponse(int i, int i3, PendingIntent pendingIntent, int i4, Bundle bundle, byte[] bArr) {
        this.zza = i;
    ...
    public static ProxyResponse createErrorProxyResponse(int i, PendingIntent pendingIntent, int i3, Map<String, String> map, byte[] bArr) {
        return new ProxyResponse(1, i, pendingIntent, i3, zza(map), bArr);
    }
    ...
    public ProxyResponse(int i, PendingIntent pendingIntent, int i3, Bundle bundle, byte[] bArr) {
        this(1, i, pendingIntent, i3, bundle, bArr);
    }
