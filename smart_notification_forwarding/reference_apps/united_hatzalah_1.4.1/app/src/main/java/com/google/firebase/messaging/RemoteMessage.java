...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        /* JADX WARN: Type inference failed for: r1v0, types: [t.j, java.util.Map<java.lang.String, java.lang.String>] */
        public Builder(String str) {
            Bundle bundle = new Bundle();
            this.bundle = bundle;
            this.data = new C0694j(0);
            if (!TextUtils.isEmpty(str)) {
                bundle.putString(Constants.MessagePayloadKeys.TO, str);
                return;
            }
            throw new IllegalArgumentException(e0.a.d("Invalid to: ", str));
        }
