...
public final class Component<T> {
    ...
    public static <T> Component<T> intoSet(T t3, Class<T> cls) {
        return intoSetBuilder(cls).factory(new a(t3, 2)).build();
    }
    ...
    public static <T> Component<T> of(Class<T> cls, T t3) {
        return builder(cls).factory(new a(t3, 3)).build();
    }
    ...
    private Component(String str, Set<Qualified<? super T>> set, Set<Dependency> set2, int i, int i3, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.name = str;
    ...
    public static <T> Component<T> intoSet(T t3, Qualified<T> qualified) {
        return intoSetBuilder(qualified).factory(new a(t3, 1)).build();
    }
    ...
    public static <T> Component<T> of(T t3, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new a(t3, 4)).build();
    }
    ...
    @SafeVarargs
    public static <T> Component<T> of(T t3, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
        return builder(qualified, qualifiedArr).factory(new a(t3, 0)).build();
    }
