...
public interface InAppWebViewInterface {
    ...
    boolean pageDown(boolean z3);

    boolean pageUp(boolean z3);
    ...
    void saveWebArchive(String str, boolean z3, ValueCallback<String> valueCallback);
    ...
    void setInFullscreen(boolean z3);
