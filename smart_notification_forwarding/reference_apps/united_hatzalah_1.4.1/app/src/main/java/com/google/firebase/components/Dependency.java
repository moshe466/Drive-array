...
public final class Dependency {
    ...
    private Dependency(Class<?> cls, int i, int i3) {
        this((Qualified<?>) Qualified.unqualified(cls), i, i3);
    }
    ...
    private static String describeInjection(int i) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new AssertionError(e0.a.c(i, "Unsupported injection: "));
            }
            return "provider";
        }
    ...
    public String toString() {
        ...
        sb.append(str);
        sb.append(", injection=");
        return AbstractC0008a.u(sb, describeInjection(this.injection), "}");
    }

    private Dependency(Qualified<?> qualified, int i, int i3) {
