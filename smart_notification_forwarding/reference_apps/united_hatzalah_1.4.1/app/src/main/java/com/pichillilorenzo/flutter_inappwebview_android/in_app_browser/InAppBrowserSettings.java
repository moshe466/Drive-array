...
public class InAppBrowserSettings implements ISettings<InAppBrowserActivity> {
    ...
    public Map<String, Object> getRealSettings(InAppBrowserActivity inAppBrowserActivity) {
        ...
        AbstractC0431a abstractC0431a = inAppBrowserActivity.actionBar;
        boolean z3 = true;
        map.put("hideToolbarTop", Boolean.valueOf(abstractC0431a == null || !abstractC0431a.h()));
        ...
        map.put("hideProgressBar", Boolean.valueOf(z3));
        return map;
    }
