...
public class CrashlyticsReportJsonTransform {
    ...
    private static CrashlyticsReport.ApplicationExitInfo parseAppExitInfo(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c4) {
                case 0:
                    builder.setBuildIdMappingForArch(parseArray(jsonReader, new a(1)));
                    break;
                case 1:
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c4) {
                case 0:
                    builder.setAppProcessDetails(parseArray(jsonReader, new a(3)));
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    builder.setInternalKeys(parseArray(jsonReader, new a(2)));
                    break;
                case 4:
                    builder.setCustomAttributes(parseArray(jsonReader, new a(2)));
                    break;
                case 5:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c4) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    builder.setEvents(parseArray(jsonReader, new a(4)));
                    break;
                case 6:
