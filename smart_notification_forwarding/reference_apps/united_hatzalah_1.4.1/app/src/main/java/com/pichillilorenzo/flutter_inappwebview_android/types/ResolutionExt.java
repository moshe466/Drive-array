...
public class ResolutionExt {
    ...
    public ResolutionExt(String str, String str2, int i, int i3) {
        this.id = str;
        this.label = str2;
        this.verticalDpi = i;
    ...
    public int hashCode() {
        return ((AbstractC0008a.g(this.label, this.id.hashCode() * 31, 31) + this.verticalDpi) * 31) + this.horizontalDpi;
    }
