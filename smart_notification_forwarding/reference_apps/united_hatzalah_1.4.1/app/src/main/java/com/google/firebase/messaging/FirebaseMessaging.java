...
public class FirebaseMessaging {
    ...
    static Provider<q1.g> transportFactory = new com.google.firebase.concurrent.g(5);
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi, Provider<q1.g> provider3, Subscriber subscriber) {
    ...
    public static /* synthetic */ q1.g lambda$clearTransportFactoryForTest$12() {
        return null;
    }
    ...
    public static /* synthetic */ q1.g lambda$static$0() {
        return null;
    }

    public static /* synthetic */ Task lambda$subscribeToTopic$10(String str, TopicsSubscriber topicsSubscriber) {
        return topicsSubscriber.subscribeToTopic(str);
    }

    public static /* synthetic */ Task lambda$unsubscribeFromTopic$11(String str, TopicsSubscriber topicsSubscriber) {
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z3) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z3).addOnSuccessListener((Executor) new Object(), new h(this, 2));
    }
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi, Provider<q1.g> provider3, Subscriber subscriber, Metadata metadata) {
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<q1.g> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        executor2.execute(new Runnable(this) { // from class: com.google.firebase.messaging.g
            ...
            public final /* synthetic */ FirebaseMessaging f4322b;
            ...
            public final void run() {
                switch (i) {
                    case 0:
                        this.f4322b.lambda$new$2();
                        return;
                    default:
                        this.f4322b.lambda$new$4();
                        return;
                }
            }
        });
        ...
        createInstance.addOnSuccessListener(executor2, new h(this, 0));
        final int i3 = 1;
        executor2.execute(new Runnable(this) { // from class: com.google.firebase.messaging.g
