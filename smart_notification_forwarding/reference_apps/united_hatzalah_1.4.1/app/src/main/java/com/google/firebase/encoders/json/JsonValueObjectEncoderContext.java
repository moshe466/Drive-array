...
public final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext doEncode(ObjectEncoder<Object> objectEncoder, Object obj, boolean z3) {
        if (!z3) {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, double d2) {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(d2);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, long j2) {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j2);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, long j2) {
    ...
    @Override // com.google.firebase.encoders.ValueEncoderContext
    public JsonValueObjectEncoderContext add(float f4) {
        maybeUnNest();
        this.jsonWriter.value(f4);
        return this;
    }
    ...
    public JsonValueObjectEncoderContext add(Object obj, boolean z3) {
