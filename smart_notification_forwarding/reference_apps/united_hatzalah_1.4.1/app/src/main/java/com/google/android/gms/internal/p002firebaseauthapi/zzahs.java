        ...
        if (jSONArray != null && jSONArray.length() != 0) {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (jSONObject == null) {
                    ...
                    zzahtVar = new zzaht(Strings.emptyToNull(jSONObject.optString("federatedId")), Strings.emptyToNull(jSONObject.optString("displayName")), Strings.emptyToNull(jSONObject.optString("photoUrl")), Strings.emptyToNull(jSONObject.optString("providerId")), null, Strings.emptyToNull(jSONObject.optString("phoneNumber")), Strings.emptyToNull(jSONObject.optString(Scopes.EMAIL)));
                }
