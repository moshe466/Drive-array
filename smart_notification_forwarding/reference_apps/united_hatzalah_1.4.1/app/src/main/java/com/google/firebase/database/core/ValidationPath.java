...
public class ValidationPath {
    ...
    private void checkValid() {
        ...
        throw new DatabaseException(AbstractC0008a.r(new StringBuilder("Data has a key path longer than 768 bytes ("), this.byteLength, ")."));
    }
    ...
    private String toErrorString() {
        ...
        return AbstractC0008a.u(new StringBuilder("in path '"), joinStringList(RemoteSettings.FORWARD_SLASH_STRING, this.parts), "'");
    }
