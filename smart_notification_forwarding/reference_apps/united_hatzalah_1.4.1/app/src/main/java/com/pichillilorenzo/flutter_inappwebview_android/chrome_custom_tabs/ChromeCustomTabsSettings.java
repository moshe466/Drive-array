...
public class ChromeCustomTabsSettings implements ISettings<ChromeCustomTabsActivity> {
    ...
    /* JADX WARN: Type inference failed for: r0v27, types: [s.b, java.lang.Object] */
    @Override // com.pichillilorenzo.flutter_inappwebview_android.ISettings
            ...
            if (value != null) {
                ...
                switch (key.hashCode()) {
                    ...
                    case 472764366:
                        ...
                        break;
                    case 908759025:
                        if (key.equals(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME)) {
                            c4 = 14;
                            break;
                        }
                        break;
                ...
                switch (c4) {
                    ...
                    case ConnectionResult.SERVICE_UPDATING /* 18 */:
                        ...
                        if (str == null) {
                            ...
                            this.displayMode = new C0646a(((Boolean) map4.get("isSticky")).booleanValue(), ((Integer) map4.get("displayCutoutMode")).intValue());
                            break;
                        } else if (str.equals("DEFAULT_MODE")) {
                            this.displayMode = new Object();
                            break;
                        } else {
                            break;
                        }
