...
public class Query {
    ...
    public Query(Repo repo, Path path, QueryParams queryParams, boolean z3) {
        this.repo = repo;
        this.path = path;
        this.params = queryParams;
        this.orderByCalled = z3;
    ...
    public void keepSynced(final boolean z3) {
        ...
        this.repo.scheduleNow(new Runnable() { // from class: com.google.firebase.database.Query.4
            ...
            public void run() {
                ...
                query.repo.keepSynced(query.getSpec(), z3);
            }
        });
    }
        ...
        if (str != null) {
            if (!str.equals("$key") && !str.equals(".key")) {
                if (!str.equals("$priority") && !str.equals(".priority")) {
                    ...
                    throw new IllegalArgumentException(e0.a.e("Can't use '", str, "' as path, please use orderByValue() instead!"));
                }
                throw new IllegalArgumentException(e0.a.e("Can't use '", str, "' as path, please use orderByPriority() instead!"));
            }
            throw new IllegalArgumentException(e0.a.e("Can't use '", str, "' as path, please use orderByKey() instead!"));
        }
    ...
    public Query endAt(boolean z3) {
        return endAt(z3, (String) null);
    }
    ...
    public Query startAt(boolean z3) {
        return startAt(z3, (String) null);
    }
    ...
    public Query endBefore(boolean z3) {
        return endAt(z3, ChildKey.getMinName().asString());
    }

    public Query equalTo(boolean z3) {
        validateEqualToCall();
        return startAt(z3).endAt(z3);
    }

    public Query startAfter(boolean z3) {
        return startAt(z3, ChildKey.getMaxName().asString());
    }
    ...
    public Query endAt(boolean z3, String str) {
        return endAt(new BooleanNode(Boolean.valueOf(z3), PriorityUtilities.NullPriority()), str);
    }
    ...
    public Query startAt(boolean z3, String str) {
        return startAt(new BooleanNode(Boolean.valueOf(z3), PriorityUtilities.NullPriority()), str);
    }
    ...
    public Query endBefore(boolean z3, String str) {
        return endBefore(new BooleanNode(Boolean.valueOf(z3), PriorityUtilities.NullPriority()), str);
    }

    public Query equalTo(boolean z3, String str) {
        validateEqualToCall();
        return startAt(z3, str).endAt(z3, str);
    }

    public Query startAfter(boolean z3, String str) {
        return startAfter(new BooleanNode(Boolean.valueOf(z3), PriorityUtilities.NullPriority()), str);
    }
