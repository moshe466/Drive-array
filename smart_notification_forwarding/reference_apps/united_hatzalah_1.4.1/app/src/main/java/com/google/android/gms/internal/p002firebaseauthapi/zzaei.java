...
public final class zzaei {
    ...
    static {
        ...
        sparseArray.put(FirebaseError.ERROR_INVALID_CREDENTIAL, new Pair<>("ERROR_INVALID_CREDENTIAL", "The supplied auth credential is incorrect, malformed or has expired."));
        ...
        sparseArray.put(FirebaseError.ERROR_OPERATION_NOT_ALLOWED, new Pair<>("ERROR_OPERATION_NOT_ALLOWED", "This operation is not allowed. This may be because the given sign-in provider is disabled for this Firebase project. Enable it in the Firebase console, under the sign-in method tab of the Auth section."));
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00dc A[FALL_THROUGH] */
    /*
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaei.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).getErrorCode().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    public static FirebaseException zza(Status status, AuthCredential authCredential, String str, String str2) {
        ...
        return new FirebaseAuthUserCollisionException(zza(statusCode), zza(zzb(statusCode), status)).zza(authCredential).zza(str);
    }

    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzaaj zzaajVar, FirebaseUser firebaseUser) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzaajVar);
        Pair<String, String> pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.zza(zzaajVar, firebaseAuth, firebaseUser));
    }
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.getStatusMessage()) ? str : String.format(AbstractC0008a.n(str, " [ %s ]"), status.getStatusMessage());
    }
