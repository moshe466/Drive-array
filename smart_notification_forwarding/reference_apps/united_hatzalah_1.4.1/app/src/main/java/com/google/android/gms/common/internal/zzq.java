        ...
        synchronized (hashMap) {
            try {
                ...
                if (zzoVar == null) {
                    ...
                    UserHandle zze = zznVar.zze();
                    if (zze != null && Build.VERSION.SDK_INT >= 33) {
                        connectionResult = zzoVar.zzk(str, zze);
                    } else {
                    ...
                    if (!zzoVar.zzf(serviceConnection)) {
                        ...
                        if (zze2 != 1) {
                            if (zze2 == 2) {
                                UserHandle zze3 = zznVar.zze();
                                if (zze3 != null && Build.VERSION.SDK_INT >= 33) {
                                    zzj = zzoVar.zzk(str, zze3);
                                } else {
                                    zzj = zzoVar.zzj(str, executor);
                                }
                                connectionResult = zzj;
                            }
                        } else {
