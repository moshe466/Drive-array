...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialRequestOptions build() {
            ...
            return new PublicKeyCredentialRequestOptions(bArr, d2, str, list, num, tokenBinding, zzayVar, this.zzh, null);
        }
    ...
    public PublicKeyCredentialRequestOptions(byte[] bArr, Double d2, String str, List list, Integer num, TokenBinding tokenBinding, String str2, AuthenticationExtensions authenticationExtensions, Long l3) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d2;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
