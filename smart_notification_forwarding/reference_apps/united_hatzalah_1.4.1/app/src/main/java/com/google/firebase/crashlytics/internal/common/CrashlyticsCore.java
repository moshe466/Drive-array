...
public class CrashlyticsCore {
    ...
    /* renamed from: app */
    private final FirebaseApp f4212app;
    ...
    private void finishInitSynchronously(SettingsProvider settingsProvider) {
        Future<?> submit = this.crashlyticsWorkers.common.getExecutor().submit(new d(this, settingsProvider, 1));
    ...
    public /* synthetic */ void lambda$log$3(long j2, String str) {
        this.crashlyticsWorkers.diskWrite.submit(new g(this, j2, str, 0));
    }
    ...
    public Task<Void> doBackgroundInitializationAsync(SettingsProvider settingsProvider) {
        return this.crashlyticsWorkers.common.submit(new d(this, settingsProvider, 0));
    }
    ...
    public void log(String str) {
        this.crashlyticsWorkers.common.submit(new g(this, System.currentTimeMillis() - this.startTime, str, 1));
    }

    public void logException(Throwable th, Map<String, String> map) {
        this.crashlyticsWorkers.common.submit(new K0.b(this, th, map, 4));
    }
    ...
    public void logFatalException(Throwable th) {
        ...
        this.crashlyticsWorkers.common.submit(new c(2, this, th));
    }
    ...
    public void setUserId(String str) {
        this.crashlyticsWorkers.common.submit(new c(3, this, str));
    }
}
