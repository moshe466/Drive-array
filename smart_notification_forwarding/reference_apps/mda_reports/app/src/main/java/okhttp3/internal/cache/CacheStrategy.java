...
public final class CacheStrategy {
    ...
    public static class Factory {
        ...
        private long cacheResponseAge() {
            ...
            return max + (j - this.sentRequestMillis) + (this.a - j);
        }
        ...
        private long computeFreshnessLifetime() {
            ...
            if (this.lastModified == null || this.c.request().url().query() != null) {
                return 0L;
            }
        ...
        private CacheStrategy getCandidate() {
            ...
            if ((!this.b.isHttps() || this.c.handshake() != null) && CacheStrategy.isCacheable(this.c, this.b)) {
                CacheControl cacheControl = this.b.cacheControl();
                if (cacheControl.noCache() || hasConditions(this.b)) {
                    return new CacheStrategy(this.b, null);
                }
        ...
        private boolean isFreshnessLifetimeHeuristic() {
            return this.c.cacheControl().maxAgeSeconds() == -1 && this.expires == null;
        }

        public CacheStrategy get() {
            CacheStrategy candidate = getCandidate();
            return (candidate.networkRequest == null || !this.b.cacheControl().onlyIfCached()) ? candidate : new CacheStrategy(null, null);
        }
    }
