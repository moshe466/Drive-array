...
public final class Cookie {
    ...
    Cookie(Builder builder) {
        ...
        this.name = str;
        this.value = str2;
        this.expiresAt = builder.c;
        this.domain = str3;
        this.path = builder.e;
        this.secure = builder.f;
        this.httpOnly = builder.g;
        this.persistent = builder.h;
        this.hostOnly = builder.i;
    }
    ...
    */
    static okhttp3.Cookie a(long r24, okhttp3.HttpUrl r26, java.lang.String r27) {
        /*
