...
public class FragmentTransition {
    ...
    static View a(ArrayMap<String, View> arrayMap, FragmentContainerTransition fragmentContainerTransition, Object obj, boolean z) {
        ...
        if (obj == null || arrayMap == null || (arrayList = backStackRecord.o) == null || arrayList.isEmpty()) {
            return null;
        }
        return arrayMap.get((z ? backStackRecord.o : backStackRecord.p).get(0));
    }
    ...
    static ArrayMap<String, View> a(FragmentTransitionImpl fragmentTransitionImpl, ArrayMap<String, String> arrayMap, Object obj, FragmentContainerTransition fragmentContainerTransition) {
        ...
        if (d != null) {
            d.onMapSharedElements(arrayList, arrayMap2);
    ...
    static void a(Fragment fragment, Fragment fragment2, boolean z, ArrayMap<String, View> arrayMap, boolean z2) {
        SharedElementCallback d = z ? fragment2.d() : fragment.d();
        if (d != null) {
            ...
            if (z2) {
                d.onSharedElementStart(arrayList2, arrayList, null);
            } else {
                d.onSharedElementEnd(arrayList2, arrayList, null);
            }
        }
    }
    ...
    */
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, backStackRecord.a.get(i), sparseArray, false, z);
        }
    }
    ...
    private static ArrayMap<String, String> calculateNameOverrides(int i, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i2, int i3) {
        ...
        for (int i4 = i3 - 1; i4 >= i2; i4--) {
            ...
            if (backStackRecord.b(i)) {
                ...
                ArrayList<String> arrayList5 = backStackRecord.o;
                if (arrayList5 != null) {
                    int size = arrayList5.size();
                    if (booleanValue) {
                        arrayList3 = backStackRecord.o;
                        arrayList4 = backStackRecord.p;
                    } else {
                        ArrayList<String> arrayList6 = backStackRecord.o;
                        arrayList3 = backStackRecord.p;
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.s.n.onHasView()) {
            for (int size = backStackRecord.a.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, backStackRecord.a.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    private static ArrayMap<String, View> captureOutSharedElements(FragmentTransitionImpl fragmentTransitionImpl, ArrayMap<String, String> arrayMap, Object obj, FragmentContainerTransition fragmentContainerTransition) {
        ...
        arrayMap2.retainAll(arrayList);
        if (e != null) {
            e.onMapSharedElements(arrayList, arrayMap2);
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                String str = arrayList.get(size);
    ...
    private static Object configureSharedElementsOrdered(final FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, final View view, final ArrayMap<String, String> arrayMap, final FragmentContainerTransition fragmentContainerTransition, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final Object obj, Object obj2) {
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.4
            ...
            public void run() {
                ArrayMap<String, View> a = FragmentTransition.a(FragmentTransitionImpl.this, (ArrayMap<String, String>) arrayMap, obj4, fragmentContainerTransition);
                if (a != null) {
                    arrayList2.addAll(a.values());
                    arrayList2.add(view);
                }
                FragmentTransition.a(fragment, fragment2, z, a, false);
                Object obj5 = obj4;
                if (obj5 != null) {
                    FragmentTransitionImpl.this.swapSharedElementTargets(obj5, arrayList, arrayList2);
                    View a2 = FragmentTransition.a(a, fragmentContainerTransition, obj, z);
                    if (a2 != null) {
                        FragmentTransitionImpl.this.a(a2, rect2);
                    }
                }
            }
        });
    ...
    private static Object configureSharedElementsReordered(final FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        final ArrayMap<String, View> a = a(fragmentTransitionImpl, arrayMap, sharedElementTransition, fragmentContainerTransition);
        if (arrayMap.isEmpty()) {
            ...
            addSharedElementsWithMatchingNames(arrayList2, a, arrayMap.values());
            obj3 = sharedElementTransition;
        }
        if (obj == null && obj2 == null && obj3 == null) {
            return null;
        ...
        if (obj3 != null) {
            ...
            setOutEpicenter(fragmentTransitionImpl, obj3, obj2, captureOutSharedElements, fragmentContainerTransition.firstOutIsPop, fragmentContainerTransition.firstOutTransaction);
            Rect rect2 = new Rect();
            View a2 = a(a, fragmentContainerTransition, obj, z);
            if (a2 != null) {
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.3
            @Override // java.lang.Runnable
            public void run() {
                FragmentTransition.a(Fragment.this, fragment2, z, (ArrayMap<String, View>) a, false);
                View view3 = view2;
                if (view3 != null) {
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManagerImpl, int i, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        Object obj;
        ViewGroup viewGroup = fragmentManagerImpl.n.onHasView() ? (ViewGroup) fragmentManagerImpl.n.onFindViewById(i) : null;
        ...
        ArrayList<View> a = a(chooseImpl, obj, fragment2, (ArrayList<View>) arrayList, view);
        ...
        if (mergeTransitions != null) {
            ...
            chooseImpl.scheduleRemoveTargets(mergeTransitions, enterTransition, arrayList3, obj2, a, configureSharedElementsOrdered, arrayList2);
            scheduleTargetChange(chooseImpl, viewGroup, fragment, view, arrayList2, enterTransition, arrayList3, obj2, a);
            chooseImpl.a((View) viewGroup, arrayList2, (Map<String, String>) arrayMap);
            chooseImpl.beginDelayedTransition(viewGroup, mergeTransitions);
            chooseImpl.a(viewGroup, arrayList2, (Map<String, String>) arrayMap);
        }
    }
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManagerImpl, int i, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        ArrayList<View> a = a(chooseImpl, obj, fragment2, arrayList2, view);
        ArrayList<View> a2 = a(chooseImpl, enterTransition, fragment, arrayList, view);
        a(a2, 4);
        Object mergeTransitions = mergeTransitions(chooseImpl, enterTransition, obj, configureSharedElementsReordered, fragment, z);
        if (mergeTransitions != null) {
            replaceHide(chooseImpl, obj, fragment2, a);
            ArrayList<String> a3 = chooseImpl.a(arrayList);
            chooseImpl.scheduleRemoveTargets(mergeTransitions, enterTransition, a2, obj, a, configureSharedElementsReordered, arrayList);
            chooseImpl.beginDelayedTransition(viewGroup, mergeTransitions);
            chooseImpl.a(viewGroup, arrayList2, arrayList, a3, arrayMap);
            a(a2, 0);
    ...
    private static void replaceHide(FragmentTransitionImpl fragmentTransitionImpl, Object obj, Fragment fragment, final ArrayList<View> arrayList) {
        if (fragment != null && obj != null && fragment.k && fragment.z && fragment.N) {
            fragment.c(true);
            fragmentTransitionImpl.scheduleHideFragmentView(obj, fragment.getView(), arrayList);
            OneShotPreDrawListener.add(fragment.F, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    private static void setOutEpicenter(FragmentTransitionImpl fragmentTransitionImpl, Object obj, Object obj2, ArrayMap<String, View> arrayMap, boolean z, BackStackRecord backStackRecord) {
        ArrayList<String> arrayList = backStackRecord.o;
        if (arrayList == null || arrayList.isEmpty()) {
            return;
        }
        View view = arrayMap.get((z ? backStackRecord.p : backStackRecord.o).get(0));
