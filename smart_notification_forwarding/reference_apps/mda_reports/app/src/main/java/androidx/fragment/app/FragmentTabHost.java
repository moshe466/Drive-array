    ...
    private FragmentTransaction doTabChanged(@Nullable String str, @Nullable FragmentTransaction fragmentTransaction) {
        ...
        if (this.mLastTab != tabInfoForTag) {
            ...
            if (tabInfoForTag != null) {
                ...
                if (fragment2 == null) {
                    tabInfoForTag.d = this.mFragmentManager.getFragmentFactory().instantiate(this.mContext.getClassLoader(), tabInfoForTag.b.getName());
                    tabInfoForTag.d.setArguments(tabInfoForTag.c);
                    fragmentTransaction.add(this.mContainerId, tabInfoForTag.d, tabInfoForTag.a);
                } else {
