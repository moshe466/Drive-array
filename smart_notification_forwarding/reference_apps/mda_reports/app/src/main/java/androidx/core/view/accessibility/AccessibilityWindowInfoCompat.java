...
public class AccessibilityWindowInfoCompat {
    ...
    public static AccessibilityWindowInfoCompat obtain(AccessibilityWindowInfoCompat accessibilityWindowInfoCompat) {
        ...
        return a(AccessibilityWindowInfo.obtain((AccessibilityWindowInfo) accessibilityWindowInfoCompat.mInfo));
    }
    ...
    public AccessibilityNodeInfoCompat getAnchor() {
        if (Build.VERSION.SDK_INT >= 24) {
            return AccessibilityNodeInfoCompat.a(((AccessibilityWindowInfo) this.mInfo).getAnchor());
        }
        return null;
    }
    ...
    public AccessibilityWindowInfoCompat getChild(int i) {
        if (Build.VERSION.SDK_INT >= 21) {
            return a(((AccessibilityWindowInfo) this.mInfo).getChild(i));
        }
        return null;
    }
    ...
    public AccessibilityWindowInfoCompat getParent() {
        if (Build.VERSION.SDK_INT >= 21) {
            return a(((AccessibilityWindowInfo) this.mInfo).getParent());
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat getRoot() {
        if (Build.VERSION.SDK_INT >= 21) {
            return AccessibilityNodeInfoCompat.a(((AccessibilityWindowInfo) this.mInfo).getRoot());
        }
        return null;
    }
