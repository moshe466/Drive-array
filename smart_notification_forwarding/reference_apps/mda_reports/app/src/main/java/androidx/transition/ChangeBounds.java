...
public class ChangeBounds extends Transition {
    ...
    public static class ViewBounds {
        ...
        private void setLeftTopRightBottom() {
            ViewUtils.a(this.mView, this.mLeft, this.mTop, this.mRight, this.mBottom);
    ...
    public Animator createAnimator(@NonNull final ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (this.mResizeClip) {
            ...
            ObjectAnimator a2 = (i3 == i4 && i5 == i6) ? null : ObjectAnimatorUtils.a(view, POSITION_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
            if (rect4 == null) {
                i2 = 0;
            ...
            if (i == 2) {
                if (i11 == i13 && i12 == i14) {
                    ...
                    ObjectAnimator a3 = ObjectAnimatorUtils.a(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
                    ObjectAnimator a4 = ObjectAnimatorUtils.a(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i7, i9, i8, i10));
            ...
            a = ObjectAnimatorUtils.a(view, property, path);
        }
