...
public class Toolbar extends ViewGroup {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.gravity = 8388611 | (toolbar4.c & 112);
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new ActionMenuView.OnMenuItemClickListener() { // from class: androidx.appcompat.widget.Toolbar.1
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                OnMenuItemClickListener onMenuItemClickListener = Toolbar.this.d;
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x029c A[LOOP:0: B:46:0x029a->B:47:0x029c, LOOP_END] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:60:0x02f8 A[LOOP:2: B:59:0x02f6->B:60:0x02f8, LOOP_END] */
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.a)) {
            ...
            i3 = this.a.getMeasuredWidth() + getHorizontalMargins(this.a);
