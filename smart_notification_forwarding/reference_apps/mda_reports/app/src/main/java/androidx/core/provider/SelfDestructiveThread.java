...
public class SelfDestructiveThread {
    ...
    public <T> void postAndReply(final Callable<T> callable, final ReplyCallback<T> replyCallback) {
        ...
        post(new Runnable(this) { // from class: androidx.core.provider.SelfDestructiveThread.2
    ...
    public <T> T postAndWait(final Callable<T> callable, int i) {
        ...
        post(new Runnable(this) { // from class: androidx.core.provider.SelfDestructiveThread.3
            @Override // java.lang.Runnable
            public void run() {
                try {
