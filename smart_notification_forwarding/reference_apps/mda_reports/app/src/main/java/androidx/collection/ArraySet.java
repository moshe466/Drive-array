...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    private int indexOf(Object obj, int i) {
        ...
        for (int i4 = a - 1; i4 >= 0 && this.mHashes[i4] == i; i4--) {
    ...
    private int indexOfNull() {
        ...
        for (int i3 = a - 1; i3 >= 0 && this.mHashes[i3] == 0; i3--) {
            if (this.a[i3] == null) {
                return i3;
            }
        }
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                ...
                if (i > 0) {
                    ...
                    System.arraycopy(objArr3, 0, this.a, 0, i);
                }
                int i6 = this.b;
                if (i < i6) {
                    int i7 = i + 1;
                    System.arraycopy(iArr3, i7, this.mHashes, i, i6 - i);
                    System.arraycopy(objArr3, i7, this.a, i, this.b - i);
                }
            }
        }
        return e;
