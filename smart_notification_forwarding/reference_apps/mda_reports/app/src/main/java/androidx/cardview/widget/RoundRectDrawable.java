...
class RoundRectDrawable extends Drawable {
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            this.mBoundsI.inset((int) Math.ceil(RoundRectDrawableWithShadow.a(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil(RoundRectDrawableWithShadow.b(this.mPadding, this.mRadius, this.mInsetForRadius)));
