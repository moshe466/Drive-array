...
public class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i) {
            float f = i / 2;
            this.mRadialGradient = new RadialGradient(f, f, CircleImageView.this.a, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle(width, height, r0 - CircleImageView.this.a, paint);
        }
