...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public SubMenu getSubMenu() {
        return a(this.mWrappedObject.getSubMenu());
    }
    ...
    public MenuItem setActionProvider(android.view.ActionProvider actionProvider) {
        androidx.core.view.ActionProvider actionProviderWrapperJB = Build.VERSION.SDK_INT >= 16 ? new ActionProviderWrapperJB(this, this.a, actionProvider) : new ActionProviderWrapper(this.a, actionProvider);
