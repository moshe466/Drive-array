...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        private void createAllFutures() {
            ...
            if (sparseArray != null) {
                ...
                for (int i = 0; i < size; i++) {
                    this.g[this.f.keyAt(i)] = prepareDrawable(this.f.valueAt(i).newDrawable(this.b));
                }
                this.f = null;
            }
        }
        ...
        public final Drawable getChild(int i) {
            ...
            Drawable prepareDrawable = prepareDrawable(this.f.valueAt(indexOfKey).newDrawable(this.b));
            this.g[i] = prepareDrawable;
    ...
    private void initializeDrawableForDisplay(Drawable drawable) {
        ...
        try {
            ...
            if (this.mDrawableContainerState.E) {
                drawable.setColorFilter(this.mDrawableContainerState.D);
            } else {
                if (this.mDrawableContainerState.H) {
                    DrawableCompat.setTintList(drawable, this.mDrawableContainerState.F);
                }
                if (this.mDrawableContainerState.I) {
                    DrawableCompat.setTintMode(drawable, this.mDrawableContainerState.G);
                }
            }
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                drawable.setAutoMirrored(this.mDrawableContainerState.C);
            }
    ...
    */
    ...
    public final Drawable.ConstantState getConstantState() {
        ...
        this.mDrawableContainerState.d = getChangingConfigurations();
        return this.mDrawableContainerState;
    }
    ...
    public boolean onLayoutDirectionChanged(int i) {
        return this.mDrawableContainerState.a(i, b());
    }
    ...
    public void setEnterFadeDuration(int i) {
        this.mDrawableContainerState.A = i;
    }

    public void setExitFadeDuration(int i) {
        this.mDrawableContainerState.B = i;
    }
