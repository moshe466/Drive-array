...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        View a(CoordinatorLayout coordinatorLayout, View view) {
            ...
            if (this.f == null || !verifyAnchorView(view, coordinatorLayout)) {
        ...
        boolean a(CoordinatorLayout coordinatorLayout, View view, View view2) {
            Behavior behavior;
            return view2 == this.g || shouldDodge(view2, ViewCompat.getLayoutDirection(coordinatorLayout)) || ((behavior = this.a) != null && behavior.layoutDependsOn(coordinatorLayout, view, view2));
        }
    ...
    private void layoutChildWithAnchor(View view, View view2, int i) {
        ...
        Rect acquireTempRect2 = acquireTempRect();
        try {
            a(view2, acquireTempRect);
            a(view, i, acquireTempRect, acquireTempRect2);
            view.layout(acquireTempRect2.left, acquireTempRect2.top, acquireTempRect2.right, acquireTempRect2.bottom);
        } finally {
            releaseTempRect(acquireTempRect);
            releaseTempRect(acquireTempRect2);
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if ((absoluteGravity & 48) != 48 || (i6 = (acquireTempRect.top - ((ViewGroup.MarginLayoutParams) layoutParams).topMargin) - layoutParams.e) >= (i7 = rect.top)) {
                z = false;
            } else {
                setInsetOffsetY(view, i7 - i6);
                z = true;
            }
            if ((absoluteGravity & 80) == 80 && (height = ((getHeight() - acquireTempRect.bottom) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin) + layoutParams.e) < (i5 = rect.bottom)) {
            ...
            if ((absoluteGravity & 3) != 3 || (i3 = (acquireTempRect.left - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) - layoutParams.d) >= (i4 = rect.left)) {
                z2 = false;
            } else {
                setInsetOffsetX(view, i4 - i3);
                z2 = true;
            }
            if ((absoluteGravity & 5) == 5 && (width = ((getWidth() - acquireTempRect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) + layoutParams.d) < (i2 = rect.right)) {
    ...
    private boolean performIntercept(MotionEvent motionEvent, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (!(z || z2) || actionMasked == 0) {
                ...
                boolean b2 = layoutParams.b();
                boolean b3 = layoutParams.b(this, view);
                boolean z3 = b3 && !b2;
                if (b3 && !z3) {
                    break;
                }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (i != 0 || view.getVisibility() != 8) {
                for (int i3 = 0; i3 < i2; i3++) {
                    if (layoutParams.g == this.mDependencySortedChildren.get(i3)) {
                        a(view, layoutDirection);
                    }
                }
                a(view, true, acquireTempRect2);
                ...
                if (i != 2) {
                    b(view, acquireTempRect3);
                    if (!acquireTempRect3.equals(acquireTempRect2)) {
                        c(view, acquireTempRect2);
                    }
                }
    ...
    void a(View view, int i) {
        ...
        if (layoutParams.f != null) {
            ...
            Rect acquireTempRect2 = acquireTempRect();
            Rect acquireTempRect3 = acquireTempRect();
            a(layoutParams.f, acquireTempRect);
            a(view, false, acquireTempRect2);
            int measuredWidth = view.getMeasuredWidth();
            int measuredHeight = view.getMeasuredHeight();
    ...
    void b(View view, Rect rect) {
        rect.set(((LayoutParams) view.getLayoutParams()).d());
    }
    ...
    public boolean doViewsOverlap(@NonNull View view, @NonNull View view2) {
        ...
        Rect acquireTempRect = acquireTempRect();
        a(view, view.getParent() != this, acquireTempRect);
        Rect acquireTempRect2 = acquireTempRect();
        a(view2, view2.getParent() != this, acquireTempRect2);
        try {
