...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    ArrayList<ArrayList<MoveInfo>> c = new ArrayList<>();
    ArrayList<ArrayList<ChangeInfo>> d = new ArrayList<>();
    ...
    void a(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            this.h.add(changeInfo.oldHolder);
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DefaultItemAnimator.this.h.remove(changeInfo.oldHolder);
                    DefaultItemAnimator.this.a();
                }
        ...
        if (view2 != null) {
            ...
            this.h.add(changeInfo.newHolder);
            animate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.8
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DefaultItemAnimator.this.h.remove(changeInfo.newHolder);
                    DefaultItemAnimator.this.a();
                }
    ...
    public void endAnimation(RecyclerView.ViewHolder viewHolder) {
        ...
        for (int size2 = this.d.size() - 1; size2 >= 0; size2--) {
            ArrayList<ChangeInfo> arrayList = this.d.get(size2);
        ...
        for (int size3 = this.c.size() - 1; size3 >= 0; size3--) {
            ArrayList<MoveInfo> arrayList2 = this.c.get(size3);
    ...
    public void endAnimations() {
        ...
        if (isRunning()) {
            for (int size5 = this.c.size() - 1; size5 >= 0; size5--) {
                ArrayList<MoveInfo> arrayList = this.c.get(size5);
            ...
            for (int size9 = this.d.size() - 1; size9 >= 0; size9--) {
                ArrayList<ChangeInfo> arrayList3 = this.d.get(size9);
    ...
    public boolean isRunning() {
        return (this.mPendingAdditions.isEmpty() && this.mPendingChanges.isEmpty() && this.mPendingMoves.isEmpty() && this.mPendingRemovals.isEmpty() && this.f.isEmpty() && this.g.isEmpty() && this.e.isEmpty() && this.h.isEmpty() && this.c.isEmpty() && this.b.isEmpty() && this.d.isEmpty()) ? false : true;
    }
            ...
            if (z2) {
                ...
                Runnable runnable = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.1
                    ...
                    public void run() {
                        ...
                        arrayList.clear();
                        DefaultItemAnimator.this.c.remove(arrayList);
                    }
                };
                if (z) {
            ...
            if (z3) {
                ...
                Runnable runnable2 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.2
                    ...
                    public void run() {
                        ...
                        arrayList2.clear();
                        DefaultItemAnimator.this.d.remove(arrayList2);
                    }
                };
                if (z) {
            ...
            if (z4) {
                ...
                Runnable runnable3 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.3
                    ...
                    public void run() {
                        ...
                        arrayList3.clear();
                        DefaultItemAnimator.this.b.remove(arrayList3);
                    }
                };
                if (z || z2 || z3) {
