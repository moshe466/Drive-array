...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
        ...
        this.mFlagsCol = -1;
        this.mSearchManager = (SearchManager) this.d.getSystemService(FirebaseAnalytics.Event.SEARCH);
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mUrlColor = this.d.getResources().getColorStateList(typedValue.resourceId);
        }
    ...
    private Drawable getDefaultIcon1(Cursor cursor) {
        ...
        return activityIconWithCache != null ? activityIconWithCache : this.d.getPackageManager().getDefaultActivityIcon();
    }
    ...
    public void onClick(View view) {
        ...
        if (tag instanceof CharSequence) {
            this.mSearchView.a((CharSequence) tag);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.mSearchView.getVisibility() == 0 && this.mSearchView.getWindowVisibility() == 0) {
            try {
                Cursor a = a(this.mSearchable, charSequence2, 50);
                if (a != null) {
                    a.getCount();
                    return a;
                }
