...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (hasSimpleTarget(transition) || !FragmentTransitionImpl.a(transition.getTargets())) {
            return;
        }
    ...
    public void setEpicenter(Object obj, final Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new Transition.EpicenterCallback(this) { // from class: androidx.transition.FragmentTransitionSupport.4
