...
public final class GradientColorInflaterCompat {
    ...
    public static Shader a(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        ...
        if (namedInt != 1) {
            return namedInt != 2 ? new LinearGradient(namedFloat, namedFloat2, namedFloat3, namedFloat4, checkColors.a, checkColors.b, parseTileMode(namedInt2)) : new SweepGradient(namedFloat5, namedFloat6, checkColors.a, checkColors.b);
        }
        if (namedFloat7 > 0.0f) {
            return new RadialGradient(namedFloat5, namedFloat6, namedFloat7, checkColors.a, checkColors.b, parseTileMode(namedInt2));
        }
