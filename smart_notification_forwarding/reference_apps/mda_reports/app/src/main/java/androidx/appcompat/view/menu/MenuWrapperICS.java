...
public class MenuWrapperICS extends BaseMenuWrapper implements Menu {
    ...
    public MenuItem add(int i) {
        return a(this.mWrappedObject.add(i));
    }

    @Override // android.view.Menu
    public MenuItem add(int i, int i2, int i3, int i4) {
        return a(this.mWrappedObject.add(i, i2, i3, i4));
    }

    @Override // android.view.Menu
    public MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(this.mWrappedObject.add(i, i2, i3, charSequence));
    }
    ...
    public SubMenu addSubMenu(int i) {
        return a(this.mWrappedObject.addSubMenu(i));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, int i4) {
        return a(this.mWrappedObject.addSubMenu(i, i2, i3, i4));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        return a(this.mWrappedObject.addSubMenu(i, i2, i3, charSequence));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(CharSequence charSequence) {
        return a(this.mWrappedObject.addSubMenu(charSequence));
    }
    ...
    public MenuItem findItem(int i) {
        return a(this.mWrappedObject.findItem(i));
    }

    @Override // android.view.Menu
    public MenuItem getItem(int i) {
        return a(this.mWrappedObject.getItem(i));
    }
