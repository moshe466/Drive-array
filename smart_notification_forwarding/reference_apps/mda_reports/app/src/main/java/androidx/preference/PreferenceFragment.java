...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    private final Runnable mRequestFocus = new Runnable() { // from class: androidx.preference.PreferenceFragment.2
        ...
        public void run() {
            RecyclerView recyclerView = PreferenceFragment.this.a;
    ...
    public class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        public void setDivider(Drawable drawable) {
            ...
            PreferenceFragment.this.a.invalidateItemDecorations();
        }
    ...
    private void scrollToPreferenceInternal(final Preference preference, final String str) {
        Runnable runnable = new Runnable() { // from class: androidx.preference.PreferenceFragment.3
            ...
            @Override // java.lang.Runnable
            public void run() {
                RecyclerView.Adapter adapter = PreferenceFragment.this.a.getAdapter();
                ...
                if (preferenceAdapterPosition != -1) {
                    PreferenceFragment.this.a.scrollToPosition(preferenceAdapterPosition);
                } else {
                    adapter.registerAdapterDataObserver(new ScrollToPreferenceObserver(adapter, PreferenceFragment.this.a, preference, str));
                }
            }
        };
        if (this.a == null) {
