...
public class ActivityCompat extends ContextCompat {
    ...
    private static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener(this) { // from class: androidx.core.app.ActivityCompat.SharedElementCallback21Impl.1
    ...
    public static void recreate(@NonNull Activity activity) {
        if (Build.VERSION.SDK_INT < 28 && ActivityRecreator.a(activity)) {
            return;
        }
        activity.recreate();
    }
