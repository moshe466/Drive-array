        ...
        private class GestureHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (i == 1) {
                    ...
                    gestureDetectorCompatImplBase.a.onShowPress(gestureDetectorCompatImplBase.e);
                    return;
                }
                if (i == 2) {
                ...
                GestureDetector.OnDoubleTapListener onDoubleTapListener = gestureDetectorCompatImplBase2.b;
                if (onDoubleTapListener != null) {
                    if (gestureDetectorCompatImplBase2.c) {
                        gestureDetectorCompatImplBase2.d = true;
                    } else {
                        onDoubleTapListener.onSingleTapConfirmed(gestureDetectorCompatImplBase2.e);
                    }
                }
            }
        }
