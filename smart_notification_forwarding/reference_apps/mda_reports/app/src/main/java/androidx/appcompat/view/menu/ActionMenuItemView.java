...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    private class ActionMenuItemForwardingListener extends ForwardingListener {
        ...
        public ShowableListMenu getPopup() {
            PopupCallback popupCallback = ActionMenuItemView.this.c;
        ...
        protected boolean onForwardingStarted() {
            ...
            MenuBuilder.ItemInvoker itemInvoker = actionMenuItemView.b;
            return itemInvoker != null && itemInvoker.invokeItem(actionMenuItemView.a) && (popup = getPopup()) != null && popup.isShowing();
        }
    }
    ...
    private void updateTextButtonVisibility() {
        ...
        if (this.mIcon != null && (!this.a.showsTextAsAction() || (!this.mAllowTextWithIcon && !this.mExpandedFormat))) {
            z = false;
        }
        boolean z3 = z2 & z;
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            TooltipCompat.setTooltipText(this, z3 ? null : this.a.getTitle());
        } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.a.hasSubMenu() && (forwardingListener = this.mForwardingListener) != null && forwardingListener.onTouch(this, motionEvent)) {
            return true;
        }
