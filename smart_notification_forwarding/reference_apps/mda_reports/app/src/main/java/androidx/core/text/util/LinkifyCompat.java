...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator<LinkSpec>() { // from class: androidx.core.text.util.LinkifyCompat.1
        ...
        public int compare(LinkSpec linkSpec, LinkSpec linkSpec2) {
            ...
            if (i3 <= i4 && (i = linkSpec.d) >= (i2 = linkSpec2.d)) {
                return i > i2 ? -1 : 0;
            }
            return 1;
        }
    ...
    public static boolean addLinks(@NonNull Spannable spannable, int i) {
        ...
        while (it.hasNext()) {
            ...
            if (linkSpec.a == null) {
                applyLink(linkSpec.b, linkSpec.c, linkSpec.d, spannable);
            }
        }
        return true;
    }
    ...
    private static void gatherLinks(ArrayList<LinkSpec> arrayList, Spannable spannable, Pattern pattern, String[] strArr, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        ...
        while (matcher.find()) {
            ...
            if (matchFilter == null || matchFilter.acceptMatch(spannable, start, end)) {
                ...
                linkSpec.b = makeUrl(matcher.group(0), strArr, matcher, transformFilter);
                linkSpec.c = start;
                linkSpec.d = end;
        ...
        while (true) {
            try {
                ...
                if (findAddress != null && (indexOf = obj.indexOf(findAddress)) >= 0) {
                    ...
                    try {
                        linkSpec.b = "geo:0,0?q=" + URLEncoder.encode(findAddress, HttpRequest.CHARSET_UTF8);
                        arrayList.add(linkSpec);
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        for (int i3 = 0; i3 < uRLSpanArr.length; i3++) {
            LinkSpec linkSpec = new LinkSpec();
            linkSpec.a = uRLSpanArr[i3];
            linkSpec.c = spannable.getSpanStart(uRLSpanArr[i3]);
            linkSpec.d = spannable.getSpanEnd(uRLSpanArr[i3]);
            arrayList.add(linkSpec);
        }
