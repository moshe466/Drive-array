...
public class SortedList<T> {
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        public BatchedCallback(Callback<T2> callback) {
            this.a = callback;
            this.mBatchingListUpdateCallback = new BatchingListUpdateCallback(this.a);
        }
    ...
    private void addToData(int i, T t) {
        ...
        if (i2 == tArr.length) {
            ...
            tArr2[i] = t;
            System.arraycopy(this.a, i, tArr2, i + 1, this.mSize - i);
            this.a = tArr2;
        } else {
    ...
    private void merge(T[] tArr, int i) {
        ...
        this.mOldData = this.a;
        int i2 = 0;
        this.mOldDataStart = 0;
        int i3 = this.mSize;
        this.mOldDataSize = i3;
        this.a = (T[]) ((Object[]) Array.newInstance((Class<?>) this.mTClass, i3 + i + 10));
        ...
        while (true) {
            ...
            if (i4 == i5) {
                int i6 = i - i2;
                System.arraycopy(tArr, i2, this.a, this.mNewDataStart, i6);
            ...
            if (i2 == i) {
                int i7 = i5 - i4;
                System.arraycopy(this.mOldData, i4, this.a, this.mNewDataStart, i7);
    ...
    private boolean remove(T t, boolean z) {
        int findIndexOf = findIndexOf(t, this.a, 0, this.mSize, 2);
        if (findIndexOf == -1) {
            return false;
        }
    ...
    private void replaceAllInternal(@NonNull T[] tArr) {
        ...
        this.mNewDataStart = 0;
        int sortAndDedup = sortAndDedup(tArr);
        this.a = (T[]) ((Object[]) Array.newInstance((Class<?>) this.mTClass, sortAndDedup));
        while (true) {
    ...
    public void endBatchedUpdates() {
        ...
        if (callback2 == batchedCallback) {
            this.mCallback = batchedCallback.a;
        }
    }
    ...
    public T get(int i) {
        ...
        if (i < this.mSize && i >= 0) {
            ...
            return (tArr == null || i < (i2 = this.mNewDataStart)) ? this.a[i] : tArr[(i - i2) + this.mOldDataStart];
        }
    ...
    public int indexOf(T t) {
        if (this.mOldData == null) {
            return findIndexOf(t, this.a, 0, this.mSize, 4);
        }
        int findIndexOf = findIndexOf(t, this.a, 0, this.mNewDataStart, 4);
        if (findIndexOf != -1) {
            return findIndexOf;
        }
