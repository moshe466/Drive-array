...
public abstract class Transition implements Cloneable {
    ...
    private void matchStartAndEnd(TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2) {
        ...
        while (true) {
            ...
            if (i2 == 1) {
                ...
                matchItemIds(arrayMap, arrayMap2, transitionValuesMaps.c, transitionValuesMaps2.c);
            }
            i++;
        }
    }
    ...
    public void a(ViewGroup viewGroup) {
        ...
        if (viewGroup != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                ...
                if (valueAt.a != null && d != null && d.equals(valueAt.d)) {
    ...
    public void a(ViewGroup viewGroup, boolean z) {
        ...
        a(z);
        if ((this.b.size() > 0 || this.c.size() > 0) && (((arrayList = this.mTargetNames) == null || arrayList.isEmpty()) && ((arrayList2 = this.mTargetTypes) == null || arrayList2.isEmpty()))) {
            for (int i = 0; i < this.b.size(); i++) {
    ...
    public boolean a(View view) {
        ...
        if ((this.b.size() == 0 && this.c.size() == 0 && (((arrayList = this.mTargetTypes) == null || arrayList.isEmpty()) && ((arrayList2 = this.mTargetNames) == null || arrayList2.isEmpty()))) || this.b.contains(Integer.valueOf(id)) || this.c.contains(view)) {
            return true;
        }
    ...
    public void b(ViewGroup viewGroup) {
        ...
        for (int i = size - 1; i >= 0; i--) {
            ...
            if (keyAt != null && (animationInfo = runningAnimators.get(keyAt)) != null && animationInfo.a != null && d.equals(animationInfo.d)) {
                TransitionValues transitionValues = animationInfo.c;
                View view = animationInfo.a;
                TransitionValues transitionValues2 = getTransitionValues(view, true);
                TransitionValues a = a(view, true);
                if (!(transitionValues2 == null && a == null) && animationInfo.e.isTransitionRequired(transitionValues, a)) {
    ...
    public void pause(View view) {
        ...
        for (int i = size - 1; i >= 0; i--) {
            AnimationInfo valueAt = runningAnimators.valueAt(i);
            if (valueAt.a != null && d.equals(valueAt.d)) {
                AnimatorUtils.a(runningAnimators.keyAt(i));
            }
        }
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList != null && arrayList.size() > 0) {
        ...
        if (this.mPaused) {
            if (!this.mEnded) {
                ...
                for (int i = size - 1; i >= 0; i--) {
                    AnimationInfo valueAt = runningAnimators.valueAt(i);
                    if (valueAt.a != null && d.equals(valueAt.d)) {
                        AnimatorUtils.b(runningAnimators.keyAt(i));
                    }
                }
                ArrayList<TransitionListener> arrayList = this.mListeners;
                if (arrayList != null && arrayList.size() > 0) {
