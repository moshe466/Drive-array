...
public class SupportMenuInflater extends MenuInflater {
    ...
    public class MenuState {
        ...
        private void setItem(MenuItem menuItem) {
            ...
            if (str != null) {
                menuItem.setActionView((View) newInstance(str, SupportMenuInflater.d, SupportMenuInflater.this.a));
                z = true;
            }
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.a = (ActionProvider) newInstance(this.itemActionProviderClassName, SupportMenuInflater.e, SupportMenuInflater.this.b);
            } else {
                if (z) {
    ...
    */
    ...
    Object a() {
        if (this.mRealOwner == null) {
            this.mRealOwner = findRealOwner(this.c);
        }
