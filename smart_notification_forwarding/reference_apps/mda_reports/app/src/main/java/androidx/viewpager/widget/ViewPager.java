...
public class ViewPager extends ViewGroup {
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        ...
        if (i2 <= 0 || this.mItems.isEmpty()) {
            ItemInfo a = a(this.b);
            min = (int) ((a != null ? Math.min(a.e, this.mLastOffset) : 0.0f) * ((i - getPaddingLeft()) - getPaddingRight()));
            if (min == getScrollX()) {
                return;
            } else {
    ...
    private void scrollToItem(int i, boolean z, int i2, boolean z2) {
        ItemInfo a = a(i);
        int clientWidth = a != null ? (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(a.e, this.mLastOffset))) : 0;
        if (z) {
            a(clientWidth, 0, i2);
            if (z2) {
    ...
    */
    ...
    void a(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(a / abs) * 1000.0f) * 4 : (int) (((Math.abs(i5) / ((f * this.a.getPageWidth(this.b)) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
    ...
    void a(int i, boolean z, boolean z2, int i2) {
        ...
        if (!z2 && this.b == i && this.mItems.size() != 0) {
            setScrollingCacheEnabled(false);
            return;
        }
        if (i < 0) {
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i2) {
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0 && (b = b(childAt)) != null && b.b == this.b) {
    ...
    */
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            if (childAt.getVisibility() == 0 && (b = b(childAt)) != null && b.b == this.b && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void endFakeDrag() {
        ...
        if (this.a != null) {
            ...
            int scrollX = getScrollX();
            ItemInfo infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            a(determineTargetPage(infoForCurrentScrollPosition.b, ((scrollX / clientWidth) - infoForCurrentScrollPosition.e) / infoForCurrentScrollPosition.d, xVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), true, true, xVelocity);
        }
        endDrag();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (b = b(childAt2)) != null) {
                    float f = i16;
                    int i18 = ((int) (b.e * f)) + i10;
                    if (layoutParams2.b) {
                        layoutParams2.b = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.a), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec((i6 - i9) - i7, Ints.MAX_POWER_OF_TWO));
                    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i2 != i4) {
            ...
            if (childAt.getVisibility() == 0 && (b = b(childAt)) != null && b.b == this.b && childAt.requestFocus(i, rect)) {
                return true;
            }
            i2 += i3;
        }
