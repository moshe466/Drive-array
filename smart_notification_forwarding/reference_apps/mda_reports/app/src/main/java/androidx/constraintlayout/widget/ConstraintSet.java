...
public class ConstraintSet {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                ...
                case 37:
                    ...
                    break;
                case 38:
                    constraint.b = typedArray.getResourceId(index, constraint.b);
                    break;
                case 39:
        ...
        while (it.hasNext()) {
            ...
            if (i3 != -1 && i3 == 1) {
                ...
                if (iArr2 != null) {
                    ...
                    if (str2 != null) {
                        constraint2.mReferenceIds = convertReferenceString(barrier2, str2);
            ...
            for (int eventType = xml.getEventType(); eventType != 1; eventType = xml.next()) {
                if (eventType == 0) {
                    ...
                    if (name.equalsIgnoreCase("Guideline")) {
                        fillFromAttributeList.a = true;
                    }
                    this.mConstraints.put(Integer.valueOf(fillFromAttributeList.b), fillFromAttributeList);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void removeFromHorizontalChain(int i) {
        ...
        if (this.mConstraints.containsKey(Integer.valueOf(i))) {
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
            int i13 = constraint.leftToRight;
            int i14 = constraint.rightToLeft;
            if (i13 == -1 && i14 == -1) {
                int i15 = constraint.startToEnd;
                int i16 = constraint.endToStart;
                if (i15 != -1 || i16 != -1) {
                    if (i15 != -1 && i16 != -1) {
                        i11 = 0;
                        constraintSet2 = this;
    ...
    public void removeFromVerticalChain(int i) {
        ...
        if (this.mConstraints.containsKey(Integer.valueOf(i))) {
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
            int i7 = constraint.topToBottom;
            int i8 = constraint.bottomToTop;
            if (i7 != -1 || i8 != -1) {
                if (i7 != -1 && i8 != -1) {
                    i5 = 0;
                    constraintSet = this;
