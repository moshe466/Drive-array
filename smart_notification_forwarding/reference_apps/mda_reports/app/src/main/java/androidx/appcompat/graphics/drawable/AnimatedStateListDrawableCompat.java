...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        int a(int i, int i2, @NonNull Drawable drawable, boolean z) {
            ...
            long j2 = addChild;
            this.K.append(generateTransitionKey, Long.valueOf(j2 | j));
            if (z) {
                this.K.append(generateTransitionKey(i2, i), Long.valueOf(REVERSED_BIT | j2 | j));
            }
            return addChild;
        }
        ...
        int b(int i, int i2) {
            return (int) this.K.get(generateTransitionKey(i, i2), -1L).longValue();
        }
        ...
        boolean c(int i, int i2) {
            return (this.K.get(generateTransitionKey(i, i2), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        boolean d(int i, int i2) {
            return (this.K.get(generateTransitionKey(i, i2), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    */
    private int parseItem(@androidx.annotation.NonNull android.content.Context r5, @androidx.annotation.NonNull android.content.res.Resources r6, @androidx.annotation.NonNull org.xmlpull.v1.XmlPullParser r7, @androidx.annotation.NonNull android.util.AttributeSet r8, @androidx.annotation.Nullable android.content.res.Resources.Theme r9) {
        /*
            r4 = this;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x0084, code lost:
        ...
        return r7.mState.a(r1, r3, r4, r5);
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private int parseTransition(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.NonNull android.content.res.Resources r9, @androidx.annotation.NonNull org.xmlpull.v1.XmlPullParser r10, @androidx.annotation.NonNull android.util.AttributeSet r11, @androidx.annotation.Nullable android.content.res.Resources.Theme r12) {
        /*
            r7 = this;
    ...
    private boolean selectTransition(int i) {
        ...
        int a = animatedStateListState.a(b);
        int a2 = animatedStateListState.a(i);
        if (a2 == 0 || a == 0 || (b2 = animatedStateListState.b(a, a2)) < 0) {
            return false;
        }
        boolean d = animatedStateListState.d(a, a2);
        a(b2);
        Object current = getCurrent();
        if (current instanceof AnimationDrawable) {
            animatableTransition = new AnimationDrawableTransition((AnimationDrawable) current, animatedStateListState.c(a, a2), d);
        } else {
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.setVariablePadding(typedArray.getBoolean(R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.i));
    ...
    @Override // androidx.appcompat.graphics.drawable.StateListDrawable, androidx.appcompat.graphics.drawable.DrawableContainer
    void a(@NonNull DrawableContainer.DrawableContainerState drawableContainerState) {
    ...
    protected boolean onStateChange(int[] iArr) {
        int b = this.mState.b(iArr);
        boolean z = b != b() && (selectTransition(b) || a(b));
