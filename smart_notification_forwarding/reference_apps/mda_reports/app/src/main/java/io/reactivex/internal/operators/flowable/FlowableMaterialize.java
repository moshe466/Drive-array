...
public final class FlowableMaterialize<T> extends AbstractFlowableWithUpstream<T, Notification<T>> {
    ...
    static final class MaterializeSubscriber<T> extends SinglePostCompleteSubscriber<T, Notification<T>> {
        ...
        public void onComplete() {
            a((MaterializeSubscriber<T>) Notification.createOnComplete());
        }

        @Override // org.reactivestreams.Subscriber
        public void onError(Throwable th) {
            a((MaterializeSubscriber<T>) Notification.createOnError(th));
        }
    ...
    protected void subscribeActual(Subscriber<? super Notification<T>> subscriber) {
        this.b.subscribe((FlowableSubscriber) new MaterializeSubscriber(subscriber));
    }
}
