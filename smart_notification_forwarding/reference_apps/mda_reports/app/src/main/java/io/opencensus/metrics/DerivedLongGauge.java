...
public abstract class DerivedLongGauge {
    ...
    private static final class NoopDerivedLongGauge extends DerivedLongGauge {
        ...
        static NoopDerivedLongGauge b(String str, String str2, String str3, List<LabelKey> list) {
    ...
    public static DerivedLongGauge a(String str, String str2, String str3, List<LabelKey> list) {
