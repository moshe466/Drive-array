...
public abstract class AbstractSpiCall {
    ...
    public HttpRequest a(Map<String, String> map) {
        return this.requestFactory.buildHttpRequest(this.method, b(), map).useCaches(false).connectTimeout(DEFAULT_TIMEOUT).header("User-Agent", CRASHLYTICS_USER_AGENT + this.a.getVersion()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
