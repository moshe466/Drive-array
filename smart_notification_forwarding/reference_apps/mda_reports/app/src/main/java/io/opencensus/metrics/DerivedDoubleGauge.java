...
public abstract class DerivedDoubleGauge {
    ...
    private static final class NoopDerivedDoubleGauge extends DerivedDoubleGauge {
        ...
        static NoopDerivedDoubleGauge b(String str, String str2, String str3, List<LabelKey> list) {
    ...
    public static DerivedDoubleGauge a(String str, String str2, String str3, List<LabelKey> list) {
