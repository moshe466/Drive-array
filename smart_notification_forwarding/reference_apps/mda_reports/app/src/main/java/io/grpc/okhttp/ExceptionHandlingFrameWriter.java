...
public final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    private static final Set<String> QUIET_ERRORS = Collections.unmodifiableSet(new HashSet(Arrays.asList("Socket closed")));
    ...
    public void ackSettings(Settings settings) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND);
        try {
    ...
    public void data(boolean z, int i, Buffer buffer, int i2) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, buffer.buffer(), i2, z);
        try {
    ...
    public void goAway(int i, ErrorCode errorCode, byte[] bArr) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, errorCode, ByteString.of(bArr));
        try {
    ...
    public void headers(int i, List<Header> list) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, list, false);
        try {
    ...
    public void ping(boolean z, int i, int i2) {
        ...
        if (z) {
            okHttpFrameLogger.b(direction, j);
        } else {
            okHttpFrameLogger.a(direction, j);
        }
        try {
    ...
    public void pushPromise(int i, int i2, List<Header> list) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, i2, list);
        try {
    ...
    public void rstStream(int i, ErrorCode errorCode) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, errorCode);
        try {
    ...
    public void settings(Settings settings) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, settings);
        try {
    ...
    public void windowUpdate(int i, long j) {
        this.frameLogger.a(OkHttpFrameLogger.Direction.OUTBOUND, i, j);
        try {
