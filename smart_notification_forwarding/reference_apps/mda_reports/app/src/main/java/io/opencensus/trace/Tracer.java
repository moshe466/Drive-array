...
public abstract class Tracer {
    ...
    public final Span getCurrentSpan() {
        Span a = CurrentSpanUtils.a();
        return a != null ? a : BlankSpan.INSTANCE;
    }

    public final SpanBuilder spanBuilder(String str) {
        return spanBuilderWithExplicitParent(str, CurrentSpanUtils.a());
    }
    ...
    public final Scope withSpan(Span span) {
        return CurrentSpanUtils.a((Span) Utils.checkNotNull(span, "span"), false);
    }

    public final Runnable withSpan(Span span, Runnable runnable) {
        return CurrentSpanUtils.a(span, false, runnable);
    }

    public final <C> Callable<C> withSpan(Span span, Callable<C> callable) {
        return CurrentSpanUtils.a(span, false, (Callable) callable);
    }
}
