...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new ValueLoader<String>(this) { // from class: io.fabric.sdk.android.services.common.InstallerPackageNameProvider.1
