...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> Map<K, V> mapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        return pairs.length > 0 ? toMap(pairs, new LinkedHashMap(MapsKt.mapCapacity(pairs.length))) : emptyMap();
    }
    ...
    public static final <K, V> Map<K, V> toMap(@NotNull Pair<? extends K, ? extends V>[] toMap) {
        ...
        return length != 0 ? length != 1 ? toMap(toMap, new LinkedHashMap(MapsKt.mapCapacity(toMap.length))) : MapsKt__MapsJVMKt.mapOf(toMap[0]) : emptyMap();
    }
