...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m906containsVKZWuLQ(uLong.getData());
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m906containsVKZWuLQ(long value) {
    ...
    public ULong getEndInclusive() {
        return ULong.m167boximpl(getLast());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getStart() {
        return ULong.m167boximpl(getFirst());
    }
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m173constructorimpl(getLast() ^ ULong.m173constructorimpl(getLast() >>> 32))) + (((int) ULong.m173constructorimpl(getFirst() ^ ULong.m173constructorimpl(getFirst() >>> 32))) * 31);
    }
    ...
    public String toString() {
        return ULong.m210toStringimpl(getFirst()) + ".." + ULong.m210toStringimpl(getLast());
    }
}
