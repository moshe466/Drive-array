...
final class AdjustedClockMark extends ClockMark {
    ...
    public double elapsedNow() {
        return Duration.m972minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }
    ...
    public ClockMark mo945plusLRDsOJo(double duration) {
        return new AdjustedClockMark(this.mark, Duration.m973plusLRDsOJo(this.adjustment, duration), null);
    }
}
