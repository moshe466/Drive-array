...
public abstract class CoroutineImpl extends Lambda<Object> implements Continuation<Object> {
    ...
    @JvmField
    @Nullable
    protected Continuation<Object> a;

    public CoroutineImpl(int i, @Nullable Continuation<Object> continuation) {
        super(i);
        this.a = continuation;
        Continuation<Object> continuation2 = this.a;
        Continuation<Object> continuation3 = this.a;
        this._context = continuation3 != null ? continuation3.getContext() : null;
    }
