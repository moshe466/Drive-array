...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m997copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m998copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m998copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m987toStringimpl(this.duration) + ")";
    }
}
