...
class UCollectionsKt___UCollectionsKt {
    ...
    public static final int sumOfUByte(@NotNull Iterable<UByte> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m104constructorimpl(i + UInt.m104constructorimpl(it.next().getData() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUInt(@NotNull Iterable<UInt> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m104constructorimpl(i + it.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(@NotNull Iterable<ULong> sum) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.m173constructorimpl(j + it.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUShort(@NotNull Iterable<UShort> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m104constructorimpl(i + UInt.m104constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final byte[] toUByteArray(@NotNull Collection<UByte> toUByteArray) {
        ...
        byte[] m80constructorimpl = UByteArray.m80constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m91setVurrAj0(m80constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final int[] toUIntArray(@NotNull Collection<UInt> toUIntArray) {
        ...
        int[] m149constructorimpl = UIntArray.m149constructorimpl(toUIntArray.size());
        Iterator<UInt> it = toUIntArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m160setVXSXFK8(m149constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final long[] toULongArray(@NotNull Collection<ULong> toULongArray) {
        ...
        long[] m218constructorimpl = ULongArray.m218constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m229setk8EXiF4(m218constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final short[] toUShortArray(@NotNull Collection<UShort> toUShortArray) {
        ...
        short[] m313constructorimpl = UShortArray.m313constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m324set01HTLdE(m313constructorimpl, i, it.next().getData());
            i++;
        }
