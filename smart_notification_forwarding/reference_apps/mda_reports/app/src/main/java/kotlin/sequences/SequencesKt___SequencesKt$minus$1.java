...
public final class SequencesKt___SequencesKt$minus$1<T> implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        return SequencesKt___SequencesKt.filter(this.a, new Function1<T, Boolean>() { // from class: kotlin.sequences.SequencesKt___SequencesKt$minus$1$iterator$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final boolean invoke2(T t) {
                if (booleanRef.element || !Intrinsics.areEqual(t, SequencesKt___SequencesKt$minus$1.this.b)) {
                    return true;
                }
