...
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public ContinuationImpl(@Nullable Continuation<Object> continuation) {
        this(continuation, continuation != null ? continuation.getA() : null);
    }
    ...
    protected void a() {
        ...
        if (continuation != null && continuation != this) {
            CoroutineContext.Element element = getA().get(ContinuationInterceptor.INSTANCE);
            if (element == null) {
                Intrinsics.throwNpe();
            }
    ...
    public final Continuation<Object> intercepted() {
        ...
        if (continuation == null) {
            ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) getA().get(ContinuationInterceptor.INSTANCE);
