...
public final class DurationKt {
    ...
    private static final double m993timeskIfJnKk(double d, double d2) {
        return Duration.m975timesimpl(d2, d);
    }
    ...
    private static final double m994timesmvk6XK0(int i, double d) {
        return Duration.m976timesimpl(d, i);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit unit) {
        ...
        return Duration.m949constructorimpl(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
