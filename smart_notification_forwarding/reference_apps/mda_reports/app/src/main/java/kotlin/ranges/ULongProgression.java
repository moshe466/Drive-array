...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m905fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m888getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m173constructorimpl = ((int) ULong.m173constructorimpl(j ^ ULong.m173constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m173constructorimpl2 = (m173constructorimpl + ((int) ULong.m173constructorimpl(j2 ^ ULong.m173constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m173constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m210toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m210toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
