...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static <T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function1<? super Continuation<? super T>, ? extends Object> createCoroutineUnintercepted, @NotNull Continuation<? super T> completion) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            ...
            continuation = new RestrictedContinuationImpl(probeCoroutineCreated, probeCoroutineCreated, createCoroutineUnintercepted) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$1
            ...
            continuation = new ContinuationImpl(probeCoroutineCreated, context, probeCoroutineCreated, context, createCoroutineUnintercepted) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$2
                final /* synthetic */ Function1 a;
                private int label;
    ...
    public static <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function2<? super R, ? super Continuation<? super T>, ? extends Object> createCoroutineUnintercepted, final R r, @NotNull Continuation<? super T> completion) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            ...
            continuation = new RestrictedContinuationImpl(probeCoroutineCreated, probeCoroutineCreated, createCoroutineUnintercepted, r) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3
                ...
                protected Object invokeSuspend(@NotNull Object result) {
                    ...
                    if (function2 != null) {
                        return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(this.b, this);
                    }
            ...
            continuation = new ContinuationImpl(probeCoroutineCreated, context, probeCoroutineCreated, context, createCoroutineUnintercepted, r) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$4
                final /* synthetic */ Function2 a;
                final /* synthetic */ Object b;
                private int label;
