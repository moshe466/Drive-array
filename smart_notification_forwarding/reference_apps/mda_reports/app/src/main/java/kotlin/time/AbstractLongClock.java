...
public abstract class AbstractLongClock implements Clock {
    ...
    private static final class LongClockMark extends ClockMark {
        ...
        public ClockMark mo945plusLRDsOJo(double duration) {
            return new LongClockMark(this.startedAt, this.clock, Duration.m973plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ClockMark markNow() {
        return new LongClockMark(b(), this, Duration.INSTANCE.getZERO(), null);
    }
}
