...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private void calculateTextBounds(Rect rect, RectF rectF) {
        ...
        if (this.unicodeWrappedText != null) {
            float a = this.chipStartPadding + a() + this.textStartPadding;
    ...
    private void drawText(@NonNull Canvas canvas, Rect rect) {
        if (this.unicodeWrappedText != null) {
            Paint.Align a = a(rect, this.pointF);
    ...
    */
    ...
    public int getIntrinsicWidth() {
        return Math.min(Math.round(this.chipStartPadding + a() + this.textStartPadding + getTextWidth() + this.textEndPadding + calculateCloseIconWidth() + this.chipEndPadding), this.maxWidth);
    }
