...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private final SmallSortedMap<FieldDescriptorType, Object> fields = SmallSortedMap.a(16);
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z) {
        return WireFormat.a(codedInputStream, fieldType, z ? WireFormat.Utf8Validation.STRICT : WireFormat.Utf8Validation.LOOSE);
    }
    ...
    */
    private static void verifyType(com.google.protobuf.WireFormat.FieldType r2, java.lang.Object r3) {
        /*
            if (r3 == 0) goto L4c
            int[] r0 = com.google.protobuf.FieldSet.AnonymousClass1.a
    ...
    public FieldSet<FieldDescriptorType> m14clone() {
    ...
    public Map<FieldDescriptorType, Object> getAllFields() {
        ...
        SmallSortedMap a = SmallSortedMap.a(16);
        for (int i = 0; i < this.fields.getNumArrayEntries(); i++) {
            cloneFieldEntry(a, this.fields.getArrayEntryAt(i));
        }
        Iterator<Map.Entry<FieldDescriptorType, Object>> it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(a, it.next());
        }
