...
public final class FirebaseAnalytics {
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    zza = zzx.zzb(context) ? new FirebaseAnalytics(zzx.zza(context)) : new FirebaseAnalytics(zzga.zza(context, null));
                }
            }
        }
        return zza;
    ...
    public final void zza(String str) {
        synchronized (this.zzg) {
            this.zze = str;
            this.zzf = this.zzd ? DefaultClock.getInstance().elapsedRealtime() : this.zzb.zzm().elapsedRealtime();
        }
    }
    ...
    public final String zzb() {
        synchronized (this.zzg) {
            if (Math.abs((this.zzd ? DefaultClock.getInstance() : this.zzb.zzm()).elapsedRealtime() - this.zzf) < 1000) {
                return this.zze;
            }
            return null;
        }
