...
public final class zzq {
    ...
    private final zzs zza(Context context, String str, zzs zzsVar, boolean z) {
        ...
        properties.setProperty("id", zzsVar.a());
        j = zzsVar.zzb;
    ...
    private static zzs zza(SharedPreferences sharedPreferences, String str) {
        ...
        String string = sharedPreferences.getString(zzat.a(str, "id"), null);
        if (string == null) {
            String string2 = sharedPreferences.getString(zzat.a(str, "|P|"), null);
            if (string2 == null) {
                return null;
            }
    ...
    private final void zza(Context context, String str, zzs zzsVar) {
        ...
        edit.putString(zzat.a(str, "id"), zzsVar.a());
        String a = zzat.a(str, "cre");
        j = zzsVar.zzb;
    ...
    private static long zzb(SharedPreferences sharedPreferences, String str) {
        String string = sharedPreferences.getString(zzat.a(str, "cre"), null);
        if (string == null) {
            return 0L;
        }
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @WorkerThread
    public final zzs a(Context context, String str) {
        zzs zzc = zzc(context, str);
        return zzc != null ? zzc : b(context, str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @WorkerThread
    public final zzs b(Context context, String str) {
