...
public final class UnsignedBytes {
    ...
    static class LexicographicalComparatorHolder {
        ...
        enum UnsafeComparator implements Comparator<byte[]> {
            ...
            static final boolean a = ByteOrder.nativeOrder().equals(ByteOrder.BIG_ENDIAN);
            static final Unsafe b = getUnsafe();
            static final int c = b.arrayBaseOffset(byte[].class);

            static {
                if (!"64".equals(System.getProperty("sun.arch.data.model")) || c % 8 != 0 || b.arrayIndexScale(byte[].class) != 1) {
                    throw new Error();
                }
            }
            ...
            public int compare(byte[] bArr, byte[] bArr2) {
                ...
                while (i2 < i) {
                    long j = i2;
                    long j2 = b.getLong(bArr, c + j);
                    long j3 = b.getLong(bArr2, c + j);
                    if (j2 != j3) {
                        if (a) {
