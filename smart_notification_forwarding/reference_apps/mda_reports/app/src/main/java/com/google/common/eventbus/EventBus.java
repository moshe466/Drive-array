...
public class EventBus {
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this("default", MoreExecutors.directExecutor(), Dispatcher.b(), subscriberExceptionHandler);
    }

    public EventBus(String str) {
        this(str, MoreExecutors.directExecutor(), Dispatcher.b(), LoggingHandler.a);
    }
    ...
    public void post(Object obj) {
        Iterator<Subscriber> a = this.subscribers.a(obj);
        if (a.hasNext()) {
            this.dispatcher.a(obj, a);
        } else {
