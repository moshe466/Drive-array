...
public final class zzdtf {
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String a(zzdte zzdteVar, String str) {
    ...
    public static final void a(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(zzduo.a(zzdqk.zzhf((String) obj)));
            sb.append(Typography.quote);
            return;
        }
        if (obj instanceof zzdqk) {
            sb.append(": \"");
            sb.append(zzduo.a((zzdqk) obj));
            sb.append(Typography.quote);
            return;
        }
        if (obj instanceof zzdrt) {
            sb.append(" {");
            zza((zzdrt) obj, sb, i + 2);
            sb.append("\n");
            while (i2 < i) {
                sb.append(' ');
                i2++;
    ...
    */
    private static void zza(com.google.android.gms.internal.ads.zzdte r18, java.lang.StringBuilder r19, int r20) {
        /*
            Method dump skipped, instructions count: 674
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdtf.zza(com.google.android.gms.internal.ads.zzdte, java.lang.StringBuilder, int):void");
    }

    private static final String zzhj(String str) {
        StringBuilder sb = new StringBuilder();
