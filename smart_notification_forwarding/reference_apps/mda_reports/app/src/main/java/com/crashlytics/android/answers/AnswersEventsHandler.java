...
public class AnswersEventsHandler implements EventsStorageListener {
    ...
    void a(final SessionEvent.Builder builder, boolean z, final boolean z2) {
        Runnable runnable = new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.6
            ...
            public void run() {
                try {
                    AnswersEventsHandler.this.b.processEvent(builder);
                    if (z2) {
        ...
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.4
            ...
            public void run() {
                try {
                    ...
                    AnswersEventsHandler.this.b = new EnabledSessionAnalyticsManagerStrategy(AnswersEventsHandler.this.kit, AnswersEventsHandler.this.context, AnswersEventsHandler.this.a, analyticsFilesManager, AnswersEventsHandler.this.requestFactory, metadata, AnswersEventsHandler.this.firebaseAnalyticsApiAdapter);
                } catch (Exception e) {
    ...
    public void onRollOver(String str) {
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.3
            ...
            public void run() {
                try {
                    AnswersEventsHandler.this.b.sendEvents();
                } catch (Exception e) {
    ...
    public void setAnalyticsSettingsData(final AnalyticsSettingsData analyticsSettingsData, final String str) {
        executeAsync(new Runnable() { // from class: com.crashlytics.android.answers.AnswersEventsHandler.1
            ...
            public void run() {
                try {
                    AnswersEventsHandler.this.b.setAnalyticsSettingsData(analyticsSettingsData, str);
                } catch (Exception e) {
