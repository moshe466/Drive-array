...
public final class Http2xStream implements HttpStream {
    ...
    public void writeRequestHeaders(Request request) {
        ...
        this.stream = this.framedConnection.newStream(this.framedConnection.getProtocol() == Protocol.HTTP_2 ? http2HeadersList(request) : spdy3HeadersList(request), this.httpEngine.a(request), true);
        this.stream.readTimeout().timeout(this.httpEngine.a.getReadTimeout(), TimeUnit.MILLISECONDS);
        this.stream.writeTimeout().timeout(this.httpEngine.a.getWriteTimeout(), TimeUnit.MILLISECONDS);
    }
}
