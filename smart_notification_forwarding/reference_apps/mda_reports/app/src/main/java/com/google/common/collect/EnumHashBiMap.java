...
public final class EnumHashBiMap<K extends Enum<K>, V> extends AbstractBiMap<K, V> {
    ...
    private EnumHashBiMap(Class<K> cls) {
        super(WellBehavedMap.a(new EnumMap(cls)), Maps.newHashMapWithExpectedSize(cls.getEnumConstants().length));
        this.keyType = cls;
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        a(WellBehavedMap.a(new EnumMap(this.keyType)), new HashMap((this.keyType.getEnumConstants().length * 3) / 2));
