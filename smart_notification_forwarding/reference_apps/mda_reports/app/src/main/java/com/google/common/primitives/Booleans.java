...
public final class Booleans {
    ...
    private static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
        ...
        public int indexOf(Object obj) {
            int indexOf;
            if (!(obj instanceof Boolean) || (indexOf = Booleans.indexOf(this.a, ((Boolean) obj).booleanValue(), this.b, this.c)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(Object obj) {
            int lastIndexOf;
            if (!(obj instanceof Boolean) || (lastIndexOf = Booleans.lastIndexOf(this.a, ((Boolean) obj).booleanValue(), this.b, this.c)) < 0) {
                return -1;
            }
