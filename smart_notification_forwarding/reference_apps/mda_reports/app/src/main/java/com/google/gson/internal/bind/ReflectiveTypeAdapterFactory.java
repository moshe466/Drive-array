...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        TypeAdapter<?> a = jsonAdapter != null ? this.jsonAdapterFactory.a(this.constructorConstructor, gson, typeToken, jsonAdapter) : null;
        final boolean z3 = a != null;
        if (a == null) {
            a = gson.getAdapter(typeToken);
        }
        final TypeAdapter<?> typeAdapter = a;
        ...
        while (cls2 != Object.class) {
            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    if (boundField3 != null) {
                        throw new IllegalArgumentException(type + " declares multiple JSON fields named " + boundField3.a);
                    }
                }
                i++;
                z = false;
