...
public final class C$Gson$Types {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                C$Gson$Types.a(this.typeArguments[i]);
    ...
    static Type a(Type type, Class<?> cls, TypeVariable<?> typeVariable) {
        ...
        Type a2 = a(type, cls, declaringClassOf);
        if (!(a2 instanceof ParameterizedType)) {
            return typeVariable;
        }
        return ((ParameterizedType) a2).getActualTypeArguments()[indexOf(declaringClassOf.getTypeParameters(), typeVariable)];
    }
