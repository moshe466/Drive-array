...
public class AppBarLayout extends LinearLayout {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
            ...
            if (valueAnimator2 == null) {
                ...
                this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        BaseBehavior.this.b(coordinatorLayout, t, ((Integer) valueAnimator3.getAnimatedValue()).intValue());
                    }
                });
            } else {
            ...
            this.offsetAnimator.setIntValues(a, i);
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            int a = a();
            int childIndexOnOffset = getChildIndexOnOffset(t, a);
        ...
        */
        ...
        public int b(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 == 0 || a < i2 || a > i3) {
                ...
                if (a != clamp) {
                    int interpolateOffset = t.a() ? interpolateOffset(t, clamp) : clamp;
                    ...
                    updateAppBarLayoutDrawableState(coordinatorLayout, t, clamp, clamp < a ? -1 : 1, false);
                }
            }
            return i4;
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                View childAt = t.getChildAt(i2);
                b(coordinatorLayout, t, (-childAt.getBottom()) + (this.offsetToChildIndexOnLayoutIsMinHeight ? ViewCompat.getMinimumHeight(childAt) + t.getTopInset() : Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc)));
        ...
        public void onRestoreInstanceState(CoordinatorLayout coordinatorLayout, T t, Parcelable parcelable) {
            ...
            this.offsetToChildIndexOnLayoutIsMinHeight = savedState.c;
        }
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.a = i;
                    savedState.c = bottom == ViewCompat.getMinimumHeight(childAt) + t.getTopInset();
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(View view, View view2) {
            ...
            if (behavior instanceof BaseBehavior) {
                ViewCompat.offsetTopAndBottom(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) behavior).offsetDelta) + a()) - a(view2));
            }
        }
