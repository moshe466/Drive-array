...
public abstract class ExpandableBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    @Nullable
    protected ExpandableWidget a(CoordinatorLayout coordinatorLayout, View view) {
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, final View view, int i) {
        final ExpandableWidget a;
        if (ViewCompat.isLaidOut(view) || (a = a(coordinatorLayout, view)) == null || !didStateChange(a.isExpanded())) {
            return false;
        }
        this.currentState = a.isExpanded() ? 1 : 2;
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.google.android.material.transformation.ExpandableBehavior.1
            ...
            public boolean onPreDraw() {
                ...
                if (ExpandableBehavior.this.currentState == i2) {
                    ...
                    ExpandableWidget expandableWidget = a;
