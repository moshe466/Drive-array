...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        getImpl().a(this.maxImageSize);
        getImpl().b(createFromAttribute);
        getImpl().a(createFromAttribute2);
    ...
    void a(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z) {
        getImpl().a(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z);
    }
    ...
    void b(OnVisibilityChangedListener onVisibilityChangedListener, boolean z) {
        getImpl().b(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z);
    }
