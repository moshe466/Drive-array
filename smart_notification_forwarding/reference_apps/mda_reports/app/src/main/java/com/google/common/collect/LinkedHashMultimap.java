...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public boolean add(@NullableDecl V v) {
            ...
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v, a, valueEntry);
        ...
        public boolean contains(@NullableDecl Object obj) {
            int a = Hashing.a(obj);
            for (ValueEntry<K, V> valueEntry = this.a[mask() & a]; valueEntry != null; valueEntry = valueEntry.d) {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        for (int i = 0; i < readInt; i++) {
            ...
            c.put(readObject, a((LinkedHashMultimap<K, V>) readObject));
        }
