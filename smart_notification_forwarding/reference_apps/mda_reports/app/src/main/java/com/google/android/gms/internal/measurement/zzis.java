...
interface zzis {
    ...
    void zza(int i, zzdu zzduVar);

    <K, V> void zza(int i, zzgf<K, V> zzgfVar, Map<K, V> map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzhd zzhdVar);

    void zza(int i, String str);

    void zza(int i, List<String> list);

    void zza(int i, List<?> list, zzhd zzhdVar);
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhd zzhdVar);

    void zzb(int i, List<zzdu> list);

    @Deprecated
    void zzb(int i, List<?> list, zzhd zzhdVar);
