...
public class DefaultAppMeasurementEventListenerRegistrar implements AppMeasurementEventListenerRegistrar {
        ...
        if (this.eventListenerProxy == null) {
            this.eventListenerProxy = Proxy.newProxyInstance(this.crashlyticsCore.getContext().getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.crashlytics.android.core.DefaultAppMeasurementEventListenerRegistrar.1
                ...
                public Object invoke(Object obj, Method method, Object[] objArr) {
                    ...
                    if (objArr.length == 4 && name.equals(DefaultAppMeasurementEventListenerRegistrar.METHOD_ONEVENT) && DefaultAppMeasurementEventListenerRegistrar.a(objArr)) {
    ...
    public boolean register() {
        ...
        try {
            cls.getDeclaredMethod(REGISTER_METHOD, cls2).invoke(defaultAppMeasurementEventListenerRegistrar, a(cls2));
            ...
            Fabric.getLogger().w(CrashlyticsCore.TAG, ERROR_PREFIX + e2.getMessage(), e2);
        }
        return true;
    }
}
