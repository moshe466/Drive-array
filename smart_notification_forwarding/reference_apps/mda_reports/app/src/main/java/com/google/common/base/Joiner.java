...
public class Joiner {
        ...
        public <A extends Appendable> A appendTo(A a, Iterator<? extends Map.Entry<?, ?>> it) {
            ...
            if (it.hasNext()) {
                while (true) {
                    ...
                    a.append(this.joiner.a(next.getKey()));
                    a.append(this.keyValueSeparator);
                    a.append(this.joiner.a(next.getValue()));
                    if (!it.hasNext()) {
                        break;
                    }
    ...
    @CanIgnoreReturnValue
    public final <A extends Appendable> A appendTo(A a, @NullableDecl Object obj, @NullableDecl Object obj2, Object... objArr) {
