...
public final class zzag {
    ...
    public static void a(zzew zzewVar, SQLiteDatabase sQLiteDatabase) {
        if (zzewVar == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @WorkerThread
    public static void a(zzew zzewVar, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) {
        if (zzewVar == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
