...
public final class RopeByteString extends ByteString {
    ...
    public static ByteString a(ByteString byteString, ByteString byteString2) {
        ...
        return size >= minLengthByDepth[Math.max(byteString.a(), byteString2.a()) + 1] ? new RopeByteString(byteString, byteString2) : new Balancer().balance(byteString, byteString2);
    }
    ...
    public byte byteAt(int i) {
        ByteString.a(i, this.totalLength);
    ...
    public ByteString substring(int i, int i2) {
        int c = ByteString.c(i, i2, this.totalLength);
        if (c == 0) {
