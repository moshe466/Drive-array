...
public class AnalyticsEventsManager {
    ...
    public void updateContextualTriggers(FetchEligibleCampaignsResponse fetchEligibleCampaignsResponse) {
        Set<String> a = a(fetchEligibleCampaignsResponse);
        Logging.logd("Updating contextual triggers for the following analytics events: " + a);
        this.handle.registerEventNames(a);
    }
}
