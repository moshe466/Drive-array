...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
    ...
    public int add(E e, int i) {
        ...
        do {
            atomicInteger = (AtomicInteger) Maps.c(this.countMap, e);
    ...
    public int count(@NullableDecl Object obj) {
        AtomicInteger atomicInteger = (AtomicInteger) Maps.c(this.countMap, obj);
    ...
    public Iterator<Multiset.Entry<E>> d() {
        ...
        return new ForwardingIterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.ConcurrentHashMultiset.3
            ...
            @Override // com.google.common.collect.ForwardingIterator, java.util.Iterator
            public void remove() {
                CollectPreconditions.a(this.last != null);
    ...
    public boolean setCount(E e, int i, int i2) {
        ...
        AtomicInteger atomicInteger = (AtomicInteger) Maps.c(this.countMap, e);
        if (atomicInteger == null) {
            if (i != 0) {
                return false;
            }
