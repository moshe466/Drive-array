...
public final class IndicatorViewController {
    ...
    private void updateCaptionViewsVisibility(final int i, final int i2, boolean z) {
        ...
        this.textInputView.b();
        this.textInputView.a(z);
    ...
    public void b(@StyleRes int i) {
        ...
        TextView textView = this.errorView;
        if (textView != null) {
            this.textInputView.a(textView, i);
        }
    }
    ...
    public void b(TextView textView, int i) {
        ...
        if (!a(i) || (frameLayout = this.captionArea) == null) {
    ...
    public void b(boolean z) {
        ...
        if (z) {
            ...
            c(this.helperTextTextAppearance);
            a(this.helperTextView, 1);
        } else {
            j();
