...
public class InflaterConfigModule {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                a[MessageType.BANNER.ordinal()] = 4;
    ...
    public static String configFor(MessageType messageType, int i) {
        ...
        int i3 = AnonymousClass1.a[messageType.ordinal()];
        if (i3 == 1) {
    ...
    public InAppMessageLayoutConfig providesBannerLandscapeLayoutConfig(DisplayMetrics displayMetrics) {
        ...
        return builder.setMaxImageHeightWeight(valueOf).setMaxImageWidthWeight(valueOf).setMaxDialogHeightPx(Integer.valueOf((int) (displayMetrics.heightPixels * 0.5f))).setMaxDialogWidthPx(Integer.valueOf((int) (displayMetrics.widthPixels * 0.9f))).setViewWindowGravity(48).setWindowFlag(Integer.valueOf(this.ENABLED_BG_FLAG)).setWindowWidth(-1).setWindowHeight(-2).setBackgroundEnabled(true).setAnimate(true).setAutoDismiss(true).build();
    }
    ...
    public InAppMessageLayoutConfig providesModalLandscapeConfig(DisplayMetrics displayMetrics) {
        ...
        double d = displayMetrics.heightPixels;
        Double.isNaN(d);
        InAppMessageLayoutConfig.Builder maxImageHeightWeight = builder.setMaxDialogHeightPx(Integer.valueOf((int) (d * 0.8d))).setMaxDialogWidthPx(Integer.valueOf(displayMetrics.widthPixels)).setMaxImageHeightWeight(Float.valueOf(1.0f));
    ...
    public InAppMessageLayoutConfig providesModalPortraitConfig(DisplayMetrics displayMetrics) {
        ...
        double d = displayMetrics.heightPixels;
        Double.isNaN(d);
        InAppMessageLayoutConfig.Builder maxBodyHeightWeight = builder.setMaxDialogHeightPx(Integer.valueOf((int) (d * 0.8d))).setMaxDialogWidthPx(Integer.valueOf((int) (displayMetrics.widthPixels * 0.7f))).setMaxImageHeightWeight(Float.valueOf(0.6f)).setMaxBodyHeightWeight(Float.valueOf(0.1f));
