        ...
        if (i != 1) {
            ...
            if (i == 2) {
                ...
                if (readStrongBinder2 != null) {
                    ...
                    zzaqeVar4 = queryLocalInterface2 instanceof zzaqe ? (zzaqe) queryLocalInterface2 : new zzaqg(readStrongBinder2);
                }
                zza(zzaqkVar, zzaqeVar4);
            } else if (i == 5) {
                zzaqk zzaqkVar2 = (zzaqk) zzge.zza(parcel, zzaqk.CREATOR);
                IBinder readStrongBinder3 = parcel.readStrongBinder();
                if (readStrongBinder3 != null) {
                    IInterface queryLocalInterface3 = readStrongBinder3.queryLocalInterface("com.google.android.gms.ads.internal.request.INonagonStreamingResponseListener");
                    zzaqeVar3 = queryLocalInterface3 instanceof zzaqe ? (zzaqe) queryLocalInterface3 : new zzaqg(readStrongBinder3);
                }
                zzb(zzaqkVar2, zzaqeVar3);
            } else if (i == 6) {
                zzaqk zzaqkVar3 = (zzaqk) zzge.zza(parcel, zzaqk.CREATOR);
                IBinder readStrongBinder4 = parcel.readStrongBinder();
                if (readStrongBinder4 != null) {
                    IInterface queryLocalInterface4 = readStrongBinder4.queryLocalInterface("com.google.android.gms.ads.internal.request.INonagonStreamingResponseListener");
                    zzaqeVar2 = queryLocalInterface4 instanceof zzaqe ? (zzaqe) queryLocalInterface4 : new zzaqg(readStrongBinder4);
                }
                zzc(zzaqkVar3, zzaqeVar2);
            } else {
                if (i != 7) {
                    return false;
                }
                ...
                if (readStrongBinder5 != null) {
                    ...
                    zzaqeVar = queryLocalInterface5 instanceof zzaqe ? (zzaqe) queryLocalInterface5 : new zzaqg(readStrongBinder5);
                }
                zza(readString, zzaqeVar);
            }
