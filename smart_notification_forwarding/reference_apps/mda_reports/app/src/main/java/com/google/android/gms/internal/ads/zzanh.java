...
public abstract class zzanh extends zzgb implements zzani {
    ...
    protected final boolean a(int i, Parcel parcel, Parcel parcel2, int i2) {
                        ...
                        switch (i) {
                            ...
                            case 14:
                                ...
                                if (readStrongBinder2 != null) {
                                    ...
                                    zzamzVar = queryLocalInterface2 instanceof zzamx ? (zzamx) queryLocalInterface2 : new zzamz(readStrongBinder2);
                                }
                                zza(readString3, readString4, zzugVar2, asInterface2, zzamzVar, zzalh.zzab(parcel.readStrongBinder()));
                                break;
                            case 15:
                                zzz = zzz(IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()));
                                parcel2.writeNoException();
                                zzge.writeBoolean(parcel2, zzz);
                                break;
                            case 16:
                                ...
                                if (readStrongBinder3 != null) {
                                    ...
                                    zzanfVar = queryLocalInterface3 instanceof zzand ? (zzand) queryLocalInterface3 : new zzanf(readStrongBinder3);
                                }
                                zza(readString5, readString6, zzugVar3, asInterface3, zzanfVar, zzalh.zzab(parcel.readStrongBinder()));
                                break;
                            case 17:
                                zzz = zzaa(IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()));
                                parcel2.writeNoException();
                                zzge.writeBoolean(parcel2, zzz);
                                break;
                            case 18:
                                ...
                                if (readStrongBinder4 != null) {
                                    ...
                                    zzaneVar = queryLocalInterface4 instanceof zzanc ? (zzanc) queryLocalInterface4 : new zzane(readStrongBinder4);
                                }
                                zza(readString7, readString8, zzugVar4, asInterface4, zzaneVar, zzalh.zzab(parcel.readStrongBinder()));
                                break;
                            case 19:
        ...
        if (readStrongBinder5 == null) {
            ...
            zzanlVar = queryLocalInterface5 instanceof zzanj ? (zzanj) queryLocalInterface5 : new zzanl(readStrongBinder5);
        }
        zza(asInterface5, readString9, bundle, bundle2, zzujVar, zzanlVar);
        parcel2.writeNoException();
        return true;
    }
}
