...
public final class zzjf implements zzjg {
    ...
    static {
        ...
        zzk = zzcrVar.zza("measurement.alarm_manager.minimum_interval", ExponentialBackoff.DEFAULT_BACKOFF_MAX_DELAY_MS);
        ...
        zzw = zzcrVar.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzaf = zzcrVar.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
