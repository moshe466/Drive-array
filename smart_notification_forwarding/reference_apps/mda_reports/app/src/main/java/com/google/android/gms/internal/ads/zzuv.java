...
public final class zzuv extends zzvb<zzvu> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzuv(zzup zzupVar, Context context, zzuj zzujVar, String str, zzalc zzalcVar) {
        this.zzcdi = zzupVar;
    ...
    public final /* synthetic */ zzvu zza(zzwd zzwdVar) {
        return zzwdVar.zzb(ObjectWrapper.wrap(this.val$context), this.zzcdj, this.zzcdg, this.zzcdh, 19649000);
    }
    ...
    public final /* synthetic */ zzvu zzoq() {
        ...
        return zzueVar.zza(this.val$context, this.zzcdj, this.zzcdg, this.zzcdh, 2);
    }
}
