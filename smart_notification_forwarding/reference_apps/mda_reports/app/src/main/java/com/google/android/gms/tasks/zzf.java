...
final class zzf implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            task.addOnSuccessListener(TaskExecutors.a, this.zzi);
            task.addOnFailureListener(TaskExecutors.a, this.zzi);
            task.addOnCanceledListener(TaskExecutors.a, this.zzi);
