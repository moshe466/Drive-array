...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final View.OnClickListener m = new View.OnClickListener() { // from class: com.google.android.material.internal.NavigationMenuPresenter.1
        ...
        public void onClick(View view) {
            ...
            boolean performItemAction = navigationMenuPresenter.b.performItemAction(itemData, navigationMenuPresenter, 0);
            if (itemData != null && itemData.isCheckable() && performItemAction) {
                NavigationMenuPresenter.this.c.setCheckedItem(itemData);
            }
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void appendTransparentIconIfMissing(int i, int i2) {
            while (i < i2) {
                ((NavigationMenuTextItem) this.items.get(i)).a = true;
                i++;
            }
        }
        ...
        private void prepareMenuItems() {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.b.getVisibleItems().get(i3);
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ...
                    if (subMenu.hasVisibleItems()) {
                        if (i3 != 0) {
                            this.items.add(new NavigationMenuSeparatorItem(NavigationMenuPresenter.this.l, 0));
                        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (navigationMenuPresenter.f) {
                navigationMenuItemView.setTextAppearance(navigationMenuPresenter.e);
            }
            ColorStateList colorStateList = NavigationMenuPresenter.this.g;
            if (colorStateList != null) {
                navigationMenuItemView.setTextColor(colorStateList);
            }
            Drawable drawable = NavigationMenuPresenter.this.i;
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            if (i == 0) {
                NavigationMenuPresenter navigationMenuPresenter = NavigationMenuPresenter.this;
                return new NormalViewHolder(navigationMenuPresenter.d, viewGroup, navigationMenuPresenter.m);
            }
            if (i == 1) {
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            this.menuView = (NavigationMenuView) this.d.inflate(R.layout.design_navigation_menu, viewGroup, false);
            if (this.c == null) {
                this.c = new NavigationMenuAdapter();
            }
            this.a = (LinearLayout) this.d.inflate(R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
