...
public abstract class AbstractExecutionThreadService implements Service {
    ...
    private final Service delegate = new AbstractService() { // from class: com.google.common.util.concurrent.AbstractExecutionThreadService.1
        ...
        protected final void a() {
            MoreExecutors.a(AbstractExecutionThreadService.this.a(), new Supplier<String>() { // from class: com.google.common.util.concurrent.AbstractExecutionThreadService.1.1
                @Override // com.google.common.base.Supplier
                public String get() {
                    return AbstractExecutionThreadService.this.c();
                }
    ...
    protected Executor a() {
        return new Executor() { // from class: com.google.common.util.concurrent.AbstractExecutionThreadService.2
            ...
            public void execute(Runnable runnable) {
                MoreExecutors.a(AbstractExecutionThreadService.this.c(), runnable).start();
            }
        };
    }
