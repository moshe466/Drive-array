...
public final class Hashing {
    ...
    private static class Sha256Holder {
        static final HashFunction a = new MessageDigestHashFunction(CommonUtils.SHA256_INSTANCE, "Hashing.sha256()");
    ...
    public static HashFunction goodFastHash(int i) {
        ...
        hashFunctionArr[0] = Murmur3_128HashFunction.b;
        int i3 = a;
