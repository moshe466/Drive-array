...
public abstract class LLRBValueNode<K, V> implements LLRBNode<K, V> {
    ...
    private LLRBValueNode<K, V> moveRedLeft() {
        ...
        return colorFlip.getRight().getLeft().isRed() ? colorFlip.a(null, null, null, ((LLRBValueNode) colorFlip.getRight()).rotateRight()).rotateLeft().colorFlip() : colorFlip;
    }
    ...
    private LLRBNode<K, V> removeMin() {
        ...
        return moveRedLeft.a(null, null, ((LLRBValueNode) moveRedLeft.left).removeMin(), null).fixUp();
    }

    private LLRBValueNode<K, V> rotateLeft() {
        return (LLRBValueNode) this.right.copy(null, null, a(), copy((LLRBValueNode<K, V>) null, (K) null, LLRBNode.Color.RED, (LLRBNode<LLRBValueNode<K, V>, K>) null, (LLRBNode<LLRBValueNode<K, V>, K>) ((LLRBValueNode) this.right).left), null);
    }

    private LLRBValueNode<K, V> rotateRight() {
        return (LLRBValueNode) this.left.copy(null, null, a(), null, copy((LLRBValueNode<K, V>) null, (K) null, LLRBNode.Color.RED, (LLRBNode<LLRBValueNode<K, V>, K>) ((LLRBValueNode) this.left).right, (LLRBNode<LLRBValueNode<K, V>, K>) null));
    }
    ...
    public LLRBNode<K, V> insert(K k, V v, Comparator<K> comparator) {
        ...
        return (compare < 0 ? a(null, null, this.left.insert(k, v, comparator), null) : compare == 0 ? a(k, v, null, null) : a(null, null, null, this.right.insert(k, v, comparator))).fixUp();
    }
    ...
    public LLRBNode<K, V> remove(K k, Comparator<K> comparator) {
        ...
        if (comparator.compare(k, this.key) < 0) {
            ...
            a = moveRedLeft.a(null, null, moveRedLeft.left.remove(k, comparator), null);
        } else {
            ...
            if (comparator.compare(k, rotateRight.key) == 0) {
                ...
                rotateRight = rotateRight.a(min.getKey(), min.getValue(), null, ((LLRBValueNode) rotateRight.right).removeMin());
            }
            a = rotateRight.a(null, null, null, rotateRight.right.remove(k, comparator));
        }
        return a.fixUp();
    }
