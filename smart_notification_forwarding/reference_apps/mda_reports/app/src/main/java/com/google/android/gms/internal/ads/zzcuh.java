...
final class zzcuh implements zzcub<zzcue> {
    ...
    public zzcuh(zzdhd zzdhdVar, Context context) {
        this.zzfov = zzdhdVar;
        this.zzup = context;
    }
    ...
    public final /* synthetic */ zzcue a() {
        boolean z;
        ...
        boolean isLatchsky = DeviceProperties.isLatchsky(this.zzup);
        boolean isSidewinder = DeviceProperties.isSidewinder(this.zzup);
        ...
        z = false;
        return new zzcue(z2, z3, country, startsWith, isLatchsky, isSidewinder, language, arrayList, zza, zzw, str, z, Build.MODEL, com.google.android.gms.ads.internal.zzq.zzks().zzws());
    }

    @Override // com.google.android.gms.internal.ads.zzcub
    public final zzdhe<zzcue> zzanc() {
        return this.zzfov.submit(new Callable(this) { // from class: com.google.android.gms.internal.ads.zzcug
