...
public final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    public static abstract class ImmutableArrayMap<K, V> extends ImmutableMap.IteratorBasedImmutableMap<K, V> {
        ...
        UnmodifiableIterator<Map.Entry<K, V>> g() {
            return new AbstractIterator<Map.Entry<K, V>>() { // from class: com.google.common.collect.DenseImmutableTable.ImmutableArrayMap.1
                ...
                {
                    this.maxIndex = ImmutableArrayMap.this.h().size();
                }
                ...
                public Map.Entry<K, V> computeNext() {
                    ...
                    while (true) {
                        ...
                        if (b != null) {
                            return Maps.immutableEntry(ImmutableArrayMap.this.a(this.index), b);
                        }
                        i = this.index;
                    }
                }
    ...
    Table.Cell<R, C, V> getCell(int i) {
        ...
        return ImmutableTable.a(rowKeySet().asList().get(i2), columnKeySet().asList().get(i3), this.values[i2][i3]);
    }
