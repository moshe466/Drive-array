...
public final class DoubleMath {
    ...
    static double a(double d, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.a[roundingMode.ordinal()]) {
            case 1:
                MathPreconditions.b(isMathematicalInteger(d));
                return d;
            case 2:
    ...
    public static boolean isMathematicalInteger(double d) {
        return DoubleUtils.c(d) && (d == LN_2 || 52 - Long.numberOfTrailingZeros(DoubleUtils.b(d)) <= Math.getExponent(d));
    }

    @GwtIncompatible
    public static boolean isPowerOfTwo(double d) {
        if (d <= LN_2 || !DoubleUtils.c(d)) {
            return false;
        }
        long b = DoubleUtils.b(d);
        return (b & (b - 1)) == 0;
    }
    ...
    */
    public static int log2(double r5, java.math.RoundingMode r7) {
        /*
            ...
            if (r4 <= 0) goto L10
            boolean r2 = com.google.common.math.DoubleUtils.c(r5)
            if (r2 == 0) goto L10
            r2 = 1
            goto L11
        L10:
        ...
        L11:
            ...
            boolean r3 = com.google.common.math.DoubleUtils.d(r5)
            if (r3 != 0) goto L2b
            ...
            return r5
        L2b:
            int[] r3 = com.google.common.math.DoubleMath.AnonymousClass1.a
            int r7 = r7.ordinal()
            r7 = r3[r7]
            switch(r7) {
                case 1: goto L5f;
        ...
        L36:
            ...
            throw r5
        L3c:
            double r5 = com.google.common.math.DoubleUtils.e(r5)
            double r5 = r5 * r5
        ...
        L5f:
            boolean r5 = isPowerOfTwo(r5)
            com.google.common.math.MathPreconditions.b(r5)
        L66:
            if (r0 == 0) goto L6a
            int r2 = r2 + 1
        L6a:
    ...
    public static BigInteger roundToBigInteger(double d, RoundingMode roundingMode) {
        ...
        if ((a2 < 9.223372036854776E18d) && ((-9.223372036854776E18d) - a2 < 1.0d)) {
            return BigInteger.valueOf((long) a2);
        }
        BigInteger shiftLeft = BigInteger.valueOf(DoubleUtils.b(a2)).shiftLeft(Math.getExponent(a2) - 52);
    ...
    public static int roundToInt(double d, RoundingMode roundingMode) {
        double a2 = a(d, roundingMode);
        MathPreconditions.a((a2 < 2.147483648E9d) & (a2 > -2.147483649E9d));
        return (int) a2;
    }
    ...
    public static long roundToLong(double d, RoundingMode roundingMode) {
        double a2 = a(d, roundingMode);
        MathPreconditions.a((a2 < 9.223372036854776E18d) & ((-9.223372036854776E18d) - a2 < 1.0d));
        return (long) a2;
    }
}
