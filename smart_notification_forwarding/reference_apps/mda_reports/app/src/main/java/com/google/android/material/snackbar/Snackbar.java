...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(a(findSuitableParent.getContext()) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, findSuitableParent, false);
    ...
    public Snackbar setAction(CharSequence charSequence, final View.OnClickListener onClickListener) {
        Button actionView = ((SnackbarContentLayout) this.a.getChildAt(0)).getActionView();
    ...
    public Snackbar setActionTextColor(@ColorInt int i) {
        ((SnackbarContentLayout) this.a.getChildAt(0)).getActionView().setTextColor(i);
        return this;
    }

    @NonNull
    public Snackbar setActionTextColor(ColorStateList colorStateList) {
        ((SnackbarContentLayout) this.a.getChildAt(0)).getActionView().setTextColor(colorStateList);
        return this;
    }
    ...
    public Snackbar setText(@NonNull CharSequence charSequence) {
        ((SnackbarContentLayout) this.a.getChildAt(0)).getMessageView().setText(charSequence);
        return this;
    }
