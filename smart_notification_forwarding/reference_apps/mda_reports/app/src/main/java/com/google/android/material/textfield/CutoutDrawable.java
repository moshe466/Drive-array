...
class CutoutDrawable extends GradientDrawable {
    ...
    private void saveCanvasLayer(@NonNull Canvas canvas) {
        this.savedLayer = Build.VERSION.SDK_INT >= 21 ? canvas.saveLayer(0.0f, 0.0f, canvas.getWidth(), canvas.getHeight(), null) : canvas.saveLayer(0.0f, 0.0f, canvas.getWidth(), canvas.getHeight(), null, 31);
    }
