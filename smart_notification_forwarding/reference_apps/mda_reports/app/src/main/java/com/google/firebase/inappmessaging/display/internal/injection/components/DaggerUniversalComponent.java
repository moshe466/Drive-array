...
public final class DaggerUniversalComponent implements UniversalComponent {
    ...
    private void initialize(ApplicationModule applicationModule, InflaterConfigModule inflaterConfigModule) {
        ...
        this.providesDisplayMetricsProvider = InflaterConfigModule_ProvidesDisplayMetricsFactory.create(inflaterConfigModule, this.providesApplicationProvider);
        this.providesPortraitImageLayoutConfigProvider = InflaterConfigModule_ProvidesPortraitImageLayoutConfigFactory.create(inflaterConfigModule, this.providesDisplayMetricsProvider);
