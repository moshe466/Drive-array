...
public final class GsonBuilder {
    ...
    public GsonBuilder(Gson gson) {
        ...
        this.generateNonExecutableJson = false;
        this.lenient = false;
        this.excluder = gson.b;
        this.fieldNamingPolicy = gson.c;
        this.instanceCreators.putAll(gson.d);
        this.serializeNulls = gson.e;
        this.complexMapKeySerialization = gson.f;
        this.generateNonExecutableJson = gson.g;
        this.escapeHtmlChars = gson.h;
        this.prettyPrinting = gson.i;
        this.lenient = gson.j;
        this.serializeSpecialFloatingPointValues = gson.k;
        this.longSerializationPolicy = gson.o;
        this.datePattern = gson.l;
        this.dateStyle = gson.m;
        this.timeStyle = gson.n;
        this.factories.addAll(gson.p);
        this.hierarchyFactories.addAll(gson.q);
    }
