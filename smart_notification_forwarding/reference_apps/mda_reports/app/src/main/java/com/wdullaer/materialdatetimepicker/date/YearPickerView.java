...
public class YearPickerView extends ListView implements AdapterView.OnItemClickListener, DatePickerDialog.OnDateChangedListener {
    ...
    public YearPickerView(Context context, DatePickerController datePickerController) {
        ...
        this.mViewSize = resources.getDimensionPixelOffset(this.mController.getVersion() == DatePickerDialog.Version.VERSION_1 ? R.dimen.mdtp_date_picker_view_animator_height : R.dimen.mdtp_date_picker_view_animator_height_v2);
