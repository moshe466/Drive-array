...
public final class Chars {
    ...
    private static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
        ...
        public int indexOf(Object obj) {
            int indexOf;
            if (!(obj instanceof Character) || (indexOf = Chars.indexOf(this.a, ((Character) obj).charValue(), this.b, this.c)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(Object obj) {
            int lastIndexOf;
            if (!(obj instanceof Character) || (lastIndexOf = Chars.lastIndexOf(this.a, ((Character) obj).charValue(), this.b, this.c)) < 0) {
                return -1;
            }
