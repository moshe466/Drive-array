...
public final class zzui implements Parcelable.Creator<zzug> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzug createFromParcel(Parcel parcel) {
        ...
        return new zzug(i, j, bundle, i2, arrayList, z, i3, z2, str, zzysVar, location, str2, bundle2, bundle3, arrayList2, str3, str4, z3, zzuaVar, i4, str5, arrayList3);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzug[] newArray(int i) {
        return new zzug[i];
    }
}
