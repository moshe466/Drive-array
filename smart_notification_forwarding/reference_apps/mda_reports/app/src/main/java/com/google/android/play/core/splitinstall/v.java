...
public final class v extends com.google.android.play.core.internal.r {
    ...
    public v(r rVar, com.google.android.play.core.tasks.h hVar, List list, com.google.android.play.core.tasks.h hVar2) {
        super(hVar);
        this.c = rVar;
        this.a = list;
        this.b = hVar2;
    ...
    protected final void a() {
        ...
        try {
            ...
            d2 = r.d();
            b.c(str, d, d2, new aa(this.c, this.b));
        } catch (RemoteException e) {
            r.b.a(e, "deferredInstall(%s)", this.a);
