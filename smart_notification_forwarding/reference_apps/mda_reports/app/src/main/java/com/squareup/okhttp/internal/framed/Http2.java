...
public final class Http2 implements Variant {
    ...
    public static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() {
            ...
            if (Http2.logger.isLoggable(Level.FINE)) {
                Http2.logger.fine(FrameLogger.a(true, this.c, this.a, readByte, this.b));
            }
    ...
    static final class Reader implements FrameReader {
        ...
        Reader(BufferedSource bufferedSource, int i, boolean z) {
            ...
            this.a = new Hpack.Reader(i, this.continuation);
        }
        ...
        public boolean nextFrame(FrameReader.Handler handler) {
            try {
                ...
                if (Http2.logger.isLoggable(Level.FINE)) {
                    Http2.logger.fine(FrameLogger.a(true, readInt, readMedium, readByte, readByte2));
                }
                switch (readByte) {
                    case 0:
    ...
    static final class Writer implements FrameWriter {
        ...
        void a(int i, int i2, byte b, byte b2) {
            if (Http2.logger.isLoggable(Level.FINE)) {
                Http2.logger.fine(FrameLogger.a(false, i, i2, b, b2));
            }
        ...
        public synchronized void ackSettings(Settings settings) {
            ...
            this.maxFrameSize = settings.e(this.maxFrameSize);
            a(0, 0, (byte) 4, (byte) 1);
            this.sink.flush();
        }
