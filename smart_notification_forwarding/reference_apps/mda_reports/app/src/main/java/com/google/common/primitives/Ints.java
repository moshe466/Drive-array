...
public final class Ints {
    ...
    private static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public int indexOf(Object obj) {
            int indexOf;
            if (!(obj instanceof Integer) || (indexOf = Ints.indexOf(this.a, ((Integer) obj).intValue(), this.b, this.c)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(Object obj) {
            int lastIndexOf;
            if (!(obj instanceof Integer) || (lastIndexOf = Ints.lastIndexOf(this.a, ((Integer) obj).intValue(), this.b, this.c)) < 0) {
                return -1;
            }
