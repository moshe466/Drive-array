...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        MotionTiming timing2 = motionSpec.getTiming(str);
        ...
        if (z) {
            ...
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec, motionTiming, timing2, -calculateTranslationX, -calculateTranslationY, 0.0f, 0.0f, rectF);
        } else {
    ...
    protected AnimatorSet b(final View view, final View view2, final boolean z, boolean z2) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            createElevationAnimation(view, view2, z, z2, a, arrayList, arrayList2);
        }
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z, z2, a, arrayList, arrayList2, rectF);
        float width = rectF.width();
        float height = rectF.height();
        createIconFadeAnimation(view, view2, z, z2, a, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z, z2, a, width, height, arrayList, arrayList2);
        createColorAnimation(view, view2, z, z2, a, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z, z2, a, arrayList, arrayList2);
