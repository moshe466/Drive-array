...
public final class zzie {
    ...
    static {
        zza = (!(zzib.a() && zzib.b()) || zzdr.a()) ? new zzii() : new zzik();
    }
    ...
    public static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zza.a(charSequence, bArr, i, i2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String a(byte[] bArr, int i, int i2) {
        return zza.b(bArr, i, i2);
    }

    public static boolean zza(byte[] bArr) {
        return zza.a(bArr, 0, bArr.length);
    }

    public static boolean zza(byte[] bArr, int i, int i2) {
        return zza.a(bArr, i, i2);
    }
