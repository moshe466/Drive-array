...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        try {
            ImmutableMultimap.FieldSettersHolder.a.a((Serialization.FieldSetter<ImmutableMultimap>) this, (Object) builder.build());
            ImmutableMultimap.FieldSettersHolder.b.a((Serialization.FieldSetter<ImmutableMultimap>) this, i);
            SetFieldSettersHolder.a.a((Serialization.FieldSetter<ImmutableSetMultimap>) this, (Object) emptySet(comparator));
    ...
    public ImmutableSet<V> get(@NullableDecl K k) {
        return (ImmutableSet) MoreObjects.firstNonNull((ImmutableSet) this.a.get(k), this.emptySet);
    }
