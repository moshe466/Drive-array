...
public class zzawi extends zzawh {
    ...
    public final String getDefaultUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(zzxc.a)) {
            zzxc.a = (String) (ClientLibraryUtils.isPackageSide() ? zzayc.zza(context, new zzaye(zzxc, context)) : zzayc.zza(context, new zzayh(zzxc, GooglePlayServicesUtilLight.getRemoteContext(context), context)));
        }
        return zzxc.a;
    }
    ...
    public final void zzbc(Context context) {
        ...
        if (!defaultUserAgent.equals(zzxc.a)) {
