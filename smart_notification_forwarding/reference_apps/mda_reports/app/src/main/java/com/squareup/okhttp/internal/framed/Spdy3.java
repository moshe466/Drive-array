...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        private void readSettings(FrameReader.Handler handler, int i, int i2) {
            ...
            for (int i3 = 0; i3 < readInt; i3++) {
                int readInt2 = this.source.readInt();
                settings.a(readInt2 & ViewCompat.MEASURED_SIZE_MASK, ((-16777216) & readInt2) >>> 24, this.source.readInt());
            }
        ...
        private void readSynStream(FrameReader.Handler handler, int i, int i2) {
            ...
            handler.headers((i & 2) != 0, (i & 1) != 0, readInt, readInt2, this.headerBlockReader.readNameValueBlock(i2 - 10), HeadersMode.SPDY_SYN_STREAM);
        }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void settings(Settings settings) {
            ...
            this.sink.writeInt((((c * 8) + 4) & ViewCompat.MEASURED_SIZE_MASK) | 0);
            this.sink.writeInt(c);
            for (int i = 0; i <= 10; i++) {
                if (settings.g(i)) {
                    this.sink.writeInt(((settings.a(i) & 255) << 24) | (i & ViewCompat.MEASURED_SIZE_MASK));
                    this.sink.writeInt(settings.b(i));
                }
            }
            this.sink.flush();
        }
