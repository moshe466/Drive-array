...
public final class DocumentDelete extends GeneratedMessageLite<DocumentDelete, Builder> implements DocumentDeleteOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DocumentDelete, Builder> implements DocumentDeleteOrBuilder {
        ...
        public Builder addAllRemovedTargetIds(Iterable<? extends Integer> iterable) {
            a();
            ((DocumentDelete) this.a).addAllRemovedTargetIds(iterable);
            return this;
        }

        public Builder addRemovedTargetIds(int i) {
            a();
            ((DocumentDelete) this.a).addRemovedTargetIds(i);
            return this;
        }

        public Builder clearDocument() {
            a();
            ((DocumentDelete) this.a).clearDocument();
            return this;
        }

        public Builder clearReadTime() {
            a();
            ((DocumentDelete) this.a).clearReadTime();
            return this;
        }

        public Builder clearRemovedTargetIds() {
            a();
            ((DocumentDelete) this.a).clearRemovedTargetIds();
            return this;
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public String getDocument() {
            return ((DocumentDelete) this.a).getDocument();
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public ByteString getDocumentBytes() {
            return ((DocumentDelete) this.a).getDocumentBytes();
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public Timestamp getReadTime() {
            return ((DocumentDelete) this.a).getReadTime();
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public int getRemovedTargetIds(int i) {
            return ((DocumentDelete) this.a).getRemovedTargetIds(i);
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public int getRemovedTargetIdsCount() {
            return ((DocumentDelete) this.a).getRemovedTargetIdsCount();
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public List<Integer> getRemovedTargetIdsList() {
            return Collections.unmodifiableList(((DocumentDelete) this.a).getRemovedTargetIdsList());
        }

        @Override // com.google.firestore.v1.DocumentDeleteOrBuilder
        public boolean hasReadTime() {
            return ((DocumentDelete) this.a).hasReadTime();
        }

        public Builder mergeReadTime(Timestamp timestamp) {
            a();
            ((DocumentDelete) this.a).mergeReadTime(timestamp);
            return this;
        }

        public Builder setDocument(String str) {
            a();
            ((DocumentDelete) this.a).setDocument(str);
            return this;
        }

        public Builder setDocumentBytes(ByteString byteString) {
            a();
            ((DocumentDelete) this.a).setDocumentBytes(byteString);
            return this;
        }

        public Builder setReadTime(Timestamp.Builder builder) {
            a();
            ((DocumentDelete) this.a).setReadTime(builder);
            return this;
        }

        public Builder setReadTime(Timestamp timestamp) {
            a();
            ((DocumentDelete) this.a).setReadTime(timestamp);
            return this;
        }

        public Builder setRemovedTargetIds(int i, int i2) {
            a();
            ((DocumentDelete) this.a).setRemovedTargetIds(i, i2);
            return this;
        }
    }
    ...
    public static Builder newBuilder(DocumentDelete documentDelete) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom((Builder) documentDelete);
    }

    public static DocumentDelete parseDelimitedFrom(InputStream inputStream) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, inputStream);
    }

    public static DocumentDelete parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static DocumentDelete parseFrom(ByteString byteString) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, byteString);
    }
    ...
    public static DocumentDelete parseFrom(CodedInputStream codedInputStream) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, codedInputStream);
    }

    public static DocumentDelete parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }

    public static DocumentDelete parseFrom(InputStream inputStream) {
        return (DocumentDelete) GeneratedMessageLite.b(DEFAULT_INSTANCE, inputStream);
    }

    public static DocumentDelete parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (DocumentDelete) GeneratedMessageLite.b(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static DocumentDelete parseFrom(byte[] bArr) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, bArr);
    }

    public static DocumentDelete parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (DocumentDelete) GeneratedMessageLite.a(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }
