...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        ColorStateList colorStateList = obtainTintedStyledAttributes.hasValue(com.google.android.material.R.styleable.NavigationView_itemIconTint) ? obtainTintedStyledAttributes.getColorStateList(com.google.android.material.R.styleable.NavigationView_itemIconTint) : createDefaultColorStateList(R.attr.textColorSecondary);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        i = View.MeasureSpec.makeMeasureSpec(min, Ints.MAX_POWER_OF_TWO);
        super.onMeasure(i, i2);
    }
