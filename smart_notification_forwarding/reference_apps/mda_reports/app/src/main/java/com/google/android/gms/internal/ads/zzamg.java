...
public final class zzamg<NETWORK_EXTRAS extends NetworkExtras, SERVER_PARAMETERS extends MediationServerParameters> extends zzalg {
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzuj zzujVar, zzug zzugVar, String str, String str2, zzali zzaliVar) {
        ...
        try {
            ...
            while (true) {
                if (i >= 6) {
                    adSize = new AdSize(com.google.android.gms.ads.zzb.zza(zzujVar.width, zzujVar.height, zzujVar.zzabg));
                    break;
                } else {
            ...
            mediationBannerAdapter.requestBannerAd(zzamfVar, activity, zzdk, adSize, zzamr.zza(zzugVar, zzc(zzugVar)), this.zzdee);
        } catch (Throwable th) {
            zzayu.zzc("", th);
            throw new RemoteException();
        }
