...
final class Serialization {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <K, V> void a(Multimap<K, V> multimap, ObjectInputStream objectInputStream) {
        a(multimap, objectInputStream, objectInputStream.readInt());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public static <K, V> void a(Multimap<K, V> multimap, ObjectInputStream objectInputStream, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <K, V> void a(Multimap<K, V> multimap, ObjectOutputStream objectOutputStream) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <E> void a(Multiset<E> multiset, ObjectOutputStream objectOutputStream) {
