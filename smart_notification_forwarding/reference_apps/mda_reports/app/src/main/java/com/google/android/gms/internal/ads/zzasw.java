...
public final class zzasw {
    public static zzasg zzd(Context context, String str, zzalc zzalcVar) {
        try {
            IBinder zzd = ((zzasm) zzayx.zza(context, "com.google.android.gms.ads.rewarded.ChimeraRewardedAdCreatorImpl", zzasz.a)).zzd(ObjectWrapper.wrap(context), str, zzalcVar, 19649000);
            if (zzd == null) {
                return null;
            }
