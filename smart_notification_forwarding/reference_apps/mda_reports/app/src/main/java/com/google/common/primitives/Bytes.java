...
public final class Bytes {
    ...
    private static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
        ...
        public int indexOf(Object obj) {
            int indexOf;
            if (!(obj instanceof Byte) || (indexOf = Bytes.indexOf(this.a, ((Byte) obj).byteValue(), this.b, this.c)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(Object obj) {
            int lastIndexOf;
            if (!(obj instanceof Byte) || (lastIndexOf = Bytes.lastIndexOf(this.a, ((Byte) obj).byteValue(), this.b, this.c)) < 0) {
                return -1;
            }
