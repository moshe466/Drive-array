...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n) {
        ...
        return graph.isDirected() ? DirectedGraphConnections.a(graph.predecessors((Graph<N>) n), Maps.asMap(graph.successors((Graph<N>) n), constant)) : UndirectedGraphConnections.a(Maps.asMap(graph.adjacentNodes(n), constant));
    }
