...
public final class u extends com.google.android.play.core.internal.r {
    ...
    public u(r rVar, com.google.android.play.core.tasks.h hVar, List list, com.google.android.play.core.tasks.h hVar2) {
        super(hVar);
        this.c = rVar;
        this.a = list;
        this.b = hVar2;
    ...
    protected final void a() {
        ...
        try {
            ...
            d = r.d();
            b.d(str, c, d, new ad(this.c, this.b));
        } catch (RemoteException e) {
            r.b.a(e, "deferredLanguageInstall(%s)", this.a);
