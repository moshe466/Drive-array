...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    public Set<E> edgesConnecting(N n, N n2) {
        ...
        return Collections.unmodifiableSet(outEdges.size() <= inEdges.size() ? Sets.filter(outEdges, connectedPredicate(n, n2)) : Sets.filter(inEdges, connectedPredicate(n2, n)));
    }
