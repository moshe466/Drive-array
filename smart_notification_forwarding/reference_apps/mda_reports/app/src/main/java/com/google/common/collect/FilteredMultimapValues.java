...
final class FilteredMultimapValues<K, V> extends AbstractCollection<V> {
    ...
    public Iterator<V> iterator() {
        return Maps.c(this.multimap.entries().iterator());
    }
    ...
    public boolean removeAll(Collection<?> collection) {
        return Iterables.removeIf(this.multimap.unfiltered().entries(), Predicates.and(this.multimap.entryPredicate(), Maps.b(Predicates.in(collection))));
    }

    @Override // java.util.AbstractCollection, java.util.Collection
    public boolean retainAll(Collection<?> collection) {
        return Iterables.removeIf(this.multimap.unfiltered().entries(), Predicates.and(this.multimap.entryPredicate(), Maps.b(Predicates.not(Predicates.in(collection)))));
    }
