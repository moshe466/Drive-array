...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static <O> ListenableFuture<O> scheduleAsync(AsyncCallable<O> asyncCallable, long j, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        TrustedListenableFutureTask a = TrustedListenableFutureTask.a(asyncCallable);
        final ScheduledFuture<?> schedule = scheduledExecutorService.schedule(a, j, timeUnit);
        a.addListener(new Runnable() { // from class: com.google.common.util.concurrent.Futures.1
            @Override // java.lang.Runnable
            public void run() {
