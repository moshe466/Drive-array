...
public class WatchStream extends AbstractStream<ListenRequest, ListenResponse, Callback> {
    ...
    public void onNext(ListenResponse listenResponse) {
        ...
        ((Callback) this.b).onWatchChange(this.serializer.decodeVersionFromListenResponse(listenResponse), decodeWatchChange);
    }
    ...
    public void unwatchTarget(int i) {
        ...
        a((WatchStream) ListenRequest.newBuilder().setDatabase(this.serializer.databaseName()).setRemoveTarget(i).build());
    }
