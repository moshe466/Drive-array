...
public final class MediaType {
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            ImmutableListMultimap.Builder builder = ImmutableListMultimap.builder();
            while (tokenizer.a()) {
                tokenizer.c(LINEAR_WHITE_SPACE);
                tokenizer.a(';');
                tokenizer.c(LINEAR_WHITE_SPACE);
                String b4 = tokenizer.b(TOKEN_MATCHER);
                tokenizer.a('=');
                if ('\"' == tokenizer.b()) {
                    ...
                    while ('\"' != tokenizer.b()) {
                        if ('\\' == tokenizer.b()) {
                            tokenizer.a('\\');
                            sb.append(tokenizer.a(CharMatcher.ascii()));
                        } else {
                    ...
                    b = tokenizer.b(TOKEN_MATCHER);
                }
                builder.put((ImmutableListMultimap.Builder) b4, b);
            }
            return create(b2, b3, builder.build());
