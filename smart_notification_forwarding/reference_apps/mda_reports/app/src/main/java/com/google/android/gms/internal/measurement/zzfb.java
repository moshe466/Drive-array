...
abstract class zzfb<T extends zzeq> {
    ...
    public static <T extends zzeq> T a(Class<T> cls) {
        ...
        if (cls.equals(zzeq.class)) {
            ...
            if (!cls.getPackage().equals(zzfb.class.getPackage())) {
        ...
        try {
            try {
                try {
                    try {
                        return cls.cast(((zzfb) Class.forName(format, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).a());
            ...
            while (it.hasNext()) {
                try {
                    arrayList.add(cls.cast(((zzfb) it.next()).a()));
