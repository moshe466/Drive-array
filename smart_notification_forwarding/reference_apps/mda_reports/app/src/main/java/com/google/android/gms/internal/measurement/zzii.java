...
final class zzii extends zzif {
    ...
    */
    public final int a(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzii.a(java.lang.CharSequence, byte[], int, int):int");
    }
            ...
            if (zzd) {
                ...
                if (!zze) {
                    ...
                    if (zzf) {
                        ...
                        int i8 = i6 + 1;
                        zzig.zzb(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        if (i6 >= i3 - 2) {
                        ...
                        byte b4 = bArr[i6];
                        int i10 = i9 + 1;
                        zzig.zzb(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    }
                } else {
