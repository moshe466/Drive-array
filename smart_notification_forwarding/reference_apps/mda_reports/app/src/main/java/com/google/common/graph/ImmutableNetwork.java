...
public final class ImmutableNetwork<N, E> extends ConfigurableNetwork<N, E> {
    ...
    private static <N, E> NetworkConnections<N, E> connectionsOf(Network<N, E> network, N n) {
        if (!network.isDirected()) {
            ...
            return network.allowsParallelEdges() ? UndirectedMultiNetworkConnections.a(asMap) : UndirectedNetworkConnections.a(asMap);
        }
        ...
        return network.allowsParallelEdges() ? DirectedMultiNetworkConnections.a(asMap2, asMap3, size) : DirectedNetworkConnections.a(asMap2, asMap3, size);
    }
