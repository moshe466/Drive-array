...
public final class zzuq {
    ...
    private final AdSize[] zzcdf;

    public zzuq(Context context, AttributeSet attributeSet) {
        ...
        if (z && !z2) {
            ...
            this.zzcdf = zzcc(string2);
        }
        this.zzbqz = obtainAttributes.getString(R.styleable.AdsAttrs_adUnitId);
