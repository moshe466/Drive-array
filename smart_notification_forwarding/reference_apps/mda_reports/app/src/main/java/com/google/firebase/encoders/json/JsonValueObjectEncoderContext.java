...
public final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @NonNull
    public JsonValueObjectEncoderContext a(@Nullable Object obj) {
        if (obj == null) {
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, double d) {
        maybeUnNest();
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, int i) {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, long j) {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j);
    }
