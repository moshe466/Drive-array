...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public void addFabAnimationListeners(@NonNull FloatingActionButton floatingActionButton) {
        ...
        floatingActionButton.addOnShowAnimationListener(this.e);
    }
    ...
    private void createCradleShapeAnimation(boolean z, List<Animator> list) {
        if (z) {
            this.topEdgeTreatment.e(getFabTranslationX());
        }
    ...
    private void createCradleTranslationAnimation(int i, List<Animator> list) {
        if (this.fabAttached) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.topEdgeTreatment.e(), getFabTranslationX(i));
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    BottomAppBar.this.topEdgeTreatment.e(((Float) valueAnimator.getAnimatedValue()).floatValue());
    ...
    private void removeFabAnimationListeners(@NonNull FloatingActionButton floatingActionButton) {
        floatingActionButton.removeOnHideAnimationListener(this.e);
        floatingActionButton.removeOnShowAnimationListener(this.e);
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.fabAlignmentMode = savedState.a;
        this.fabAttached = savedState.b;
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.a = this.fabAlignmentMode;
        savedState.b = this.fabAttached;
        return savedState;
    }
    ...
    void setFabDiameter(@Px int i) {
        float f = i;
        if (f != this.topEdgeTreatment.d()) {
            this.topEdgeTreatment.d(f);
            this.materialShapeDrawable.invalidateSelf();
        }
    }
