...
public final class Doubles {
    ...
    private static class DoubleArrayAsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public int indexOf(Object obj) {
            int indexOf;
            if (!(obj instanceof Double) || (indexOf = Doubles.indexOf(this.a, ((Double) obj).doubleValue(), this.b, this.c)) < 0) {
                return -1;
            }
        ...
        public int lastIndexOf(Object obj) {
            int lastIndexOf;
            if (!(obj instanceof Double) || (lastIndexOf = Doubles.lastIndexOf(this.a, ((Double) obj).doubleValue(), this.b, this.c)) < 0) {
                return -1;
            }
