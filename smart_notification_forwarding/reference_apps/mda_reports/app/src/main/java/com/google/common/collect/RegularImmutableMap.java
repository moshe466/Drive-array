...
public final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static final ImmutableMap<Object, Object> c = new RegularImmutableMap(null, new Object[0], 0);
    ...
    public static <K, V> RegularImmutableMap<K, V> a(int i, Object[] objArr) {
        ...
        return new RegularImmutableMap<>(a(objArr, i, ImmutableSet.a(i), 0), objArr, i);
    }
    ...
    */
    ...
    ImmutableSet<Map.Entry<K, V>> a() {
        return new EntrySet(this, this.b, 0, this.size);
    }

    @Override // com.google.common.collect.ImmutableMap
    ImmutableSet<K> b() {
        return new KeySet(this, new KeysOrValuesAsList(this.b, 0, this.size));
    }

    @Override // com.google.common.collect.ImmutableMap
    ImmutableCollection<V> c() {
        return new KeysOrValuesAsList(this.b, 1, this.size);
    }
    ...
    public V get(@NullableDecl Object obj) {
        return (V) a(this.hashTable, this.b, this.size, 0, obj);
    }
