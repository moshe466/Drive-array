...
final class zzp implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            then.addOnSuccessListener(TaskExecutors.a, this.zzs);
            then.addOnFailureListener(TaskExecutors.a, this.zzs);
            then.addOnCanceledListener(TaskExecutors.a, this.zzs);
