...
final class UndirectedMultiNetworkConnections<N, E> extends AbstractUndirectedNetworkConnections<N, E> {
    ...
    public static <N, E> UndirectedMultiNetworkConnections<N, E> a() {
        return new UndirectedMultiNetworkConnections<>(new HashMap(2, 1.0f));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <N, E> UndirectedMultiNetworkConnections<N, E> a(Map<E, N> map) {
    ...
    public Set<E> edgesConnecting(final N n) {
        return new MultiEdgesConnecting<E>(this.a, n) { // from class: com.google.common.graph.UndirectedMultiNetworkConnections.1
